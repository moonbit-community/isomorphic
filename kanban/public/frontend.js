...
function _M0TPB8MutLocalGORPB5ArrayGRP38bobzhang6kanban6shared6ColumnEE(param0) {
  this.val = param0;
}
...
function _M0TPB8MutLocalGORPB5ArrayGRP38bobzhang6kanban6shared4CardEE(param0) {
  this.val = param0;
}
...
function _M0FPB24fixed__choose__pivot__byN7sort__2S419GRP38bobzhang6kanban6shared6ColumnE(_env, a, b) {
  const swaps = _env._2;
  const cmp = _env._1;
  const arr = _env._0;
...
function _M0FPB24fixed__choose__pivot__byN7sort__3S423GRP38bobzhang6kanban6shared6ColumnE(_env, a, b, c) {
  _M0FPB24fixed__choose__pivot__byN7sort__2S419GRP38bobzhang6kanban6shared6ColumnE(_env, a, b);
  _M0FPB24fixed__choose__pivot__byN7sort__2S419GRP38bobzhang6kanban6shared6ColumnE(_env, b, c);
  _M0FPB24fixed__choose__pivot__byN7sort__2S419GRP38bobzhang6kanban6shared6ColumnE(_env, a, b);
}
function _M0FPB24fixed__choose__pivot__byGRP38bobzhang6kanban6shared6ColumnE(arr, cmp) {
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FPB24fixed__choose__pivot__byN7sort__3S423GRP38bobzhang6kanban6shared6ColumnE(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FPB24fixed__choose__pivot__byN7sort__3S423GRP38bobzhang6kanban6shared6ColumnE(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FPB24fixed__choose__pivot__byN7sort__3S423GRP38bobzhang6kanban6shared6ColumnE(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FPB24fixed__choose__pivot__byN7sort__3S423GRP38bobzhang6kanban6shared6ColumnE(_env, a, b, c);
  }
  if (swaps.val === 12) {
...
function _M0FPB21fixed__sift__down__byGRP38bobzhang6kanban6shared6ColumnE(arr, index, cmp) {
  ...
  while (true) {
    ...
    const child = _tmp$2;
    if (child < len) {
      const child$2 = (child + 1 | 0) < len && cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr, child), _M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr, child + 1 | 0)) < 0 ? child + 1 | 0 : child;
      if (cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr, index$2), _M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr, child$2)) >= 0) {
        return undefined;
      }
      _M0MPC15array12MutArrayView4swapGRP38bobzhang6kanban6shared6ColumnE(arr, index$2, child$2);
      _tmp = child$2;
...
function _M0FPB22fixed__quick__sort__byGRP38bobzhang6kanban6shared6ColumnE(arr, cmp, pred, limit) {
  ...
  while (true) {
    ...
    if (pred$2 === undefined) {
      ...
      const _Some = pred$2;
      const _p = _Some;
      if (cmp(_p, _M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr$2, _pivot)) === 0) {
        let i;
        let _tmp$7 = _pivot;
        while (true) {
          const i$2 = _tmp$7;
          if (i$2 < len && cmp(_p, _M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr$2, i$2)) === 0) {
            _tmp$7 = i$2 + 1 | 0;
            continue;
          } else {
            i = i$2;
        ...
        _tmp = limit$3;
        _tmp$2 = _M0MPC15array12MutArrayView5sliceGRP38bobzhang6kanban6shared6ColumnE(arr$2, i, len);
        _tmp$4 = _partitioned;
        _tmp$5 = balanced$2;
        continue;
      }
    ...
    if (_M0MPC15array12MutArrayView6lengthGRP38bobzhang6kanban6shared6ColumnE(left) < _M0MPC15array12MutArrayView6lengthGRP38bobzhang6kanban6shared6ColumnE(right)) {
      _M0FPB22fixed__quick__sort__byGRP38bobzhang6kanban6shared6ColumnE(left, cmp, pred$2, limit$3);
      _tmp = limit$3;
      _tmp$2 = right;
      _tmp$3 = _M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr$2, _pivot);
      _tmp$4 = _partitioned;
      _tmp$5 = balanced$2;
      continue;
    } else {
      _M0FPB22fixed__quick__sort__byGRP38bobzhang6kanban6shared6ColumnE(right, cmp, _M0MPC15array12MutArrayView2atGRP38bobzhang6kanban6shared6ColumnE(arr$2, _pivot), limit$3);
      _tmp = limit$3;
      _tmp$2 = left;
      _tmp$4 = _partitioned;
      _tmp$5 = balanced$2;
...
function _M0IP38bobzhang6kanban6shared5BoardPC14json8FromJson10from__json(_x_118, _x_119) {
  const _de_columns_121 = new _M0TPB8MutLocalGORPB5ArrayGRP38bobzhang6kanban6shared6ColumnEE(_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang6kanban6shared6ColumnEE4None__);
  const _de_cards_120 = new _M0TPB8MutLocalGORPB5ArrayGRP38bobzhang6kanban6shared4CardEE(_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang6kanban6shared4CardEE4None__);
  let _map;
  _L: {
    if (_x_118.$tag === 6) {
      const _Object = _x_118;
      const __map = _Object._0;
      _map = __map;
      break _L;
    } else {
      return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared5BoardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_119, _1: "Expected object to deserialize Board" }));
    }
  }
  let _v;
  _L$2: {
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang6kanban6shared6ColumnE(_v, _M0MPC14json8JsonPath8add__key(_x_119, "columns"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_columns_121.val = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang6kanban6shared6ColumnEE4Some(_tmp);
  }
  let _v$2;
  _L$3: {
    _L$4: {
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang6kanban6shared4CardE(_v$2, _M0MPC14json8JsonPath8add__key(_x_119, "cards"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_cards_120.val = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang6kanban6shared4CardEE4Some(_tmp);
  }
  let _de_columns_121$2;
  const _bind = _de_columns_121.val;
  if (_bind.$tag === 1) {
    const _Some = _bind;
    const _v$3 = _Some._0;
    _de_columns_121$2 = _v$3;
  } else {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared5BoardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_119, _1: "Missing field columns" }));
  }
  let _de_cards_120$2;
  const _bind$2 = _de_cards_120.val;
  if (_bind$2.$tag === 1) {
    const _Some = _bind$2;
    const _v$3 = _Some._0;
    _de_cards_120$2 = _v$3;
  } else {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared5BoardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_119, _1: "Missing field cards" }));
  }
  return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared5BoardRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang6kanban6shared5Board(_de_columns_121$2, _de_cards_120$2));
}
function _M0IP38bobzhang6kanban6shared6ColumnPC14json8FromJson10from__json(_x_89, _x_90) {
  const _de_title_93 = new _M0TPB8MutLocalGOsE(undefined);
  const _de_position_92 = new _M0TPB8MutLocalGOiE(undefined);
  const _de_id_91 = new _M0TPB8MutLocalGOiE(undefined);
  let _map;
  _L: {
    if (_x_89.$tag === 6) {
      const _Object = _x_89;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared6ColumnRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_90, _1: "Expected object to deserialize Column" }));
    }
  }
  let _v;
  _L$2: {
  ...
  _L$3: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_90, "title"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$4: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_90, "position"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_position_92.val = _tmp;
  }
  let _de_title_93$2;
  const _bind = _de_title_93.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared6ColumnRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_90, _1: "Missing field title" }));
  } else {
    const _Some = _bind;
    const _v$4 = _Some;
    _de_title_93$2 = _v$4;
  }
  let _de_position_92$2;
  const _bind$2 = _de_position_92.val;
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared6ColumnRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_90, _1: "Missing field position" }));
  } else {
    const _Some = _bind$2;
    const _v$4 = _Some;
    _de_position_92$2 = _v$4;
  }
  let _de_id_91$2;
  const _bind$3 = _de_id_91.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared6ColumnRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_90, _1: "Missing field id" }));
  } else {
    const _Some = _bind$3;
    const _v$4 = _Some;
    _de_id_91$2 = _v$4;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared6ColumnRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang6kanban6shared6Column(_de_id_91$2, _de_title_93$2, _de_position_92$2));
}
function _M0IP38bobzhang6kanban6shared4CardPC14json8FromJson10from__json(_x_45, _x_46) {
  const _de_title_52 = new _M0TPB8MutLocalGOsE(undefined);
  const _de_position_51 = new _M0TPB8MutLocalGOiE(undefined);
  const _de_id_50 = new _M0TPB8MutLocalGOiE(undefined);
  const _de_description_49 = new _M0TPB8MutLocalGOsE(undefined);
  const _de_column_id_48 = new _M0TPB8MutLocalGOiE(undefined);
  const _de_color_47 = new _M0TPB8MutLocalGOsE(undefined);
  let _map;
  _L: {
    if (_x_45.$tag === 6) {
      const _Object = _x_45;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_46, _1: "Expected object to deserialize Card" }));
    }
  }
  let _v;
  _L$2: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v, _M0MPC14json8JsonPath8add__key(_x_46, "id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$3: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_46, "column_id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$4: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_46, "title"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$5: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$4, _M0MPC14json8JsonPath8add__key(_x_46, "description"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$6: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$5, _M0MPC14json8JsonPath8add__key(_x_46, "color"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$7: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$6, _M0MPC14json8JsonPath8add__key(_x_46, "position"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_position_51.val = _tmp;
  }
  let _de_title_52$2;
  const _bind = _de_title_52.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_46, _1: "Missing field title" }));
  } else {
    const _Some = _bind;
    const _v$7 = _Some;
    _de_title_52$2 = _v$7;
  }
  let _de_position_51$2;
  const _bind$2 = _de_position_51.val;
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_46, _1: "Missing field position" }));
  } else {
    const _Some = _bind$2;
    const _v$7 = _Some;
    _de_position_51$2 = _v$7;
  }
  let _de_id_50$2;
  const _bind$3 = _de_id_50.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_46, _1: "Missing field id" }));
  } else {
    const _Some = _bind$3;
    const _v$7 = _Some;
    _de_id_50$2 = _v$7;
  }
  let _de_description_49$2;
  const _bind$4 = _de_description_49.val;
  if (_bind$4 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_46, _1: "Missing field description" }));
  } else {
    const _Some = _bind$4;
    const _v$7 = _Some;
    _de_description_49$2 = _v$7;
  }
  let _de_column_id_48$2;
  const _bind$5 = _de_column_id_48.val;
  if (_bind$5 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_46, _1: "Missing field column_id" }));
  } else {
    const _Some = _bind$5;
    const _v$7 = _Some;
    _de_column_id_48$2 = _v$7;
  }
  let _de_color_47$2;
  const _bind$6 = _de_color_47.val;
  if (_bind$6 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_46, _1: "Missing field color" }));
  } else {
    const _Some = _bind$6;
    const _v$7 = _Some;
    _de_color_47$2 = _v$7;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang6kanban6shared4CardRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang6kanban6shared4Card(_de_id_50$2, _de_column_id_48$2, _de_title_52$2, _de_description_49$2, _de_color_47$2, _de_position_51$2));
}
function _M0FP38bobzhang6kanban6shared21validate__card__title(title) {
  return !_M0MPC16string6String9is__empty(title) && _M0MPC16string6String20char__length_2einner(title, 0, undefined) <= _M0FP38bobzhang6kanban6shared16max__card__title;
}
function _M0FP38bobzhang6kanban6shared23validate__column__title(title) {
  return !_M0MPC16string6String9is__empty(title) && _M0MPC16string6String20char__length_2einner(title, 0, undefined) <= _M0FP38bobzhang6kanban6shared18max__column__title;
}
...
function _M0FP48bobzhang6kanban8frontend3app19view__color__picker(dispatch, current, on_change) {
  return _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "gap: 4px", "margin-bottom: 8px", "flex-wrap: wrap"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, _M0MPC15array5Array3mapGsRP319moonbit_2dcommunity7rabbita4html4HtmlE(_M0FP38bobzhang6kanban6shared13valid__colors, (c) => {
    const bg = _M0MPC16string6String9is__empty(c) ? "#f1f5f9" : _M0FP38bobzhang6kanban6shared14color__to__css(c);
                    ...
                    _L$10: {
                      ...
                      _L$11: {
                        ...
                        _L$12: {
                          ...
                          let target_idx$2;
                          if (msg.$tag === 14) {
                            target_idx$2 = idx - 1 | 0;
                          } else {
                            target_idx$2 = idx + 1 | 0;
                          }
                          if (idx < 0 || (target_idx$2 < 0 || target_idx$2 >= sorted.length)) {
                            return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                          }
                          const other = _M0MPC15array5Array2atGRP38bobzhang6kanban6shared6ColumnE(sorted, target_idx$2);
                          const this_col = _M0MPC15array5Array2atGRP38bobzhang6kanban6shared6ColumnE(sorted, idx);
