...
function _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE2Ok.prototype.$tag = 1;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE2Ok.prototype.$tag = 1;
...
function _M0TPB12MutArrayViewGRP38bobzhang7noteapp6shared4NoteE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
...
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
...
function _M0TPC15queue5QueueGRP48bobzhang7noteapp8frontend3app3MsgE(param0, param1, param2) {
  this.length = param0;
  this.first = param1;
  this.last = param2;
}
...
function _M0TPC13ref3RefGRP48bobzhang7noteapp8frontend3app5ModelE(param0) {
  this.val = param0;
}
...
function _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang7noteapp6shared4Note(param0, param1, param2, param3) {
  this.id = param0;
  this.title = param1;
  this.content = param2;
  this.pinned = param3;
...
function _M0TP38bobzhang7noteapp6shared9NoteStats(param0, param1, param2) {
  this.word_count = param0;
  this.char_count = param1;
  this.reading_time_secs = param2;
}
...
function _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang7noteapp8frontend3app3MsgE(param0, param1) {
  this.id = param0;
  this.inbox = param1;
}
function _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE(param0, param1, param2, param3, param4, param5) {
  this.model = param0;
...
function _M0DTP48bobzhang7noteapp8frontend3app3Msg4Init() {}
_M0DTP48bobzhang7noteapp8frontend3app3Msg4Init.prototype.$tag = 0;
const _M0DTP48bobzhang7noteapp8frontend3app3Msg4Init__ = new _M0DTP48bobzhang7noteapp8frontend3app3Msg4Init();
function _M0DTP48bobzhang7noteapp8frontend3app3Msg8GotNotes(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg8GotNotes.prototype.$tag = 1;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg17TitleInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg17TitleInputChanged.prototype.$tag = 2;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg19ContentInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg19ContentInputChanged.prototype.$tag = 3;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg8SaveNote() {}
_M0DTP48bobzhang7noteapp8frontend3app3Msg8SaveNote.prototype.$tag = 4;
const _M0DTP48bobzhang7noteapp8frontend3app3Msg8SaveNote__ = new _M0DTP48bobzhang7noteapp8frontend3app3Msg8SaveNote();
function _M0DTP48bobzhang7noteapp8frontend3app3Msg9NoteSaved(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg9NoteSaved.prototype.$tag = 5;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg10SelectNote(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg10SelectNote.prototype.$tag = 6;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg12DeselectNote() {}
_M0DTP48bobzhang7noteapp8frontend3app3Msg12DeselectNote.prototype.$tag = 7;
const _M0DTP48bobzhang7noteapp8frontend3app3Msg12DeselectNote__ = new _M0DTP48bobzhang7noteapp8frontend3app3Msg12DeselectNote();
function _M0DTP48bobzhang7noteapp8frontend3app3Msg9TogglePin(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg9TogglePin.prototype.$tag = 8;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg14NotePinToggled(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg14NotePinToggled.prototype.$tag = 9;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg10DeleteNote(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg10DeleteNote.prototype.$tag = 10;
function _M0DTP48bobzhang7noteapp8frontend3app3Msg11NoteDeleted(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7noteapp8frontend3app3Msg11NoteDeleted.prototype.$tag = 11;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE4Text.prototype.$tag = 1;
function _M0TPB9ArrayViewGUsRPB4JsonEE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7noteapp6shared4NoteE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7noteapp6shared4NoteE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7noteapp6shared4NoteE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7noteapp6shared4NoteE4Text.prototype.$tag = 1;
function _M0TP48bobzhang7noteapp8frontend3app5Model(param0, param1, param2, param3) {
  this.notes = param0;
  this.title_input = param1;
  this.content_input = param2;
  this.selected_note_id = param3;
}
...
const _M0FP0207moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fnoteapp_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fnoteapp_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell = { method_0: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE, method_1: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE, method_2: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE };
...
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1969 = { _0: 0, _1: "" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1970 = { _0: 1, _1: "5" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1971 = { _0: 1, _1: "25" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1972 = { _0: 1, _1: "125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1973 = { _0: 2, _1: "625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1974 = { _0: 2, _1: "3125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1975 = { _0: 2, _1: "15625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1976 = { _0: 3, _1: "78125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1977 = { _0: 3, _1: "390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1978 = { _0: 3, _1: "1953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1979 = { _0: 4, _1: "9765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1980 = { _0: 4, _1: "48828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1981 = { _0: 4, _1: "244140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1982 = { _0: 4, _1: "1220703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1983 = { _0: 5, _1: "6103515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1984 = { _0: 5, _1: "30517578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1985 = { _0: 5, _1: "152587890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1986 = { _0: 6, _1: "762939453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1987 = { _0: 6, _1: "3814697265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1988 = { _0: 6, _1: "19073486328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1989 = { _0: 7, _1: "95367431640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1990 = { _0: 7, _1: "476837158203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1991 = { _0: 7, _1: "2384185791015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1992 = { _0: 7, _1: "11920928955078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1993 = { _0: 8, _1: "59604644775390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1994 = { _0: 8, _1: "298023223876953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1995 = { _0: 8, _1: "1490116119384765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1996 = { _0: 9, _1: "7450580596923828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1997 = { _0: 9, _1: "37252902984619140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1998 = { _0: 9, _1: "186264514923095703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1999 = { _0: 10, _1: "931322574615478515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2000 = { _0: 10, _1: "4656612873077392578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2001 = { _0: 10, _1: "23283064365386962890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2002 = { _0: 10, _1: "116415321826934814453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2003 = { _0: 11, _1: "582076609134674072265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2004 = { _0: 11, _1: "2910383045673370361328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2005 = { _0: 11, _1: "14551915228366851806640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2006 = { _0: 12, _1: "72759576141834259033203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2007 = { _0: 12, _1: "363797880709171295166015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2008 = { _0: 12, _1: "1818989403545856475830078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2009 = { _0: 13, _1: "9094947017729282379150390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2010 = { _0: 13, _1: "45474735088646411895751953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2011 = { _0: 13, _1: "227373675443232059478759765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2012 = { _0: 13, _1: "1136868377216160297393798828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2013 = { _0: 14, _1: "5684341886080801486968994140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2014 = { _0: 14, _1: "28421709430404007434844970703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2015 = { _0: 14, _1: "142108547152020037174224853515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2016 = { _0: 15, _1: "710542735760100185871124267578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2017 = { _0: 15, _1: "3552713678800500929355621337890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2018 = { _0: 15, _1: "17763568394002504646778106689453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2019 = { _0: 16, _1: "88817841970012523233890533447265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2020 = { _0: 16, _1: "444089209850062616169452667236328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2021 = { _0: 16, _1: "2220446049250313080847263336181640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2022 = { _0: 16, _1: "11102230246251565404236316680908203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2023 = { _0: 17, _1: "55511151231257827021181583404541015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2024 = { _0: 17, _1: "277555756156289135105907917022705078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2025 = { _0: 17, _1: "1387778780781445675529539585113525390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2026 = { _0: 18, _1: "6938893903907228377647697925567626953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2027 = { _0: 18, _1: "34694469519536141888238489627838134765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2028 = { _0: 18, _1: "173472347597680709441192448139190673828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2029 = { _0: 19, _1: "867361737988403547205962240695953369140625" };
const _M0FPC17strconv19left__shift__cheats = [_M0FPC17strconv34left__shift__cheats_2etuple_2f1969, _M0FPC17strconv34left__shift__cheats_2etuple_2f1970, _M0FPC17strconv34left__shift__cheats_2etuple_2f1971, _M0FPC17strconv34left__shift__cheats_2etuple_2f1972, _M0FPC17strconv34left__shift__cheats_2etuple_2f1973, _M0FPC17strconv34left__shift__cheats_2etuple_2f1974, _M0FPC17strconv34left__shift__cheats_2etuple_2f1975, _M0FPC17strconv34left__shift__cheats_2etuple_2f1976, _M0FPC17strconv34left__shift__cheats_2etuple_2f1977, _M0FPC17strconv34left__shift__cheats_2etuple_2f1978, _M0FPC17strconv34left__shift__cheats_2etuple_2f1979, _M0FPC17strconv34left__shift__cheats_2etuple_2f1980, _M0FPC17strconv34left__shift__cheats_2etuple_2f1981, _M0FPC17strconv34left__shift__cheats_2etuple_2f1982, _M0FPC17strconv34left__shift__cheats_2etuple_2f1983, _M0FPC17strconv34left__shift__cheats_2etuple_2f1984, _M0FPC17strconv34left__shift__cheats_2etuple_2f1985, _M0FPC17strconv34left__shift__cheats_2etuple_2f1986, _M0FPC17strconv34left__shift__cheats_2etuple_2f1987, _M0FPC17strconv34left__shift__cheats_2etuple_2f1988, _M0FPC17strconv34left__shift__cheats_2etuple_2f1989, _M0FPC17strconv34left__shift__cheats_2etuple_2f1990, _M0FPC17strconv34left__shift__cheats_2etuple_2f1991, _M0FPC17strconv34left__shift__cheats_2etuple_2f1992, _M0FPC17strconv34left__shift__cheats_2etuple_2f1993, _M0FPC17strconv34left__shift__cheats_2etuple_2f1994, _M0FPC17strconv34left__shift__cheats_2etuple_2f1995, _M0FPC17strconv34left__shift__cheats_2etuple_2f1996, _M0FPC17strconv34left__shift__cheats_2etuple_2f1997, _M0FPC17strconv34left__shift__cheats_2etuple_2f1998, _M0FPC17strconv34left__shift__cheats_2etuple_2f1999, _M0FPC17strconv34left__shift__cheats_2etuple_2f2000, _M0FPC17strconv34left__shift__cheats_2etuple_2f2001, _M0FPC17strconv34left__shift__cheats_2etuple_2f2002, _M0FPC17strconv34left__shift__cheats_2etuple_2f2003, _M0FPC17strconv34left__shift__cheats_2etuple_2f2004, _M0FPC17strconv34left__shift__cheats_2etuple_2f2005, _M0FPC17strconv34left__shift__cheats_2etuple_2f2006, _M0FPC17strconv34left__shift__cheats_2etuple_2f2007, _M0FPC17strconv34left__shift__cheats_2etuple_2f2008, _M0FPC17strconv34left__shift__cheats_2etuple_2f2009, _M0FPC17strconv34left__shift__cheats_2etuple_2f2010, _M0FPC17strconv34left__shift__cheats_2etuple_2f2011, _M0FPC17strconv34left__shift__cheats_2etuple_2f2012, _M0FPC17strconv34left__shift__cheats_2etuple_2f2013, _M0FPC17strconv34left__shift__cheats_2etuple_2f2014, _M0FPC17strconv34left__shift__cheats_2etuple_2f2015, _M0FPC17strconv34left__shift__cheats_2etuple_2f2016, _M0FPC17strconv34left__shift__cheats_2etuple_2f2017, _M0FPC17strconv34left__shift__cheats_2etuple_2f2018, _M0FPC17strconv34left__shift__cheats_2etuple_2f2019, _M0FPC17strconv34left__shift__cheats_2etuple_2f2020, _M0FPC17strconv34left__shift__cheats_2etuple_2f2021, _M0FPC17strconv34left__shift__cheats_2etuple_2f2022, _M0FPC17strconv34left__shift__cheats_2etuple_2f2023, _M0FPC17strconv34left__shift__cheats_2etuple_2f2024, _M0FPC17strconv34left__shift__cheats_2etuple_2f2025, _M0FPC17strconv34left__shift__cheats_2etuple_2f2026, _M0FPC17strconv34left__shift__cheats_2etuple_2f2027, _M0FPC17strconv34left__shift__cheats_2etuple_2f2028, _M0FPC17strconv34left__shift__cheats_2etuple_2f2029];
...
const _M0FP38bobzhang7noteapp6shared18max__title__length = 100;
const _M0FP38bobzhang7noteapp6shared20max__content__length = 5000;
const _M0FP38bobzhang7noteapp6shared10api__notes = "/api/notes";
...
const _M0FPB33brute__force__find_2econstr_2f410 = 0;
const _M0FPB43boyer__moore__horspool__find_2econstr_2f396 = 0;
...
const _M0FPC17strconv28checked__mul_2econstr_2f2449 = $0L;
...
function _M0FPB28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB43boyer__moore__horspool__find_2econstr_2f396;
  }
}
function _M0FPB18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB33brute__force__find_2econstr_2f410;
  }
}
...
function _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(self, value) {
...
function _M0MPB4Iter9to__arrayGRPC16string10StringViewE(self) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(result, _x);
      continue;
    }
  }
  return result;
...
function _M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang7noteapp6shared4NoteE(self, g) {
  if (self.$tag === 1) {
    const _Ok = self;
    const _value = _Ok._0;
    return g(_value);
    ...
    const _Err = self;
    const _err = _Err._0;
    return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE3Err(_err);
  }
}
function _M0MPC16result6Result4bindGRPB4JsonsRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(self, g) {
  if (self.$tag === 1) {
    const _Ok = self;
    const _value = _Ok._0;
    return g(_value);
    ...
    const _Err = self;
    const _err = _Err._0;
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE3Err(_err);
  }
}
...
function _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(self) {
  return self.end - self.start | 0;
}
function _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(self, index) {
...
function _M0MPC15array12MutArrayView3setGRP38bobzhang7noteapp6shared4NoteE(self, index, value) {
  if (index >= 0 && index < (self.end - self.start | 0)) {
    const _tmp = self.buf;
    const _tmp$2 = self.start + index | 0;
    $bound_check(_tmp, _tmp$2);
...
function _M0MPC15array5Array17mut__view_2einnerGRP38bobzhang7noteapp6shared4NoteE(self, start, end) {
  const len = self.length;
  let end$2;
  if (end === undefined) {
    end$2 = len;
  ...
  if (start$2 >= 0 && (start$2 <= end$2 && end$2 <= len)) {
    ...
    return new _M0TPB12MutArrayViewGRP38bobzhang7noteapp6shared4NoteE(_bind, start$2, start$2 + _bind$2 | 0);
  } else {
...
function _M0MPC15array12MutArrayView17mut__view_2einnerGRP38bobzhang7noteapp6shared4NoteE(self, start, end) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(self);
  let end$2;
  if (end === undefined) {
    end$2 = len;
  } else {
  ...
  if (start$2 >= 0 && (start$2 <= end$2 && end$2 <= len)) {
    ...
    return new _M0TPB12MutArrayViewGRP38bobzhang7noteapp6shared4NoteE(_bind, _bind$2, _bind$2 + _bind$3 | 0);
  } else {
...
function _M0MPC15array5Array3mapGRP38bobzhang7noteapp6shared4NoteRP38bobzhang7noteapp6shared4NoteE(self, f) {
...
function _M0MPC15array5Array3mapGRP38bobzhang7noteapp6shared4NoteRP319moonbit_2dcommunity7rabbita4html4HtmlE(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0MPC15array5Array4copyGRP38bobzhang7noteapp6shared4NoteE(self) {
  return _M0MPB7JSArray4copy(self);
}
function _M0FPB7minimum(x, y) {
  return x > y ? y : x;
}
function _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, i, j) {
  const temp = _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, i);
  _M0MPC15array12MutArrayView3setGRP38bobzhang7noteapp6shared4NoteE(arr, i, _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, j));
  _M0MPC15array12MutArrayView3setGRP38bobzhang7noteapp6shared4NoteE(arr, j, temp);
}
function _M0MPC15array12MutArrayView5sliceGRP38bobzhang7noteapp6shared4NoteE(arr, start, end) {
  return _M0MPC15array12MutArrayView17mut__view_2einnerGRP38bobzhang7noteapp6shared4NoteE(arr, start, end);
}
function _M0MPC15array12MutArrayView14rev__in__placeGRP38bobzhang7noteapp6shared4NoteE(arr) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr);
  if (2 === 0) {
    $panic();
  }
...
function _M0FPB23fixed__bubble__sort__byGRP38bobzhang7noteapp6shared4NoteE(arr, cmp) {
  const _bind = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr);
  let _tmp = 1;
  while (true) {
    const i = _tmp;
    if (i < _bind) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j > 0 && cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, j - 1 | 0), _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, j)) > 0) {
          _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, j, j - 1 | 0);
          _tmp$2 = j - 1 | 0;
          continue;
        } else {
          break;
...
function _M0FPB41fixed__choose__pivot__by_2esort__2_2f1826(_env, a, b) {
  const swaps = _env._2;
  const arr = _env._1;
  const cmp = _env._0;
  if (cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, a), _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, b)) > 0) {
    _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, a, b);
...
function _M0FPB41fixed__choose__pivot__by_2esort__3_2f1827(_env, a, b, c) {
  _M0FPB41fixed__choose__pivot__by_2esort__2_2f1826(_env, a, b);
  _M0FPB41fixed__choose__pivot__by_2esort__2_2f1826(_env, b, c);
  _M0FPB41fixed__choose__pivot__by_2esort__2_2f1826(_env, a, b);
}
function _M0FPB24fixed__choose__pivot__byGRP38bobzhang7noteapp6shared4NoteE(arr, cmp) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr);
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FPB41fixed__choose__pivot__by_2esort__3_2f1827(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FPB41fixed__choose__pivot__by_2esort__3_2f1827(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FPB41fixed__choose__pivot__by_2esort__3_2f1827(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FPB41fixed__choose__pivot__by_2esort__3_2f1827(_env, a, b, c);
  }
  if (swaps.val === 12) {
    _M0MPC15array12MutArrayView14rev__in__placeGRP38bobzhang7noteapp6shared4NoteE(arr);
    return { _0: (len - b | 0) - 1 | 0, _1: true };
  } else {
    return { _0: b, _1: swaps.val === 0 };
  }
}
function _M0FPB21fixed__sift__down__byGRP38bobzhang7noteapp6shared4NoteE(arr, index, cmp) {
  let index$2 = index;
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr);
  let child = (Math.imul(index$2, 2) | 0) + 1 | 0;
  while (true) {
    if (child < len) {
      if ((child + 1 | 0) < len && cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, child), _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, child + 1 | 0)) < 0) {
        child = child + 1 | 0;
      }
      if (cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, index$2), _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, child)) >= 0) {
        return undefined;
      }
      _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, index$2, child);
      index$2 = child;
...
function _M0FPB21fixed__heap__sort__byGRP38bobzhang7noteapp6shared4NoteE(arr, cmp) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr);
  if (2 === 0) {
    $panic();
  }
  ...
  while (true) {
    const i = _tmp;
    if (i >= 0) {
      _M0FPB21fixed__sift__down__byGRP38bobzhang7noteapp6shared4NoteE(arr, i, cmp);
      _tmp = i - 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    const i = _tmp$2;
    if (i >= 1) {
      _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, 0, i);
      _M0FPB21fixed__sift__down__byGRP38bobzhang7noteapp6shared4NoteE(_M0MPC15array12MutArrayView5sliceGRP38bobzhang7noteapp6shared4NoteE(arr, 0, i), 0, cmp);
      _tmp$2 = i - 1 | 0;
      continue;
    } else {
      return;
...
function _M0FPB20fixed__partition__byGRP38bobzhang7noteapp6shared4NoteE(arr, cmp, pivot_index) {
  _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, pivot_index, _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr) - 1 | 0);
  const pivot = _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr) - 1 | 0);
  let i = 0;
  let partitioned = true;
  const _bind = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr) - 1 | 0;
  let _tmp = 0;
  while (true) {
    const j = _tmp;
    if (j < _bind) {
      if (cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr, j), pivot) < 0) {
        if (i !== j) {
          _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, i, j);
          partitioned = false;
        }
        i = i + 1 | 0;
      }
  ...
  _M0MPC15array12MutArrayView4swapGRP38bobzhang7noteapp6shared4NoteE(arr, i, _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr) - 1 | 0);
  return { _0: i, _1: partitioned };
}
function _M0FPB28fixed__try__bubble__sort__byGRP38bobzhang7noteapp6shared4NoteE(arr, cmp) {
  let tries = 0;
  const _bind = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr);
  let _tmp = 1;
  while (true) {
...
function _M0FPB22fixed__quick__sort__byGRP38bobzhang7noteapp6shared4NoteE(arr, cmp, pred, limit) {
  let limit$2 = limit;
  let arr$2 = arr;
  let pred$2 = pred;
  ...
  let balanced = true;
  while (true) {
    const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(arr$2);
    if (len <= 16) {
      if (len >= 2) {
        _M0FPB23fixed__bubble__sort__byGRP38bobzhang7noteapp6shared4NoteE(arr$2, cmp);
      }
      return undefined;
    }
    if (limit$2 === 0) {
      _M0FPB21fixed__heap__sort__byGRP38bobzhang7noteapp6shared4NoteE(arr$2, cmp);
      return undefined;
    }
    const _bind = _M0FPB24fixed__choose__pivot__byGRP38bobzhang7noteapp6shared4NoteE(arr$2, cmp);
    const _pivot_index = _bind._0;
    const _likely_sorted = _bind._1;
    if (was_partitioned && (balanced && _likely_sorted)) {
      if (_M0FPB28fixed__try__bubble__sort__byGRP38bobzhang7noteapp6shared4NoteE(arr$2, cmp)) {
        return undefined;
      }
    }
    const _bind$2 = _M0FPB20fixed__partition__byGRP38bobzhang7noteapp6shared4NoteE(arr$2, cmp, _pivot_index);
    ...
    if (_bind$3 === undefined) {
      ...
      const _Some = _bind$3;
      const _pred = _Some;
      if (cmp(_pred, _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr$2, _pivot)) === 0) {
        let i = _pivot;
        while (true) {
          if (i < len && cmp(_pred, _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr$2, i)) === 0) {
            i = i + 1 | 0;
            continue;
          } else {
            break;
        ...
        arr$2 = _M0MPC15array12MutArrayView5sliceGRP38bobzhang7noteapp6shared4NoteE(arr$2, i, len);
        continue;
      }
    }
    const left = _M0MPC15array12MutArrayView5sliceGRP38bobzhang7noteapp6shared4NoteE(arr$2, 0, _pivot);
    const right = _M0MPC15array12MutArrayView5sliceGRP38bobzhang7noteapp6shared4NoteE(arr$2, _pivot + 1 | 0, len);
    if (_M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(left) < _M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(right)) {
      _M0FPB22fixed__quick__sort__byGRP38bobzhang7noteapp6shared4NoteE(left, cmp, pred$2, limit$2);
      pred$2 = _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr$2, _pivot);
      arr$2 = right;
    } else {
      _M0FPB22fixed__quick__sort__byGRP38bobzhang7noteapp6shared4NoteE(right, cmp, _M0MPC15array12MutArrayView2atGRP38bobzhang7noteapp6shared4NoteE(arr$2, _pivot), limit$2);
      arr$2 = left;
    }
    continue;
  }
}
function _M0MPC15array12MutArrayView8sort__byGRP38bobzhang7noteapp6shared4NoteE(self, cmp) {
  _M0FPB22fixed__quick__sort__byGRP38bobzhang7noteapp6shared4NoteE(self, cmp, undefined, _M0FPB17fixed__get__limit(_M0MPC15array12MutArrayView6lengthGRP38bobzhang7noteapp6shared4NoteE(self)));
}
function _M0MPC15array5Array8sort__byGRP38bobzhang7noteapp6shared4NoteE(self, cmp) {
  _M0MPC15array12MutArrayView8sort__byGRP38bobzhang7noteapp6shared4NoteE(_M0MPC15array5Array17mut__view_2einnerGRP38bobzhang7noteapp6shared4NoteE(self, 0, undefined), cmp);
}
...
function _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang7noteapp6shared4NoteEHRPC14json15JsonDecodeError(self, f) {
  if (self.length === 0) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE2Ok([]);
  }
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE2Ok(arr);
}
function _M0MPC15array5Array6filterGRP38bobzhang7noteapp6shared4NoteE(self, f) {
  const arr = [];
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0MPC15array5Array10push__iterGRP419moonbit_2dcommunity7rabbita8internal7runtime5INodeE(self, iter) {
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(self, _x);
      continue;
    }
  }
}
...
function _M0FPC17strconv12checked__mul(a, b) {
  if (_M0IPC16uint646UInt64PB2Eq5equal(a, $0L) || _M0IPC16uint646UInt64PB2Eq5equal(b, $0L)) {
    return _M0FPC17strconv28checked__mul_2econstr_2f2449;
  }
...
function _M0FPC14json13decode__errorGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(path, msg) {
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: path, _1: msg }));
}
...
function _M0MPC14json12ParseContext12parse__array(ctx) {
  ...
  _L: while (true) {
    ...
    if (_param.$tag === 8) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(vec, _tmp$4);
      ...
      switch (_value.$tag) {
        case 6: {
          ...
          if (_M0MPB3Map9is__emptyGsRPB4JsonE(_members)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(stack, new _M0DTPC14json10WriteFrame6Object(_M0MPB3Map4iterGsWRP319moonbit_2dcommunity7rabbita3dom5EventRP419moonbit_2dcommunity7rabbita8internal7runtime9SchedulerEuE(_members), true));
          }
          break;
        }
        case 5: {
          ...
          if (_M0MPC15array5Array9is__emptyGRPB4JsonE(_arr)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(stack, new _M0DTPC14json10WriteFrame5Array(_arr, 0));
          }
          break;
        }
        case 4: {
...
function _M0FPC14json18from__json_2einnerGRP38bobzhang7noteapp6shared4NoteE(json, path) {
  return _M0IP38bobzhang7noteapp6shared4NotePC14json8FromJson10from__json(json, path);
}
function _M0FPC14json18from__json_2einnerGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(json, path) {
  return _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang7noteapp6shared4NoteE(json, path);
}
function _M0FPC14json10from__jsonGRP38bobzhang7noteapp6shared4NoteE(json, path$46$opt) {
  let path;
  ...
  return _M0FPC14json18from__json_2einnerGRP38bobzhang7noteapp6shared4NoteE(json, path);
}
function _M0FPC14json10from__jsonGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(json, path$46$opt) {
  let path;
  if (path$46$opt === undefined) {
    path = _M0DTPC14json8JsonPath4Root__;
  } else {
  ...
  return _M0FPC14json18from__json_2einnerGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(json, path);
}
...
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang7noteapp6shared4NoteE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    ...
    if (_bind.$tag === 2) {
      const _Index = _bind;
      return _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang7noteapp6shared4NoteEHRPC14json15JsonDecodeError(_a, (i, x) => {
        _Index._1 = i;
        return _M0IP38bobzhang7noteapp6shared4NotePC14json8FromJson10from__json(x, _Index);
      });
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    return _M0FPC14json13decode__errorGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(path, "Array::from_json: expected array");
  }
}
function _M0MPC15queue5Queue3newGRP48bobzhang7noteapp8frontend3app3MsgE() {
  return new _M0TPC15queue5QueueGRP48bobzhang7noteapp8frontend3app3MsgE(0, undefined, undefined);
}
...
function _M0FPC13ref3newGRP48bobzhang7noteapp8frontend3app5ModelE(x) {
  return new _M0TPC13ref3RefGRP48bobzhang7noteapp8frontend3app5ModelE(x);
}
...
function _M0IP38bobzhang7noteapp6shared4NotePC14json8FromJson10from__json(_x_27, _x_28) {
  const _de_title_32 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_pinned_31 = new _M0TPC13ref3RefGObE(-1);
  const _de_id_30 = new _M0TPC13ref3RefGOiE(undefined);
  const _de_content_29 = new _M0TPC13ref3RefGOsE(undefined);
  let _map;
  _L: {
    if (_x_27.$tag === 6) {
      const _Object = _x_27;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_28, _1: "Expected object to deserialize Note" }));
    }
  }
  let _v;
  _L$2: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v, _M0MPC14json8JsonPath8add__key(_x_28, "id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$3: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_28, "title"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$4: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_28, "content"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_content_29.val = _tmp;
  }
  let _v$4;
  _L$5: {
    _L$6: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "pinned");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC14bool4BoolPC14json8FromJson10from__json(_v$4, _M0MPC14json8JsonPath8add__key(_x_28, "pinned"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_pinned_31.val = _tmp;
  }
  let _de_title_32$2;
  const _bind = _de_title_32.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_28, _1: "Missing field title" }));
  } else {
    const _Some = _bind;
    const _v$5 = _Some;
    _de_title_32$2 = _v$5;
  ...
  let _de_pinned_31$2;
  const _bind$2 = _de_pinned_31.val;
  if (_bind$2 === -1) {
    return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_28, _1: "Missing field pinned" }));
  } else {
    const _Some = _bind$2;
    const _v$5 = _Some;
    _de_pinned_31$2 = _v$5;
  }
  let _de_id_30$2;
  const _bind$3 = _de_id_30.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_28, _1: "Missing field id" }));
  } else {
    const _Some = _bind$3;
    const _v$5 = _Some;
    _de_id_30$2 = _v$5;
  }
  let _de_content_29$2;
  const _bind$4 = _de_content_29.val;
  if (_bind$4 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_28, _1: "Missing field content" }));
  } else {
    const _Some = _bind$4;
    const _v$5 = _Some;
    _de_content_29$2 = _v$5;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NoteRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang7noteapp6shared4Note(_de_id_30$2, _de_title_32$2, _de_content_29$2, _de_pinned_31$2));
}
function _M0FP38bobzhang7noteapp6shared15validate__title(title) {
  return _M0IP016_24default__implPB2Eq10not__equalGsE(title, "") && _M0MPC16string6String20char__length_2einner(title, 0, undefined) <= _M0FP38bobzhang7noteapp6shared18max__title__length;
}
function _M0FP38bobzhang7noteapp6shared17validate__content(content) {
  return _M0IP016_24default__implPB2Eq10not__equalGsE(content, "") && _M0MPC16string6String20char__length_2einner(content, 0, undefined) <= _M0FP38bobzhang7noteapp6shared20max__content__length;
}
function _M0FP38bobzhang7noteapp6shared9api__note(id) {
  return `/api/notes/${_M0IP016_24default__implPB4Show10to__stringGiE(id)}`;
}
function _M0FP38bobzhang7noteapp6shared14api__note__pin(id) {
  return `/api/notes/${_M0IP016_24default__implPB4Show10to__stringGiE(id)}/pin`;
}
function _M0FP38bobzhang7noteapp6shared11word__count(text) {
  if (text === "") {
    return 0;
  }
  const count = new _M0TPC13ref3RefGiE(0);
  const in_word = new _M0TPC13ref3RefGbE(false);
...
function _M0FP38bobzhang7noteapp6shared11char__count(text) {
  return _M0MPC16string6String20char__length_2einner(text, 0, undefined);
}
function _M0FP38bobzhang7noteapp6shared19reading__time__secs(text) {
  const words = _M0FP38bobzhang7noteapp6shared11word__count(text);
  if (10 === 0) {
    $panic();
  }
  const secs = (Math.imul(words, 3) | 0) / 10 | 0;
  return secs < 1 && words > 0 ? 1 : secs;
}
function _M0FP38bobzhang7noteapp6shared14compute__stats(content) {
  return new _M0TP38bobzhang7noteapp6shared9NoteStats(_M0FP38bobzhang7noteapp6shared11word__count(content), _M0FP38bobzhang7noteapp6shared11char__count(content), _M0FP38bobzhang7noteapp6shared19reading__time__secs(content));
}
function _M0FP38bobzhang7noteapp6shared8truncate(text, max_len) {
  if (_M0MPC16string6String20char__length_2einner(text, 0, undefined) <= max_len) {
    return text;
  } else {
    const chars = [];
    const i = new _M0TPC13ref3RefGiE(0);
...
function _M0FP38bobzhang7noteapp6shared11sort__notes(notes) {
  const result = _M0MPC15array5Array4copyGRP38bobzhang7noteapp6shared4NoteE(notes);
  _M0MPC15array5Array8sort__byGRP38bobzhang7noteapp6shared4NoteE(result, (a, b) => {
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode20scan__direct__childs(s) {
  ...
  while (true) {
    ...
    _L$2: {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(result, inst.link);
    }
    continue;
  }
  return result;
  ...
  while (true) {
    ...
    while (true) {
      ...
      _L$4: {
        ...
        _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(stack, c);
      }
      continue;
    }
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5VNode6insert(self, sandbox, parent_inst, parent, before) {
  ...
  while (true) {
    ...
    const slot = _M0FPC13ref3newGRP48bobzhang7noteapp8frontend3app5ModelE(h);
  ...
  while (true) {
    ...
    _L$2: {
      _L$3: {
        ...
        if (_bind === undefined) {
          const slot$2 = _M0FPC13ref3newGRP48bobzhang7noteapp8frontend3app5ModelE(handler);
  ...
  _L: {
      ...
      if (len1 > len2) {
        ...
        while (true) {
          ...
          if (i >= len1) {
            ...
            _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(acc, inode);
    ...
    while (true) {
      ...
      if (i >= _bind$2) {
        ...
        _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(reversed, { _0: k, _1: inode });
        before.val = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime8nullableGRP319moonbit_2dcommunity7rabbita3dom4NodeE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode5start(inode));
        _tmp = i - 1 | 0;
        continue;
      } else {
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime7Sandbox3new(root) {
  ...
  const _bind$8 = false;
  const _bind$9 = "";
  const _bind$10 = _M0MPC15queue5Queue3newGRP48bobzhang7noteapp8frontend3app3MsgE();
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE(self, scheduler) {
  let msg;
  _L: {
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE(self) {
  const _func = self.view;
  return _func(self.dispatch, self.model.val);
}
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE(self) {
  return self.flags;
}
function _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang7noteapp8frontend3app3MsgE(self, msg) {
...
function _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE(model, update, view) {
  const flags = _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags3new();
  const dispatcher = new _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang7noteapp8frontend3app3MsgE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags2id(flags), _M0MPC15queue5Queue3newGRP48bobzhang7noteapp8frontend3app3MsgE());
  const dispatch = (m) => _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang7noteapp8frontend3app3MsgE(dispatcher, m);
  const model$2 = _M0FPC13ref3newGRP48bobzhang7noteapp8frontend3app5ModelE(model);
  return { _0: dispatch, _1: { self: new _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE(model$2, dispatcher, dispatch, update, view, flags), method_table: _M0FP0207moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fnoteapp_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fnoteapp_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell } };
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang7noteapp6shared4NoteE(url, http_method, expect, body) {
  const launch = (scheduler) => {
    let has_body;
    if (body.$tag === 2) {
      has_body = false;
    ...
    _L: {
      ...
      _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
        ...
        scheduler.method_table.method_0(scheduler.self, f$2(_M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang7noteapp6shared4NoteE(result, decoder)));
      }, (msg) => {
        scheduler.method_table.method_0(scheduler.self, f$2(new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE3Err(`Http request failed:${_M0IPC16string6StringPB4Show10to__string(msg)}`)));
      });
      return;
    }
    _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
...
function _M0FP319moonbit_2dcommunity7rabbita4http7requestGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(url, http_method, expect, body) {
  const launch = (scheduler) => {
    let has_body;
    if (body.$tag === 2) {
      has_body = false;
    ...
    _L: {
      ...
      _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
        ...
        scheduler.method_table.method_0(scheduler.self, f$2(_M0MPC16result6Result4bindGRPB4JsonsRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(result, decoder)));
      }, (msg) => {
        scheduler.method_table.method_0(scheduler.self, f$2(new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE3Err(`Http request failed:${_M0IPC16string6StringPB4Show10to__string(msg)}`)));
      });
      return;
    }
    _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
...
function _M0FP319moonbit_2dcommunity7rabbita4http3getGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(url, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(url, "GET", expect, _M0DTP319moonbit_2dcommunity7rabbita4http4Body5Empty__);
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang7noteapp6shared4NoteE(url, body, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang7noteapp6shared4NoteE(url, "POST", expect, body);
}
function _M0FP48bobzhang7noteapp8frontend3app21format__reading__time(secs) {
  if (secs < 60) {
    return "< 1 min read";
  } else {
    if (60 === 0) {
    ...
    return `${_M0IP016_24default__implPB4Show10to__stringGiE(mins)} min read`;
  }
}
function _M0FP48bobzhang7noteapp8frontend3app10find__note(notes, id) {
  const _bind = notes.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind) {
...
function _M0FP48bobzhang7noteapp8frontend3app17view__stat__badge(text, color, bg) {
  return _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-size: 12px", "font-weight: 600", `color: ${_M0IPC16string6StringPB4Show10to__string(color)}`, `background: ${_M0IPC16string6StringPB4Show10to__string(bg)}`, "padding: 4px 10px", "border-radius: 10px"], undefined, undefined, undefined, -1, undefined, text);
}
function _M0FP48bobzhang7noteapp8frontend3app10view__card(title, children) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(all, child);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP48bobzhang7noteapp8frontend3app5Model4view(self, dispatch) {
  ...
  if (self.selected_note_id !== 0) {
    ...
    _L: {
      ...
      const stats = _M0FP38bobzhang7noteapp6shared14compute__stats(note.content);
      _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(sections, _M0FP48bobzhang7noteapp8frontend3app10view__card("Note Detail", [_M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["padding: 6px 14px", "background: #f0f0f5", "color: #667eea", "border: none", "border-radius: 8px", "cursor: pointer", "font-size: 13px", "font-weight: 600", "margin-bottom: 14px"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(_M0DTP48bobzhang7noteapp8frontend3app3Msg12DeselectNote__), undefined, "Back"), _M0FP319moonbit_2dcommunity7rabbita4html10h1_2einnerGsE(["font-size: 20px", "font-weight: 700", "color: #333", "margin-bottom: 8px"], undefined, undefined, undefined, -1, undefined, undefined, note.title), note.pinned ? _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["display: inline-block", "padding: 3px 10px", "background: #fff3e0", "color: #f57c00", "border-radius: 12px", "font-size: 11px", "font-weight: 600", "margin-bottom: 12px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, "Pinned") : _M0FP319moonbit_2dcommunity7rabbita4html7nothing, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 14px", "line-height: 1.7", "color: #555", "margin-bottom: 16px", "white-space: pre-wrap"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, note.content), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "gap: 16px", "padding: 12px 0", "border-top: 1px solid #f0f0f0"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP48bobzhang7noteapp8frontend3app17view__stat__badge(`${_M0IP016_24default__implPB4Show10to__stringGiE(stats.word_count)} words`, "#667eea", "#f0f0ff"), _M0FP48bobzhang7noteapp8frontend3app17view__stat__badge(`${_M0IP016_24default__implPB4Show10to__stringGiE(stats.char_count)} chars`, "#9c27b0", "#f5f0ff"), _M0FP48bobzhang7noteapp8frontend3app17view__stat__badge(_M0FP48bobzhang7noteapp8frontend3app21format__reading__time(stats.reading_time_secs), "#43a047", "#e8f5e9")])]));
    }
  } else {
    _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(sections, _M0FP48bobzhang7noteapp8frontend3app10view__card("New Note", [_M0FP319moonbit_2dcommunity7rabbita4html12form_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "flex-direction: column", "gap: 10px"], undefined, undefined, undefined, -1, undefined, undefined, dispatch(_M0DTP48bobzhang7noteapp8frontend3app3Msg8SaveNote__), undefined, [_M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.title_input, -1, -1, -1, undefined, "Note title...", undefined, ["padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg17TitleInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html16textarea_2einnerGsE(["padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none", "resize: vertical", "font-family: inherit"], undefined, undefined, undefined, -1, undefined, self.content_input, 5, undefined, "Write your note...", -1, -1, undefined, undefined, -1, -1, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg19ContentInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["padding: 12px", "background: linear-gradient(135deg, #667eea, #764ba2)", "color: white", "border: none", "border-radius: 10px", "cursor: pointer", "font-size: 15px", "font-weight: 600", "margin-top: 2px"], undefined, undefined, undefined, -1, "submit", -1, undefined, undefined, -1, undefined, undefined, "Save Note")])]));
    if (self.notes.length > 0) {
      _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(sections, _M0FP48bobzhang7noteapp8frontend3app10view__card("All Notes", _M0MPC15array5Array3mapGRP38bobzhang7noteapp6shared4NoteRP319moonbit_2dcommunity7rabbita4html4HtmlE(self.notes, (note) => {
        const preview = _M0FP38bobzhang7noteapp6shared8truncate(note.content, 80);
        const stats = _M0FP38bobzhang7noteapp6shared14compute__stats(note.content);
        const bg = note.pinned ? "background: #fffdf5" : "background: white";
        return _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["padding: 12px 0", "border-bottom: 1px solid #f5f5f5"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "align-items: flex-start", "gap: 10px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["flex: 1", "min-width: 0", "cursor: pointer", "padding: 8px 12px", "border-radius: 10px", bg], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "align-items: center", "gap: 8px", "margin-bottom: 4px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [note.pinned ? _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["color: #f57c00", "font-size: 14px"], undefined, undefined, undefined, -1, undefined, "* ") : _M0FP319moonbit_2dcommunity7rabbita4html7nothing, _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["font-weight: 700", "font-size: 15px", "color: #333", "background: none", "border: none", "cursor: pointer", "text-align: left", "padding: 0"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg10SelectNote(note.id)), undefined, note.title)]), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 13px", "color: #888", "margin-bottom: 6px", "line-height: 1.4"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, preview), _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-size: 11px", "color: #667eea", "background: #f0f0ff", "padding: 2px 8px", "border-radius: 10px", "font-weight: 600"], undefined, undefined, undefined, -1, undefined, `${_M0IP016_24default__implPB4Show10to__stringGiE(stats.word_count)} words`)]), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "flex-direction: column", "gap: 6px", "padding-top: 8px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["width: 32px", "height: 32px", note.pinned ? "background: #fff3e0" : "background: #f5f5f5", note.pinned ? "color: #f57c00" : "color: #bbb", "border: none", "border-radius: 8px", "cursor: pointer", "font-size: 14px", "font-weight: 700", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg9TogglePin(note.id)), undefined, note.pinned ? "*" : "o"), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["width: 32px", "height: 32px", "background: #fee", "color: #e53935", "border: none", "border-radius: 8px", "cursor: pointer", "font-size: 13px", "font-weight: 700", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg10DeleteNote(note.id)), undefined, "X")])])]);
      })));
    }
  }
...
function _M0FP48bobzhang7noteapp8frontend3app12fetch__notes(dispatch) {
  return _M0FP319moonbit_2dcommunity7rabbita4http3getGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(_M0FP38bobzhang7noteapp6shared10api__notes, new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE4Json((result) => dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg8GotNotes(result)), (json) => {
    let _try_err;
    _L: {
      const _bind = _M0FPC14json10from__jsonGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEE(json, undefined);
      let _tmp;
      if (_bind.$tag === 1) {
        const _ok = _bind;
        _tmp = _ok._0;
      ...
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE2Ok(_tmp);
    }
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7noteapp6shared4NoteEsE3Err("Failed to decode notes");
  }));
}
function _M0MP48bobzhang7noteapp8frontend3app5Model6update(self, msg, dispatch) {
  let id;
  _L: {
    let id$2;
    _L$2: {
              ...
              _L$7: {
                ...
                _L$8: {
                  ...
                  _L$9: {
                    switch (msg.$tag) {
                      case 0: {
                        return { _0: self, _1: _M0FP48bobzhang7noteapp8frontend3app12fetch__notes(dispatch) };
                      }
                      case 1: {
                        const _GotNotes = msg;
                        const _x = _GotNotes._0;
                        if (_x.$tag === 1) {
                          const _Ok = _x;
                          const _notes = _Ok._0;
                          notes = _notes;
                      ...
                      case 2: {
                        const _TitleInputChanged = msg;
                        const _v = _TitleInputChanged._0;
                        v$2 = _v;
                        break _L$8;
                      }
                      case 3: {
                        const _ContentInputChanged = msg;
                        const _v$2 = _ContentInputChanged._0;
                        v = _v$2;
                        break _L$7;
                      }
                      case 4: {
                        if (!_M0FP38bobzhang7noteapp6shared15validate__title(self.title_input)) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        if (!_M0FP38bobzhang7noteapp6shared17validate__content(self.content_input)) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        ...
                        const body = _M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 2)));
                        const cmd = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang7noteapp6shared4NoteE(_M0FP38bobzhang7noteapp6shared10api__notes, new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(body), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7noteapp6shared4NoteE4Json((r) => dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg9NoteSaved(r)), (json) => {
                          let _try_err;
                          _L$10: {
                            const _bind$2 = _M0FPC14json10from__jsonGRP38bobzhang7noteapp6shared4NoteE(json, undefined);
                            let _tmp;
                            if (_bind$2.$tag === 1) {
                              const _ok = _bind$2;
                              _tmp = _ok._0;
                            ...
                            return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE2Ok(_tmp);
                          }
                          return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE3Err("Failed to decode note");
                        }));
                        return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(self.notes, "", "", self.selected_note_id), _1: cmd };
                      }
                      case 5: {
                        const _NoteSaved = msg;
                        const _x$2 = _NoteSaved._0;
                        if (_x$2.$tag === 1) {
                          const _Ok = _x$2;
                          const _note = _Ok._0;
                          note = _note;
                      ...
                      case 6: {
                        const _SelectNote = msg;
                        const _id = _SelectNote._0;
                        id$4 = _id;
                        break _L$5;
                      }
                      case 7: {
                        return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(self.notes, self.title_input, self.content_input, 0), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                      }
                      case 8: {
                        const _TogglePin = msg;
                        const _id$2 = _TogglePin._0;
                        id$3 = _id$2;
                        break _L$4;
                      }
                      case 9: {
                        const _NotePinToggled = msg;
                        const _x$3 = _NotePinToggled._0;
                        if (_x$3.$tag === 1) {
                          const _Ok = _x$3;
                      ...
                      case 10: {
                        const _DeleteNote = msg;
                        const _id$3 = _DeleteNote._0;
                        id$2 = _id$3;
                        break _L$2;
                      }
                      default: {
                        const _NoteDeleted = msg;
                        const _x$4 = _NoteDeleted._0;
                        if (_x$4.$tag === 1) {
                          const _Ok = _x$4;
                          const _id$4 = _Ok._0;
                          id = _id$4;
                  ...
                  const sorted = _M0FP38bobzhang7noteapp6shared11sort__notes(notes);
                  return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(sorted, self.title_input, self.content_input, self.selected_note_id), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                }
                return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(self.notes, v$2, self.content_input, self.selected_note_id), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
              }
              return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(self.notes, self.title_input, v, self.selected_note_id), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
            }
            const notes = _M0MPC15array5Array4copyGRP38bobzhang7noteapp6shared4NoteE(self.notes);
            _M0MPC15array5Array4pushGRP38bobzhang7noteapp6shared4NoteE(notes, note);
            const sorted = _M0FP38bobzhang7noteapp6shared11sort__notes(notes);
            return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(sorted, self.title_input, self.content_input, self.selected_note_id), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
          }
          return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(self.notes, self.title_input, self.content_input, id$4), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
        }
        const _tmp = _M0FP38bobzhang7noteapp6shared14api__note__pin(id$3);
        const _bind = [];
        const cmd = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang7noteapp6shared4NoteE(_tmp, new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(_M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0)))), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7noteapp6shared4NoteE4Json((r) => dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg14NotePinToggled(r)), (json) => {
          let _try_err;
          _L$5: {
            const _bind$2 = _M0FPC14json10from__jsonGRP38bobzhang7noteapp6shared4NoteE(json, undefined);
            let _tmp$2;
            ...
            return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE2Ok(_tmp$2);
          }
          return new _M0DTPC16result6ResultGRP38bobzhang7noteapp6shared4NotesE3Err("Failed to decode note");
        }));
        return { _0: self, _1: cmd };
      }
      const notes = _M0MPC15array5Array3mapGRP38bobzhang7noteapp6shared4NoteRP38bobzhang7noteapp6shared4NoteE(self.notes, (n) => n.id === updated.id ? updated : n);
      const sorted = _M0FP38bobzhang7noteapp6shared11sort__notes(notes);
      return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(sorted, self.title_input, self.content_input, self.selected_note_id), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
    }
    const cmd = _M0FP319moonbit_2dcommunity7rabbita4http6deleteGuE(_M0FP38bobzhang7noteapp6shared9api__note(id$2), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmduE4Text((result) => {
      let _tmp;
      let e;
      _L$3: {
        _L$4: {
      ...
      return dispatch(new _M0DTP48bobzhang7noteapp8frontend3app3Msg11NoteDeleted(_tmp));
    }));
    return { _0: self, _1: cmd };
  }
  const notes = _M0MPC15array5Array6filterGRP38bobzhang7noteapp6shared4NoteE(self.notes, (n) => n.id !== id);
  const selected = self.selected_note_id === id ? 0 : self.selected_note_id;
  return { _0: new _M0TP48bobzhang7noteapp8frontend3app5Model(notes, self.title_input, self.content_input, selected), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
}
(() => {
  let dispatch;
  let app_cell;
  _L: {
    const _bind = _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang7noteapp8frontend3app5ModelRP48bobzhang7noteapp8frontend3app3MsgE(new _M0TP48bobzhang7noteapp8frontend3app5Model([], "", "", 0), (dispatch$2, msg, model) => {
      let model$2;
      let cmd;
      _L$2: {
        const _bind$2 = _M0MP48bobzhang7noteapp8frontend3app5Model6update(model, msg, dispatch$2);
    ...
    }, (dispatch$2, model) => _M0MP48bobzhang7noteapp8frontend3app5Model4view(model, dispatch$2));
  ...
  _M0MP219moonbit_2dcommunity7rabbita3App10with__init(app, dispatch(_M0DTP48bobzhang7noteapp8frontend3app3Msg4Init__));
