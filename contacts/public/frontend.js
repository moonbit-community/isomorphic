...
function _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE2Ok.prototype.$tag = 1;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE2Ok.prototype.$tag = 1;
...
function _M0TPB12MutArrayViewGRP38bobzhang8contacts6shared7ContactE(param0, param1, param2) {
  this.buf = param0;
  this.start = param1;
  this.end = param2;
}
...
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
...
function _M0TPC15queue5QueueGRP48bobzhang8contacts8frontend3app3MsgE(param0, param1, param2) {
  this.length = param0;
  this.first = param1;
  this.last = param2;
}
...
function _M0TPC13ref3RefGRP48bobzhang8contacts8frontend3app5ModelE(param0) {
  this.val = param0;
}
...
function _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang8contacts6shared7Contact(param0, param1, param2, param3, param4) {
  this.id = param0;
  this.name = param1;
  this.email = param2;
  this.phone = param3;
...
function _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang8contacts8frontend3app3MsgE(param0, param1) {
  this.id = param0;
  this.inbox = param1;
}
function _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE(param0, param1, param2, param3, param4, param5) {
  this.model = param0;
...
function _M0DTP48bobzhang8contacts8frontend3app3Msg4Init() {}
_M0DTP48bobzhang8contacts8frontend3app3Msg4Init.prototype.$tag = 0;
const _M0DTP48bobzhang8contacts8frontend3app3Msg4Init__ = new _M0DTP48bobzhang8contacts8frontend3app3Msg4Init();
function _M0DTP48bobzhang8contacts8frontend3app3Msg11GotContacts(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg11GotContacts.prototype.$tag = 1;
function _M0DTP48bobzhang8contacts8frontend3app3Msg13SearchChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg13SearchChanged.prototype.$tag = 2;
function _M0DTP48bobzhang8contacts8frontend3app3Msg10ToggleForm() {}
_M0DTP48bobzhang8contacts8frontend3app3Msg10ToggleForm.prototype.$tag = 3;
const _M0DTP48bobzhang8contacts8frontend3app3Msg10ToggleForm__ = new _M0DTP48bobzhang8contacts8frontend3app3Msg10ToggleForm();
function _M0DTP48bobzhang8contacts8frontend3app3Msg16NameInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg16NameInputChanged.prototype.$tag = 4;
function _M0DTP48bobzhang8contacts8frontend3app3Msg17EmailInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg17EmailInputChanged.prototype.$tag = 5;
function _M0DTP48bobzhang8contacts8frontend3app3Msg17PhoneInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg17PhoneInputChanged.prototype.$tag = 6;
function _M0DTP48bobzhang8contacts8frontend3app3Msg10AddContact() {}
_M0DTP48bobzhang8contacts8frontend3app3Msg10AddContact.prototype.$tag = 7;
const _M0DTP48bobzhang8contacts8frontend3app3Msg10AddContact__ = new _M0DTP48bobzhang8contacts8frontend3app3Msg10AddContact();
function _M0DTP48bobzhang8contacts8frontend3app3Msg12ContactAdded(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg12ContactAdded.prototype.$tag = 8;
function _M0DTP48bobzhang8contacts8frontend3app3Msg14ToggleFavorite(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg14ToggleFavorite.prototype.$tag = 9;
function _M0DTP48bobzhang8contacts8frontend3app3Msg15FavoriteToggled(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg15FavoriteToggled.prototype.$tag = 10;
function _M0DTP48bobzhang8contacts8frontend3app3Msg13DeleteContact(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg13DeleteContact.prototype.$tag = 11;
function _M0DTP48bobzhang8contacts8frontend3app3Msg14ContactDeleted(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang8contacts8frontend3app3Msg14ContactDeleted.prototype.$tag = 12;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE4Text.prototype.$tag = 1;
function _M0TP48bobzhang8contacts8frontend3app5Model(param0, param1, param2, param3, param4, param5) {
  this.contacts = param0;
  this.search_query = param1;
  this.name_input = param2;
  this.email_input = param3;
  this.phone_input = param4;
  this.show_form = param5;
}
...
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang8contacts6shared7ContactE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang8contacts6shared7ContactE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang8contacts6shared7ContactE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang8contacts6shared7ContactE4Text.prototype.$tag = 1;
...
const _M0FP0209moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fcontacts_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fcontacts_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell = { method_0: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE, method_1: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE, method_2: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE };
...
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1988 = { _0: 0, _1: "" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1989 = { _0: 1, _1: "5" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1990 = { _0: 1, _1: "25" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1991 = { _0: 1, _1: "125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1992 = { _0: 2, _1: "625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1993 = { _0: 2, _1: "3125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1994 = { _0: 2, _1: "15625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1995 = { _0: 3, _1: "78125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1996 = { _0: 3, _1: "390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1997 = { _0: 3, _1: "1953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1998 = { _0: 4, _1: "9765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1999 = { _0: 4, _1: "48828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2000 = { _0: 4, _1: "244140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2001 = { _0: 4, _1: "1220703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2002 = { _0: 5, _1: "6103515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2003 = { _0: 5, _1: "30517578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2004 = { _0: 5, _1: "152587890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2005 = { _0: 6, _1: "762939453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2006 = { _0: 6, _1: "3814697265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2007 = { _0: 6, _1: "19073486328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2008 = { _0: 7, _1: "95367431640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2009 = { _0: 7, _1: "476837158203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2010 = { _0: 7, _1: "2384185791015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2011 = { _0: 7, _1: "11920928955078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2012 = { _0: 8, _1: "59604644775390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2013 = { _0: 8, _1: "298023223876953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2014 = { _0: 8, _1: "1490116119384765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2015 = { _0: 9, _1: "7450580596923828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2016 = { _0: 9, _1: "37252902984619140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2017 = { _0: 9, _1: "186264514923095703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2018 = { _0: 10, _1: "931322574615478515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2019 = { _0: 10, _1: "4656612873077392578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2020 = { _0: 10, _1: "23283064365386962890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2021 = { _0: 10, _1: "116415321826934814453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2022 = { _0: 11, _1: "582076609134674072265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2023 = { _0: 11, _1: "2910383045673370361328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2024 = { _0: 11, _1: "14551915228366851806640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2025 = { _0: 12, _1: "72759576141834259033203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2026 = { _0: 12, _1: "363797880709171295166015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2027 = { _0: 12, _1: "1818989403545856475830078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2028 = { _0: 13, _1: "9094947017729282379150390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2029 = { _0: 13, _1: "45474735088646411895751953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2030 = { _0: 13, _1: "227373675443232059478759765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2031 = { _0: 13, _1: "1136868377216160297393798828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2032 = { _0: 14, _1: "5684341886080801486968994140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2033 = { _0: 14, _1: "28421709430404007434844970703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2034 = { _0: 14, _1: "142108547152020037174224853515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2035 = { _0: 15, _1: "710542735760100185871124267578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2036 = { _0: 15, _1: "3552713678800500929355621337890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2037 = { _0: 15, _1: "17763568394002504646778106689453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2038 = { _0: 16, _1: "88817841970012523233890533447265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2039 = { _0: 16, _1: "444089209850062616169452667236328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2040 = { _0: 16, _1: "2220446049250313080847263336181640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2041 = { _0: 16, _1: "11102230246251565404236316680908203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2042 = { _0: 17, _1: "55511151231257827021181583404541015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2043 = { _0: 17, _1: "277555756156289135105907917022705078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2044 = { _0: 17, _1: "1387778780781445675529539585113525390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2045 = { _0: 18, _1: "6938893903907228377647697925567626953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2046 = { _0: 18, _1: "34694469519536141888238489627838134765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2047 = { _0: 18, _1: "173472347597680709441192448139190673828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2048 = { _0: 19, _1: "867361737988403547205962240695953369140625" };
const _M0FPC17strconv19left__shift__cheats = [_M0FPC17strconv34left__shift__cheats_2etuple_2f1988, _M0FPC17strconv34left__shift__cheats_2etuple_2f1989, _M0FPC17strconv34left__shift__cheats_2etuple_2f1990, _M0FPC17strconv34left__shift__cheats_2etuple_2f1991, _M0FPC17strconv34left__shift__cheats_2etuple_2f1992, _M0FPC17strconv34left__shift__cheats_2etuple_2f1993, _M0FPC17strconv34left__shift__cheats_2etuple_2f1994, _M0FPC17strconv34left__shift__cheats_2etuple_2f1995, _M0FPC17strconv34left__shift__cheats_2etuple_2f1996, _M0FPC17strconv34left__shift__cheats_2etuple_2f1997, _M0FPC17strconv34left__shift__cheats_2etuple_2f1998, _M0FPC17strconv34left__shift__cheats_2etuple_2f1999, _M0FPC17strconv34left__shift__cheats_2etuple_2f2000, _M0FPC17strconv34left__shift__cheats_2etuple_2f2001, _M0FPC17strconv34left__shift__cheats_2etuple_2f2002, _M0FPC17strconv34left__shift__cheats_2etuple_2f2003, _M0FPC17strconv34left__shift__cheats_2etuple_2f2004, _M0FPC17strconv34left__shift__cheats_2etuple_2f2005, _M0FPC17strconv34left__shift__cheats_2etuple_2f2006, _M0FPC17strconv34left__shift__cheats_2etuple_2f2007, _M0FPC17strconv34left__shift__cheats_2etuple_2f2008, _M0FPC17strconv34left__shift__cheats_2etuple_2f2009, _M0FPC17strconv34left__shift__cheats_2etuple_2f2010, _M0FPC17strconv34left__shift__cheats_2etuple_2f2011, _M0FPC17strconv34left__shift__cheats_2etuple_2f2012, _M0FPC17strconv34left__shift__cheats_2etuple_2f2013, _M0FPC17strconv34left__shift__cheats_2etuple_2f2014, _M0FPC17strconv34left__shift__cheats_2etuple_2f2015, _M0FPC17strconv34left__shift__cheats_2etuple_2f2016, _M0FPC17strconv34left__shift__cheats_2etuple_2f2017, _M0FPC17strconv34left__shift__cheats_2etuple_2f2018, _M0FPC17strconv34left__shift__cheats_2etuple_2f2019, _M0FPC17strconv34left__shift__cheats_2etuple_2f2020, _M0FPC17strconv34left__shift__cheats_2etuple_2f2021, _M0FPC17strconv34left__shift__cheats_2etuple_2f2022, _M0FPC17strconv34left__shift__cheats_2etuple_2f2023, _M0FPC17strconv34left__shift__cheats_2etuple_2f2024, _M0FPC17strconv34left__shift__cheats_2etuple_2f2025, _M0FPC17strconv34left__shift__cheats_2etuple_2f2026, _M0FPC17strconv34left__shift__cheats_2etuple_2f2027, _M0FPC17strconv34left__shift__cheats_2etuple_2f2028, _M0FPC17strconv34left__shift__cheats_2etuple_2f2029, _M0FPC17strconv34left__shift__cheats_2etuple_2f2030, _M0FPC17strconv34left__shift__cheats_2etuple_2f2031, _M0FPC17strconv34left__shift__cheats_2etuple_2f2032, _M0FPC17strconv34left__shift__cheats_2etuple_2f2033, _M0FPC17strconv34left__shift__cheats_2etuple_2f2034, _M0FPC17strconv34left__shift__cheats_2etuple_2f2035, _M0FPC17strconv34left__shift__cheats_2etuple_2f2036, _M0FPC17strconv34left__shift__cheats_2etuple_2f2037, _M0FPC17strconv34left__shift__cheats_2etuple_2f2038, _M0FPC17strconv34left__shift__cheats_2etuple_2f2039, _M0FPC17strconv34left__shift__cheats_2etuple_2f2040, _M0FPC17strconv34left__shift__cheats_2etuple_2f2041, _M0FPC17strconv34left__shift__cheats_2etuple_2f2042, _M0FPC17strconv34left__shift__cheats_2etuple_2f2043, _M0FPC17strconv34left__shift__cheats_2etuple_2f2044, _M0FPC17strconv34left__shift__cheats_2etuple_2f2045, _M0FPC17strconv34left__shift__cheats_2etuple_2f2046, _M0FPC17strconv34left__shift__cheats_2etuple_2f2047, _M0FPC17strconv34left__shift__cheats_2etuple_2f2048];
...
const _M0FP38bobzhang8contacts6shared17max__name__length = 50;
const _M0FP38bobzhang8contacts6shared18max__email__length = 100;
const _M0FP38bobzhang8contacts6shared18max__phone__length = 20;
const _M0FP38bobzhang8contacts6shared13api__contacts = "/api/contacts";
...
const _M0FPB33brute__force__find_2econstr_2f416 = 0;
const _M0FPB43boyer__moore__horspool__find_2econstr_2f402 = 0;
...
const _M0FPC17strconv28checked__mul_2econstr_2f2468 = $0L;
...
function _M0FPB28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB43boyer__moore__horspool__find_2econstr_2f402;
  }
}
function _M0FPB18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB33brute__force__find_2econstr_2f416;
  }
}
...
function _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(self, value) {
...
function _M0MPB4Iter9to__arrayGRPC16string10StringViewE(self) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(result, _x);
      continue;
    }
  }
  return result;
...
function _M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang8contacts6shared7ContactE(self, g) {
  if (self.$tag === 1) {
    const _Ok = self;
    const _value = _Ok._0;
    return g(_value);
    ...
    const _Err = self;
    const _err = _Err._0;
    return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE3Err(_err);
  }
}
function _M0MPC16result6Result4bindGRPB4JsonsRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(self, g) {
  if (self.$tag === 1) {
    const _Ok = self;
    const _value = _Ok._0;
    return g(_value);
    ...
    const _Err = self;
    const _err = _Err._0;
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE3Err(_err);
  }
}
...
function _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(self) {
  return self.end - self.start | 0;
}
function _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(self, index) {
...
function _M0MPC15array12MutArrayView3setGRP38bobzhang8contacts6shared7ContactE(self, index, value) {
  if (index >= 0 && index < (self.end - self.start | 0)) {
    const _tmp = self.buf;
    const _tmp$2 = self.start + index | 0;
    $bound_check(_tmp, _tmp$2);
...
function _M0MPC15array5Array17mut__view_2einnerGRP38bobzhang8contacts6shared7ContactE(self, start, end) {
  const len = self.length;
  let end$2;
  if (end === undefined) {
    end$2 = len;
  ...
  if (start$2 >= 0 && (start$2 <= end$2 && end$2 <= len)) {
    ...
    return new _M0TPB12MutArrayViewGRP38bobzhang8contacts6shared7ContactE(_bind, start$2, start$2 + _bind$2 | 0);
  } else {
...
function _M0MPC15array12MutArrayView17mut__view_2einnerGRP38bobzhang8contacts6shared7ContactE(self, start, end) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(self);
  let end$2;
  if (end === undefined) {
    end$2 = len;
  } else {
  ...
  if (start$2 >= 0 && (start$2 <= end$2 && end$2 <= len)) {
    ...
    return new _M0TPB12MutArrayViewGRP38bobzhang8contacts6shared7ContactE(_bind, _bind$2, _bind$2 + _bind$3 | 0);
  } else {
...
function _M0MPC15array5Array3mapGRP38bobzhang8contacts6shared7ContactRP38bobzhang8contacts6shared7ContactE(self, f) {
...
function _M0MPC15array5Array3mapGRP38bobzhang8contacts6shared7ContactRP319moonbit_2dcommunity7rabbita4html4HtmlE(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0MPC15array5Array4copyGRP38bobzhang8contacts6shared7ContactE(self) {
  return _M0MPB7JSArray4copy(self);
}
function _M0FPB7minimum(x, y) {
  return x > y ? y : x;
}
function _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, i, j) {
  const temp = _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, i);
  _M0MPC15array12MutArrayView3setGRP38bobzhang8contacts6shared7ContactE(arr, i, _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, j));
  _M0MPC15array12MutArrayView3setGRP38bobzhang8contacts6shared7ContactE(arr, j, temp);
}
function _M0MPC15array12MutArrayView5sliceGRP38bobzhang8contacts6shared7ContactE(arr, start, end) {
  return _M0MPC15array12MutArrayView17mut__view_2einnerGRP38bobzhang8contacts6shared7ContactE(arr, start, end);
}
function _M0MPC15array12MutArrayView14rev__in__placeGRP38bobzhang8contacts6shared7ContactE(arr) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr);
  if (2 === 0) {
    $panic();
  }
...
function _M0FPB23fixed__bubble__sort__byGRP38bobzhang8contacts6shared7ContactE(arr, cmp) {
  const _bind = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr);
  let _tmp = 1;
  while (true) {
    const i = _tmp;
    if (i < _bind) {
      ...
      while (true) {
        const j = _tmp$2;
        if (j > 0 && cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, j - 1 | 0), _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, j)) > 0) {
          _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, j, j - 1 | 0);
          _tmp$2 = j - 1 | 0;
          continue;
        } else {
          break;
...
function _M0FPB41fixed__choose__pivot__by_2esort__2_2f1847(_env, a, b) {
  const swaps = _env._2;
  const arr = _env._1;
  const cmp = _env._0;
  if (cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, a), _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, b)) > 0) {
    _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, a, b);
...
function _M0FPB41fixed__choose__pivot__by_2esort__3_2f1848(_env, a, b, c) {
  _M0FPB41fixed__choose__pivot__by_2esort__2_2f1847(_env, a, b);
  _M0FPB41fixed__choose__pivot__by_2esort__2_2f1847(_env, b, c);
  _M0FPB41fixed__choose__pivot__by_2esort__2_2f1847(_env, a, b);
}
function _M0FPB24fixed__choose__pivot__byGRP38bobzhang8contacts6shared7ContactE(arr, cmp) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr);
  ...
  if (len >= 8) {
    ...
    if (len > 50) {
      _M0FPB41fixed__choose__pivot__by_2esort__3_2f1848(_env, a - 1 | 0, a, a + 1 | 0);
      _M0FPB41fixed__choose__pivot__by_2esort__3_2f1848(_env, b - 1 | 0, b, b + 1 | 0);
      _M0FPB41fixed__choose__pivot__by_2esort__3_2f1848(_env, c - 1 | 0, c, c + 1 | 0);
    }
    _M0FPB41fixed__choose__pivot__by_2esort__3_2f1848(_env, a, b, c);
  }
  if (swaps.val === 12) {
    _M0MPC15array12MutArrayView14rev__in__placeGRP38bobzhang8contacts6shared7ContactE(arr);
    return { _0: (len - b | 0) - 1 | 0, _1: true };
  } else {
    return { _0: b, _1: swaps.val === 0 };
  }
}
function _M0FPB21fixed__sift__down__byGRP38bobzhang8contacts6shared7ContactE(arr, index, cmp) {
  let index$2 = index;
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr);
  let child = (Math.imul(index$2, 2) | 0) + 1 | 0;
  while (true) {
    if (child < len) {
      if ((child + 1 | 0) < len && cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, child), _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, child + 1 | 0)) < 0) {
        child = child + 1 | 0;
      }
      if (cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, index$2), _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, child)) >= 0) {
        return undefined;
      }
      _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, index$2, child);
      index$2 = child;
...
function _M0FPB21fixed__heap__sort__byGRP38bobzhang8contacts6shared7ContactE(arr, cmp) {
  const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr);
  if (2 === 0) {
    $panic();
  }
  ...
  while (true) {
    const i = _tmp;
    if (i >= 0) {
      _M0FPB21fixed__sift__down__byGRP38bobzhang8contacts6shared7ContactE(arr, i, cmp);
      _tmp = i - 1 | 0;
      continue;
    } else {
      break;
  ...
  while (true) {
    const i = _tmp$2;
    if (i >= 1) {
      _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, 0, i);
      _M0FPB21fixed__sift__down__byGRP38bobzhang8contacts6shared7ContactE(_M0MPC15array12MutArrayView5sliceGRP38bobzhang8contacts6shared7ContactE(arr, 0, i), 0, cmp);
      _tmp$2 = i - 1 | 0;
      continue;
    } else {
      return;
...
function _M0FPB20fixed__partition__byGRP38bobzhang8contacts6shared7ContactE(arr, cmp, pivot_index) {
  _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, pivot_index, _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr) - 1 | 0);
  const pivot = _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr) - 1 | 0);
  let i = 0;
  let partitioned = true;
  const _bind = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr) - 1 | 0;
  let _tmp = 0;
  while (true) {
    const j = _tmp;
    if (j < _bind) {
      if (cmp(_M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr, j), pivot) < 0) {
        if (i !== j) {
          _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, i, j);
          partitioned = false;
        }
        i = i + 1 | 0;
      }
  ...
  _M0MPC15array12MutArrayView4swapGRP38bobzhang8contacts6shared7ContactE(arr, i, _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr) - 1 | 0);
  return { _0: i, _1: partitioned };
}
function _M0FPB28fixed__try__bubble__sort__byGRP38bobzhang8contacts6shared7ContactE(arr, cmp) {
  let tries = 0;
  const _bind = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr);
  let _tmp = 1;
  while (true) {
...
function _M0FPB22fixed__quick__sort__byGRP38bobzhang8contacts6shared7ContactE(arr, cmp, pred, limit) {
  let limit$2 = limit;
  let arr$2 = arr;
  let pred$2 = pred;
  ...
  let balanced = true;
  while (true) {
    const len = _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(arr$2);
    if (len <= 16) {
      if (len >= 2) {
        _M0FPB23fixed__bubble__sort__byGRP38bobzhang8contacts6shared7ContactE(arr$2, cmp);
      }
      return undefined;
    }
    if (limit$2 === 0) {
      _M0FPB21fixed__heap__sort__byGRP38bobzhang8contacts6shared7ContactE(arr$2, cmp);
      return undefined;
    }
    const _bind = _M0FPB24fixed__choose__pivot__byGRP38bobzhang8contacts6shared7ContactE(arr$2, cmp);
    const _pivot_index = _bind._0;
    const _likely_sorted = _bind._1;
    if (was_partitioned && (balanced && _likely_sorted)) {
      if (_M0FPB28fixed__try__bubble__sort__byGRP38bobzhang8contacts6shared7ContactE(arr$2, cmp)) {
        return undefined;
      }
    }
    const _bind$2 = _M0FPB20fixed__partition__byGRP38bobzhang8contacts6shared7ContactE(arr$2, cmp, _pivot_index);
    ...
    if (_bind$3 === undefined) {
      ...
      const _Some = _bind$3;
      const _pred = _Some;
      if (cmp(_pred, _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr$2, _pivot)) === 0) {
        let i = _pivot;
        while (true) {
          if (i < len && cmp(_pred, _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr$2, i)) === 0) {
            i = i + 1 | 0;
            continue;
          } else {
            break;
        ...
        arr$2 = _M0MPC15array12MutArrayView5sliceGRP38bobzhang8contacts6shared7ContactE(arr$2, i, len);
        continue;
      }
    }
    const left = _M0MPC15array12MutArrayView5sliceGRP38bobzhang8contacts6shared7ContactE(arr$2, 0, _pivot);
    const right = _M0MPC15array12MutArrayView5sliceGRP38bobzhang8contacts6shared7ContactE(arr$2, _pivot + 1 | 0, len);
    if (_M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(left) < _M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(right)) {
      _M0FPB22fixed__quick__sort__byGRP38bobzhang8contacts6shared7ContactE(left, cmp, pred$2, limit$2);
      pred$2 = _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr$2, _pivot);
      arr$2 = right;
    } else {
      _M0FPB22fixed__quick__sort__byGRP38bobzhang8contacts6shared7ContactE(right, cmp, _M0MPC15array12MutArrayView2atGRP38bobzhang8contacts6shared7ContactE(arr$2, _pivot), limit$2);
      arr$2 = left;
    }
    continue;
  }
}
function _M0MPC15array12MutArrayView8sort__byGRP38bobzhang8contacts6shared7ContactE(self, cmp) {
  _M0FPB22fixed__quick__sort__byGRP38bobzhang8contacts6shared7ContactE(self, cmp, undefined, _M0FPB17fixed__get__limit(_M0MPC15array12MutArrayView6lengthGRP38bobzhang8contacts6shared7ContactE(self)));
}
function _M0MPC15array5Array8sort__byGRP38bobzhang8contacts6shared7ContactE(self, cmp) {
  _M0MPC15array12MutArrayView8sort__byGRP38bobzhang8contacts6shared7ContactE(_M0MPC15array5Array17mut__view_2einnerGRP38bobzhang8contacts6shared7ContactE(self, 0, undefined), cmp);
}
...
function _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang8contacts6shared7ContactEHRPC14json15JsonDecodeError(self, f) {
  if (self.length === 0) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE2Ok([]);
  }
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE2Ok(arr);
}
function _M0MPC15array5Array6filterGRP38bobzhang8contacts6shared7ContactE(self, f) {
  const arr = [];
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0MPC15array5Array10push__iterGRP419moonbit_2dcommunity7rabbita8internal7runtime5INodeE(self, iter) {
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(self, _x);
      continue;
    }
  }
}
...
function _M0FPC17strconv12checked__mul(a, b) {
  if (_M0IPC16uint646UInt64PB2Eq5equal(a, $0L) || _M0IPC16uint646UInt64PB2Eq5equal(b, $0L)) {
    return _M0FPC17strconv28checked__mul_2econstr_2f2468;
  }
...
function _M0FPC14json13decode__errorGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(path, msg) {
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: path, _1: msg }));
}
...
function _M0MPC14json12ParseContext12parse__array(ctx) {
  ...
  _L: while (true) {
    ...
    if (_param.$tag === 8) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(vec, _tmp$4);
      ...
      switch (_value.$tag) {
        case 6: {
          ...
          if (_M0MPB3Map9is__emptyGsRPB4JsonE(_members)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(stack, new _M0DTPC14json10WriteFrame6Object(_M0MPB3Map4iterGsWRP319moonbit_2dcommunity7rabbita3dom5EventRP419moonbit_2dcommunity7rabbita8internal7runtime9SchedulerEuE(_members), true));
          }
          break;
        }
        case 5: {
          ...
          if (_M0MPC15array5Array9is__emptyGRPB4JsonE(_arr)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(stack, new _M0DTPC14json10WriteFrame5Array(_arr, 0));
          }
          break;
        }
        case 4: {
...
function _M0FPC14json18from__json_2einnerGRP38bobzhang8contacts6shared7ContactE(json, path) {
  return _M0IP38bobzhang8contacts6shared7ContactPC14json8FromJson10from__json(json, path);
}
function _M0FPC14json18from__json_2einnerGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(json, path) {
  return _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang8contacts6shared7ContactE(json, path);
}
function _M0FPC14json10from__jsonGRP38bobzhang8contacts6shared7ContactE(json, path$46$opt) {
  let path;
  ...
  return _M0FPC14json18from__json_2einnerGRP38bobzhang8contacts6shared7ContactE(json, path);
}
function _M0FPC14json10from__jsonGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(json, path$46$opt) {
  let path;
  if (path$46$opt === undefined) {
    path = _M0DTPC14json8JsonPath4Root__;
  } else {
  ...
  return _M0FPC14json18from__json_2einnerGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(json, path);
}
...
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang8contacts6shared7ContactE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    ...
    if (_bind.$tag === 2) {
      const _Index = _bind;
      return _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang8contacts6shared7ContactEHRPC14json15JsonDecodeError(_a, (i, x) => {
        _Index._1 = i;
        return _M0IP38bobzhang8contacts6shared7ContactPC14json8FromJson10from__json(x, _Index);
      });
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    return _M0FPC14json13decode__errorGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(path, "Array::from_json: expected array");
  }
}
function _M0MPC15queue5Queue3newGRP48bobzhang8contacts8frontend3app3MsgE() {
  return new _M0TPC15queue5QueueGRP48bobzhang8contacts8frontend3app3MsgE(0, undefined, undefined);
}
...
function _M0FPC13ref3newGRP48bobzhang8contacts8frontend3app5ModelE(x) {
  return new _M0TPC13ref3RefGRP48bobzhang8contacts8frontend3app5ModelE(x);
}
...
function _M0IP38bobzhang8contacts6shared7ContactPC14json8FromJson10from__json(_x_49, _x_50) {
  const _de_phone_55 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_name_54 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_id_53 = new _M0TPC13ref3RefGOiE(undefined);
  const _de_favorite_52 = new _M0TPC13ref3RefGObE(-1);
  const _de_email_51 = new _M0TPC13ref3RefGOsE(undefined);
  let _map;
  _L: {
    if (_x_49.$tag === 6) {
      const _Object = _x_49;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_50, _1: "Expected object to deserialize Contact" }));
    }
  }
  let _v;
  _L$2: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v, _M0MPC14json8JsonPath8add__key(_x_50, "id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$3: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_50, "name"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_name_54.val = _tmp;
  }
  let _v$3;
  _L$4: {
    _L$5: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "email");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_50, "email"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_email_51.val = _tmp;
  }
  let _v$4;
  _L$5: {
    _L$6: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "phone");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$4, _M0MPC14json8JsonPath8add__key(_x_50, "phone"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_phone_55.val = _tmp;
  }
  let _v$5;
  _L$6: {
    _L$7: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "favorite");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC14bool4BoolPC14json8FromJson10from__json(_v$5, _M0MPC14json8JsonPath8add__key(_x_50, "favorite"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_favorite_52.val = _tmp;
  }
  let _de_phone_55$2;
  const _bind = _de_phone_55.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_50, _1: "Missing field phone" }));
  } else {
    const _Some = _bind;
    const _v$6 = _Some;
    _de_phone_55$2 = _v$6;
  ...
  let _de_name_54$2;
  const _bind$2 = _de_name_54.val;
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_50, _1: "Missing field name" }));
  } else {
    const _Some = _bind$2;
    const _v$6 = _Some;
    _de_name_54$2 = _v$6;
  ...
  let _de_id_53$2;
  const _bind$3 = _de_id_53.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_50, _1: "Missing field id" }));
  } else {
    const _Some = _bind$3;
    const _v$6 = _Some;
    _de_id_53$2 = _v$6;
  }
  let _de_favorite_52$2;
  const _bind$4 = _de_favorite_52.val;
  if (_bind$4 === -1) {
    return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_50, _1: "Missing field favorite" }));
  } else {
    const _Some = _bind$4;
    const _v$6 = _Some;
    _de_favorite_52$2 = _v$6;
  }
  let _de_email_51$2;
  const _bind$5 = _de_email_51.val;
  if (_bind$5 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_50, _1: "Missing field email" }));
  } else {
    const _Some = _bind$5;
    const _v$6 = _Some;
    _de_email_51$2 = _v$6;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang8contacts6shared7Contact(_de_id_53$2, _de_name_54$2, _de_email_51$2, _de_phone_55$2, _de_favorite_52$2));
}
function _M0FP38bobzhang8contacts6shared14validate__name(name) {
  return _M0IP016_24default__implPB2Eq10not__equalGsE(name, "") && _M0MPC16string6String20char__length_2einner(name, 0, undefined) <= _M0FP38bobzhang8contacts6shared17max__name__length;
}
function _M0FP38bobzhang8contacts6shared15validate__email(email) {
  if (email === "" || _M0MPC16string6String20char__length_2einner(email, 0, undefined) > _M0FP38bobzhang8contacts6shared18max__email__length) {
    return false;
  }
  const found_at = new _M0TPC13ref3RefGbE(false);
  const dot_after_at = new _M0TPC13ref3RefGbE(false);
  const _it = _M0MPC16string6String4iter(email);
  while (true) {
    let ch;
    _L: {
      const _bind = _M0MPB4Iter4nextGcE(_it);
    ...
    if (ch === 64) {
      ...
      if (ch === 46 && found_at.val) {
        dot_after_at.val = true;
      }
    }
    continue;
  }
  return found_at.val && dot_after_at.val;
}
function _M0FP38bobzhang8contacts6shared15validate__phone(phone) {
  if (phone === "" || _M0MPC16string6String20char__length_2einner(phone, 0, undefined) > _M0FP38bobzhang8contacts6shared18max__phone__length) {
    return false;
  }
  const _it = _M0MPC16string6String4iter(phone);
  while (true) {
    let ch;
    _L: {
      const _bind = _M0MPB4Iter4nextGcE(_it);
    ...
    if (ch === 32 || (ch === 45 || (ch === 40 || (ch === 41 || ch === 43)))) {
      continue;
    }
    return false;
  }
...
function _M0FP38bobzhang8contacts6shared12api__contact(id) {
  return `/api/contacts/${_M0IP016_24default__implPB4Show10to__stringGiE(id)}`;
}
function _M0FP38bobzhang8contacts6shared22api__contact__favorite(id) {
  return `/api/contacts/${_M0IP016_24default__implPB4Show10to__stringGiE(id)}/favorite`;
}
function _M0FP38bobzhang8contacts6shared15to__lower__char(ch) {
  return ch >= 65 && ch <= 90 ? ch + 32 | 0 : ch;
}
function _M0FP38bobzhang8contacts6shared9to__lower(s) {
  const buf = _M0MPB13StringBuilder11new_2einner(0);
  ...
  while (true) {
    ...
    _M0IPB13StringBuilderPB6Logger11write__char(buf, _M0FP38bobzhang8contacts6shared15to__lower__char(ch));
    continue;
  }
  return _M0MPB13StringBuilder10to__string(buf);
}
function _M0FP38bobzhang8contacts6shared13format__phone(phone) {
  const digits = _M0MPB13StringBuilder11new_2einner(0);
  const _it = _M0MPC16string6String4iter(phone);
  while (true) {
    let ch;
    _L: {
    ...
    if (ch >= 48 && ch <= 57) {
      _M0IPB13StringBuilderPB6Logger11write__char(digits, ch);
    }
    continue;
  }
  const d = _M0MPB13StringBuilder10to__string(digits);
  if (_M0MPC16string6String20char__length_2einner(d, 0, undefined) === 10) {
    const chars = _M0MPB4Iter9to__arrayGcE(_M0MPC16string6String4iter(d));
    const area = _M0MPB13StringBuilder11new_2einner(0);
    const _bind = 0;
    const _bind$2 = 3;
    let _tmp = _bind;
    while (true) {
      const i = _tmp;
      if (i < _bind$2) {
        _M0IPB13StringBuilderPB6Logger11write__char(area, _M0MPC15array5Array2atGcE(chars, i));
        _tmp = i + 1 | 0;
        continue;
      } else {
        break;
    ...
    const mid = _M0MPB13StringBuilder11new_2einner(0);
    const _bind$3 = 3;
    const _bind$4 = 6;
    let _tmp$2 = _bind$3;
    while (true) {
      const i = _tmp$2;
      if (i < _bind$4) {
        _M0IPB13StringBuilderPB6Logger11write__char(mid, _M0MPC15array5Array2atGcE(chars, i));
        _tmp$2 = i + 1 | 0;
        continue;
      } else {
        break;
    ...
    const last = _M0MPB13StringBuilder11new_2einner(0);
    const _bind$5 = 6;
    const _bind$6 = 10;
    let _tmp$3 = _bind$5;
    while (true) {
      const i = _tmp$3;
      if (i < _bind$6) {
        _M0IPB13StringBuilderPB6Logger11write__char(last, _M0MPC15array5Array2atGcE(chars, i));
        _tmp$3 = i + 1 | 0;
        continue;
      } else {
        break;
    ...
    return `(${_M0IPC16string6StringPB4Show10to__string(_M0MPB13StringBuilder10to__string(area))}) ${_M0IPC16string6StringPB4Show10to__string(_M0MPB13StringBuilder10to__string(mid))}-${_M0IPC16string6StringPB4Show10to__string(_M0MPB13StringBuilder10to__string(last))}`;
  } else {
    return phone;
  }
}
function _M0FP38bobzhang8contacts6shared13match__search(contact, query) {
  if (query === "") {
    return true;
  }
  const q = _M0FP38bobzhang8contacts6shared9to__lower(query);
  const name = _M0FP38bobzhang8contacts6shared9to__lower(contact.name);
  const email = _M0FP38bobzhang8contacts6shared9to__lower(contact.email);
  const phone = _M0FP38bobzhang8contacts6shared9to__lower(contact.phone);
  return _M0MPC16string6String8contains(name, new _M0TPC16string10StringView(q, 0, q.length)) || (_M0MPC16string6String8contains(email, new _M0TPC16string10StringView(q, 0, q.length)) || _M0MPC16string6String8contains(phone, new _M0TPC16string10StringView(q, 0, q.length)));
}
function _M0FP38bobzhang8contacts6shared16filter__contacts(contacts, query) {
  return _M0MPC15array5Array6filterGRP38bobzhang8contacts6shared7ContactE(contacts, (c) => _M0FP38bobzhang8contacts6shared13match__search(c, query));
}
function _M0FP38bobzhang8contacts6shared14sort__contacts(contacts) {
  const result = _M0MPC15array5Array4copyGRP38bobzhang8contacts6shared7ContactE(contacts);
  _M0MPC15array5Array8sort__byGRP38bobzhang8contacts6shared7ContactE(result, (a, b) => {
    ...
    const na = _M0FP38bobzhang8contacts6shared9to__lower(a.name);
    const nb = _M0FP38bobzhang8contacts6shared9to__lower(b.name);
    return _M0IPC16string6StringPB7Compare7compare(na, nb);
  });
  return result;
}
function _M0FP38bobzhang8contacts6shared15to__upper__char(ch) {
  return ch >= 97 && ch <= 122 ? ch - 32 | 0 : ch;
}
function _M0FP38bobzhang8contacts6shared13get__initials(name) {
  if (name === "") {
    return "?";
  }
  const chars = _M0MPB4Iter9to__arrayGcE(_M0MPC16string6String4iter(name));
  const first = _M0MPC15array5Array2atGcE(chars, 0);
  const last_space_idx = new _M0TPC13ref3RefGiE(-1);
  const _bind = 0;
  ...
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      if (_M0MPC15array5Array2atGcE(chars, i) === 32) {
        last_space_idx.val = i;
      }
      _tmp = i + 1 | 0;
      continue;
    } else {
  ...
  const buf = _M0MPB13StringBuilder11new_2einner(0);
  _M0IPB13StringBuilderPB6Logger11write__char(buf, _M0FP38bobzhang8contacts6shared15to__upper__char(first));
  if (last_space_idx.val >= 0 && (last_space_idx.val + 1 | 0) < chars.length) {
    _M0IPB13StringBuilderPB6Logger11write__char(buf, _M0FP38bobzhang8contacts6shared15to__upper__char(_M0MPC15array5Array2atGcE(chars, last_space_idx.val + 1 | 0)));
  }
  return _M0MPB13StringBuilder10to__string(buf);
}
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode20scan__direct__childs(s) {
  ...
  while (true) {
    ...
    _L$2: {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(result, inst.link);
    }
    continue;
  }
  return result;
  ...
  while (true) {
    ...
    while (true) {
      ...
      _L$4: {
        ...
        _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(stack, c);
      }
      continue;
    }
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5VNode6insert(self, sandbox, parent_inst, parent, before) {
  ...
  while (true) {
    ...
    const slot = _M0FPC13ref3newGRP48bobzhang8contacts8frontend3app5ModelE(h);
  ...
  while (true) {
    ...
    _L$2: {
      _L$3: {
        ...
        if (_bind === undefined) {
          const slot$2 = _M0FPC13ref3newGRP48bobzhang8contacts8frontend3app5ModelE(handler);
  ...
  _L: {
    ...
    _L$2: {
      ...
      if (len1 > len2) {
        ...
        while (true) {
          const i = _tmp;
          if (i >= len2) {
            _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode6remove(_M0MPC15array5Array2atGsE(old$3, i), sandbox, parent);
            _tmp = i - 1 | 0;
            continue;
          } else {
            break;
        ...
        while (true) {
          const i = _tmp;
          if (i >= len1) {
            const inode = _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5VNode6insert(_M0MPC15array5Array2atGsE(new$3, i), sandbox, parent_inst, parent, before.val);
            _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(acc, inode);
      ...
      while (true) {
        const i = _tmp;
        if (i >= _bind) {
          const inode = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime10diff__node(_M0MPC15array5Array2atGsE(old$3, i), _M0MPC15array5Array2atGsE(new$3, i), sandbox, parent, before.val, parent_inst);
          _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(acc, inode);
          before.val = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime8nullableGRP319moonbit_2dcommunity7rabbita3dom4NodeE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode5start(inode));
          _tmp = i - 1 | 0;
          continue;
    ...
    while (true) {
      ...
      if (i >= _bind$2) {
        ...
        let v2;
        _L$3: {
          const _bind$3 = _M0MPC15array5Array2atGsE(order, i);
          const _k = _bind$3._0;
        ...
        _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(reversed, { _0: k, _1: inode });
        before.val = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime8nullableGRP319moonbit_2dcommunity7rabbita3dom4NodeE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode5start(inode));
        _tmp = i - 1 | 0;
        continue;
      } else {
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime7Sandbox3new(root) {
  ...
  const _bind$8 = false;
  const _bind$9 = "";
  const _bind$10 = _M0MPC15queue5Queue3newGRP48bobzhang8contacts8frontend3app3MsgE();
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE(self, scheduler) {
  let msg;
  _L: {
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE(self) {
  const _func = self.view;
  return _func(self.dispatch, self.model.val);
}
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE(self) {
  return self.flags;
}
function _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang8contacts8frontend3app3MsgE(self, msg) {
...
function _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE(model, update, view) {
  const flags = _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags3new();
  const dispatcher = new _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang8contacts8frontend3app3MsgE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags2id(flags), _M0MPC15queue5Queue3newGRP48bobzhang8contacts8frontend3app3MsgE());
  const dispatch = (m) => _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang8contacts8frontend3app3MsgE(dispatcher, m);
  const model$2 = _M0FPC13ref3newGRP48bobzhang8contacts8frontend3app5ModelE(model);
  return { _0: dispatch, _1: { self: new _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE(model$2, dispatcher, dispatch, update, view, flags), method_table: _M0FP0209moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fcontacts_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fcontacts_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell } };
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang8contacts6shared7ContactE(url, http_method, expect, body) {
  const launch = (scheduler) => {
    let has_body;
    if (body.$tag === 2) {
      has_body = false;
    ...
    _L: {
      ...
      _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
        ...
        scheduler.method_table.method_0(scheduler.self, f$2(_M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang8contacts6shared7ContactE(result, decoder)));
      }, (msg) => {
        scheduler.method_table.method_0(scheduler.self, f$2(new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE3Err(`Http request failed:${_M0IPC16string6StringPB4Show10to__string(msg)}`)));
      });
      return;
    }
    _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
...
function _M0FP319moonbit_2dcommunity7rabbita4http7requestGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(url, http_method, expect, body) {
  const launch = (scheduler) => {
    let has_body;
    if (body.$tag === 2) {
      has_body = false;
    ...
    _L: {
      ...
      _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
        ...
        scheduler.method_table.method_0(scheduler.self, f$2(_M0MPC16result6Result4bindGRPB4JsonsRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(result, decoder)));
      }, (msg) => {
        scheduler.method_table.method_0(scheduler.self, f$2(new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE3Err(`Http request failed:${_M0IPC16string6StringPB4Show10to__string(msg)}`)));
      });
      return;
    }
    _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
...
function _M0FP319moonbit_2dcommunity7rabbita4http3getGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(url, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(url, "GET", expect, _M0DTP319moonbit_2dcommunity7rabbita4http4Body5Empty__);
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang8contacts6shared7ContactE(url, body, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang8contacts6shared7ContactE(url, "POST", expect, body);
}
function _M0FP48bobzhang8contacts8frontend3app10view__card(title, children) {
  ...
  if (_M0IP016_24default__implPB2Eq10not__equalGsE(title, "")) {
    _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(all, _M0FP319moonbit_2dcommunity7rabbita4html10h2_2einnerGsE(["font-size: 13px", "font-weight: 700", "color: #999", "margin-bottom: 14px", "text-transform: uppercase", "letter-spacing: 0.5px"], undefined, undefined, undefined, -1, undefined, title));
  }
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(all, child);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP48bobzhang8contacts8frontend3app13person__color(id) {
  const colors = ["#667eea", "#e91e63", "#00bcd4", "#ff9800", "#8bc34a", "#9c27b0", "#009688", "#f44336", "#3f51b5", "#795548"];
  if (colors.length === 0) {
    $panic();
  }
  return _M0MPC15array5Array2atGsE(colors, (id - 1 | 0) % colors.length | 0);
}
function _M0FP48bobzhang8contacts8frontend3app18view__contact__row(dispatch, contact) {
  const color = _M0FP48bobzhang8contacts8frontend3app13person__color(contact.id);
  const initials = _M0FP38bobzhang8contacts6shared13get__initials(contact.name);
  return _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "align-items: center", "gap: 12px", "padding: 10px 0", "border-bottom: 1px solid #f5f5f5"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["width: 42px", "height: 42px", "border-radius: 50%", "flex-shrink: 0", `background: ${_M0IPC16string6StringPB4Show10to__string(color)}`, "color: white", "font-size: 15px", "font-weight: 700", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, initials), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["flex: 1", "min-width: 0"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-weight: 600", "font-size: 14px", "margin-bottom: 2px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, contact.name), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 12px", "color: #999", "margin-bottom: 1px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, contact.email), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 12px", "color: #999"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, _M0FP38bobzhang8contacts6shared13format__phone(contact.phone))]), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["width: 32px", "height: 32px", "background: none", "border: none", "cursor: pointer", "font-size: 18px", "flex-shrink: 0", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg14ToggleFavorite(contact.id)), undefined, contact.favorite ? "★" : "☆"), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["width: 28px", "height: 28px", "background: #fee", "color: #e53935", "border: none", "border-radius: 8px", "cursor: pointer", "font-size: 13px", "font-weight: 700", "flex-shrink: 0", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg13DeleteContact(contact.id)), undefined, "X")]);
}
function _M0MP48bobzhang8contacts8frontend3app5Model4view(self, dispatch) {
  const sorted = _M0FP38bobzhang8contacts6shared14sort__contacts(self.contacts);
  const filtered = _M0FP38bobzhang8contacts6shared16filter__contacts(sorted, self.search_query);
  const favorites = _M0MPC15array5Array6filterGRP38bobzhang8contacts6shared7ContactE(filtered, (c) => c.favorite);
  const non_favorites = _M0MPC15array5Array6filterGRP38bobzhang8contacts6shared7ContactE(filtered, (c) => !c.favorite);
  ...
  const sections = [];
  _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(sections, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["text-align: center", "margin-bottom: 24px", "padding-top: 12px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html10h1_2einnerGsE(["color: white", "font-size: 26px", "font-weight: 800", "margin-bottom: 4px", "letter-spacing: -0.5px"], undefined, undefined, undefined, -1, undefined, undefined, "Contacts"), _M0FP319moonbit_2dcommunity7rabbita4html9p_2einnerGsE(["color: rgba(255,255,255,0.75)", "font-size: 13px"], undefined, undefined, undefined, -1, undefined, "Your address book")]));
  _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(sections, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["margin-bottom: 14px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.search_query, -1, -1, -1, undefined, "Search contacts...", undefined, ["width: 100%", "padding: 12px 16px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none", "background: white"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg13SearchChanged(v)), undefined, "")]));
  const _tmp$2 = ["display: flex", "justify-content: space-between", "align-items: center"];
  const _tmp$3 = ["font-size: 14px", "color: #666", "font-weight: 500"];
  const count = self.contacts.length;
  const suffix = count !== 1 ? "s" : "";
  _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(sections, _M0FP48bobzhang8contacts8frontend3app10view__card("", [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(_tmp$2, undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(_tmp$3, undefined, undefined, undefined, -1, undefined, `${_M0IP016_24default__implPB4Show10to__stringGiE(count)} contact${_M0IPC16string6StringPB4Show10to__string(suffix)}`), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["padding: 8px 18px", "background: linear-gradient(135deg, #667eea, #764ba2)", "color: white", "border: none", "border-radius: 10px", "cursor: pointer", "font-size: 13px", "font-weight: 600"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(_M0DTP48bobzhang8contacts8frontend3app3Msg10ToggleForm__), undefined, self.show_form ? "Cancel" : "+ Add Contact")]), self.show_form ? _M0FP319moonbit_2dcommunity7rabbita4html12form_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "flex-direction: column", "gap: 10px", "margin-top: 16px", "padding-top: 16px", "border-top: 1px solid #f0f0f0"], undefined, undefined, undefined, -1, undefined, undefined, dispatch(_M0DTP48bobzhang8contacts8frontend3app3Msg10AddContact__), undefined, [_M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.name_input, -1, -1, -1, undefined, "Name", undefined, ["padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg16NameInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.email_input, -1, -1, -1, undefined, "Email", undefined, ["padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg17EmailInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.phone_input, -1, -1, -1, undefined, "Phone", undefined, ["padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg17PhoneInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["padding: 12px", "background: linear-gradient(135deg, #667eea, #764ba2)", "color: white", "border: none", "border-radius: 10px", "cursor: pointer", "font-size: 15px", "font-weight: 600", "margin-top: 2px"], undefined, undefined, undefined, -1, "submit", -1, undefined, undefined, -1, undefined, undefined, "Save Contact")]) : _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE([], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, "")]));
  if (favorites.length > 0) {
    _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(sections, _M0FP48bobzhang8contacts8frontend3app10view__card("Favorites", _M0MPC15array5Array3mapGRP38bobzhang8contacts6shared7ContactRP319moonbit_2dcommunity7rabbita4html4HtmlE(favorites, (c) => _M0FP48bobzhang8contacts8frontend3app18view__contact__row(dispatch, c))));
  }
  if (non_favorites.length > 0) {
    _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(sections, _M0FP48bobzhang8contacts8frontend3app10view__card(favorites.length > 0 ? "Other Contacts" : "All Contacts", _M0MPC15array5Array3mapGRP38bobzhang8contacts6shared7ContactRP319moonbit_2dcommunity7rabbita4html4HtmlE(non_favorites, (c) => _M0FP48bobzhang8contacts8frontend3app18view__contact__row(dispatch, c))));
  } else {
    if (favorites.length === 0 && (self.contacts.length > 0 && _M0IP016_24default__implPB2Eq10not__equalGsE(self.search_query, ""))) {
      _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(sections, _M0FP48bobzhang8contacts8frontend3app10view__card("Contacts", [_M0FP319moonbit_2dcommunity7rabbita4html9p_2einnerGsE(["color: #aaa", "font-size: 13px", "text-align: center", "padding: 12px 0"], undefined, undefined, undefined, -1, undefined, "No contacts match your search")]));
    } else {
...
function _M0FP48bobzhang8contacts8frontend3app15fetch__contacts(dispatch) {
  return _M0FP319moonbit_2dcommunity7rabbita4http3getGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(_M0FP38bobzhang8contacts6shared13api__contacts, new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE4Json((result) => dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg11GotContacts(result)), (json) => {
    let _try_err;
    _L: {
      const _bind = _M0FPC14json10from__jsonGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEE(json, undefined);
      let _tmp;
      if (_bind.$tag === 1) {
        const _ok = _bind;
        _tmp = _ok._0;
      ...
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE2Ok(_tmp);
    }
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang8contacts6shared7ContactEsE3Err("Failed to decode contacts");
  }));
}
function _M0MP48bobzhang8contacts8frontend3app5Model6update(self, msg, dispatch) {
  let id;
  _L: {
    let id$2;
    _L$2: {
                ...
                _L$8: {
                  ...
                  _L$9: {
                    ...
                    _L$10: {
                      switch (msg.$tag) {
                        case 0: {
                          return { _0: self, _1: _M0FP48bobzhang8contacts8frontend3app15fetch__contacts(dispatch) };
                        }
                        case 1: {
                          const _GotContacts = msg;
                          const _x = _GotContacts._0;
                          if (_x.$tag === 1) {
                            const _Ok = _x;
                            const _contacts = _Ok._0;
                            contacts = _contacts;
                            break _L$10;
                          } else {
                        ...
                        case 2: {
                          ...
                          const _v = _SearchChanged._0;
                          v$4 = _v;
                          break _L$9;
                        }
                        case 3: {
                          return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(self.contacts, self.search_query, self.name_input, self.email_input, self.phone_input, !self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        case 4: {
                          const _NameInputChanged = msg;
                          const _v$2 = _NameInputChanged._0;
                          v$3 = _v$2;
                          break _L$8;
                        }
                        case 5: {
                          const _EmailInputChanged = msg;
                          const _v$3 = _EmailInputChanged._0;
                          v$2 = _v$3;
                          break _L$7;
                        }
                        case 6: {
                          const _PhoneInputChanged = msg;
                          const _v$4 = _PhoneInputChanged._0;
                          v = _v$4;
                          break _L$6;
                        }
                        case 7: {
                          if (!_M0FP38bobzhang8contacts6shared14validate__name(self.name_input)) {
                            return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                          }
                          if (!_M0FP38bobzhang8contacts6shared15validate__email(self.email_input)) {
                            return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                          }
                          if (!_M0FP38bobzhang8contacts6shared15validate__phone(self.phone_input)) {
                            return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                          }
                          const _bind = [{ _0: "name", _1: _M0IPC16string6StringPB6ToJson8to__json(self.name_input) }, { _0: "email", _1: _M0IPC16string6StringPB6ToJson8to__json(self.email_input) }, { _0: "phone", _1: _M0IPC16string6StringPB6ToJson8to__json(self.phone_input) }];
                          const body = _M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 3)));
                          const cmd = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang8contacts6shared7ContactE(_M0FP38bobzhang8contacts6shared13api__contacts, new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(body), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang8contacts6shared7ContactE4Json((r) => dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg12ContactAdded(r)), (json) => {
                            let _try_err;
                            _L$11: {
                              const _bind$2 = _M0FPC14json10from__jsonGRP38bobzhang8contacts6shared7ContactE(json, undefined);
                              let _tmp;
                              if (_bind$2.$tag === 1) {
                                const _ok = _bind$2;
                                _tmp = _ok._0;
                              ...
                              return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE2Ok(_tmp);
                            }
                            return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE3Err("Failed to decode contact");
                          }));
                          return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(self.contacts, self.search_query, "", "", "", false), _1: cmd };
                        }
                        case 8: {
                          const _ContactAdded = msg;
                          const _x$2 = _ContactAdded._0;
                          if (_x$2.$tag === 1) {
                            const _Ok = _x$2;
                            const _contact = _Ok._0;
                            contact = _contact;
                            break _L$5;
                          } else {
                            return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        ...
                        case 9: {
                          const _ToggleFavorite = msg;
                          const _id = _ToggleFavorite._0;
                          id$3 = _id;
                          break _L$4;
                        }
                        case 10: {
                          const _FavoriteToggled = msg;
                          const _x$3 = _FavoriteToggled._0;
                          if (_x$3.$tag === 1) {
                            const _Ok = _x$3;
                        ...
                        case 11: {
                          const _DeleteContact = msg;
                          const _id$2 = _DeleteContact._0;
                          id$2 = _id$2;
                          break _L$2;
                        }
                        default: {
                          const _ContactDeleted = msg;
                          const _x$4 = _ContactDeleted._0;
                          if (_x$4.$tag === 1) {
                            const _Ok = _x$4;
                            const _id$3 = _Ok._0;
                            id = _id$3;
                    ...
                    return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(contacts, self.search_query, self.name_input, self.email_input, self.phone_input, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                  }
                  return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(self.contacts, v$4, self.name_input, self.email_input, self.phone_input, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                }
                return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(self.contacts, self.search_query, v$3, self.email_input, self.phone_input, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
              }
              return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(self.contacts, self.search_query, self.name_input, v$2, self.phone_input, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
            }
            return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(self.contacts, self.search_query, self.name_input, self.email_input, v, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
          }
          const contacts = _M0MPC15array5Array4copyGRP38bobzhang8contacts6shared7ContactE(self.contacts);
          _M0MPC15array5Array4pushGRP38bobzhang8contacts6shared7ContactE(contacts, contact);
          return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(contacts, self.search_query, self.name_input, self.email_input, self.phone_input, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
        }
        const _tmp = _M0FP38bobzhang8contacts6shared22api__contact__favorite(id$3);
        const _bind = [];
        const cmd = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang8contacts6shared7ContactE(_tmp, new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(_M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 0)))), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang8contacts6shared7ContactE4Json((r) => dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg15FavoriteToggled(r)), (json) => {
          let _try_err;
          _L$5: {
            const _bind$2 = _M0FPC14json10from__jsonGRP38bobzhang8contacts6shared7ContactE(json, undefined);
            let _tmp$2;
            ...
            return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE2Ok(_tmp$2);
          }
          return new _M0DTPC16result6ResultGRP38bobzhang8contacts6shared7ContactsE3Err("Failed to decode contact");
        }));
        return { _0: self, _1: cmd };
      }
      const contacts = _M0MPC15array5Array3mapGRP38bobzhang8contacts6shared7ContactRP38bobzhang8contacts6shared7ContactE(self.contacts, (c) => c.id === updated.id ? updated : c);
      return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(contacts, self.search_query, self.name_input, self.email_input, self.phone_input, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
    }
    const cmd = _M0FP319moonbit_2dcommunity7rabbita4http6deleteGuE(_M0FP38bobzhang8contacts6shared12api__contact(id$2), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmduE4Text((result) => {
      let _tmp;
      let e;
      _L$3: {
        _L$4: {
      ...
      return dispatch(new _M0DTP48bobzhang8contacts8frontend3app3Msg14ContactDeleted(_tmp));
    }));
    return { _0: self, _1: cmd };
  }
  const contacts = _M0MPC15array5Array6filterGRP38bobzhang8contacts6shared7ContactE(self.contacts, (c) => c.id !== id);
  return { _0: new _M0TP48bobzhang8contacts8frontend3app5Model(contacts, self.search_query, self.name_input, self.email_input, self.phone_input, self.show_form), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
}
(() => {
  let dispatch;
  let app_cell;
  _L: {
    const _bind = _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang8contacts8frontend3app5ModelRP48bobzhang8contacts8frontend3app3MsgE(new _M0TP48bobzhang8contacts8frontend3app5Model([], "", "", "", "", false), (dispatch$2, msg, model) => {
      let model$2;
      let cmd;
      _L$2: {
        const _bind$2 = _M0MP48bobzhang8contacts8frontend3app5Model6update(model, msg, dispatch$2);
    ...
    }, (dispatch$2, model) => _M0MP48bobzhang8contacts8frontend3app5Model4view(model, dispatch$2));
  ...
  _M0MP219moonbit_2dcommunity7rabbita3App10with__init(app, dispatch(_M0DTP48bobzhang8contacts8frontend3app3Msg4Init__));
