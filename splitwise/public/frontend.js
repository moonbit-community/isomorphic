...
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE2Ok.prototype.$tag = 1;
...
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonERPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonERPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonERPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonERPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseERPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseERPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseERPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseERPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementERPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementERPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementERPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementERPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
...
function _M0TPC15queue5QueueGRP48bobzhang9splitwise8frontend3app3MsgE(param0, param1, param2) {
  this.length = param0;
  this.first = param1;
  this.last = param2;
}
...
function _M0TPC13ref3RefGRP48bobzhang9splitwise8frontend3app5ModelE(param0) {
  this.val = param0;
}
...
function _M0TPC13ref3RefGORPB5ArrayGiEE(param0) {
  this.val = param0;
}
...
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang9splitwise6shared7Expense(param0, param1, param2, param3, param4) {
  this.id = param0;
  this.description = param1;
  this.amount = param2;
  this.paid_by = param3;
  this.split_among = param4;
}
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang9splitwise6shared6Person(param0, param1) {
  this.id = param0;
  this.name = param1;
}
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang9splitwise6shared10Settlement(param0, param1, param2, param3, param4) {
  this.from_id = param0;
  this.from_name = param1;
  this.to_id = param2;
  this.to_name = param3;
  this.amount = param4;
}
function _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE(param0) {
  this.val = param0;
}
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4None() {}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4None.prototype.$tag = 0;
const _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4None__ = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4None();
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4Some(param0) {
  this._0 = param0;
}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4Some.prototype.$tag = 1;
function _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE(param0) {
  this.val = param0;
}
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4None() {}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4None.prototype.$tag = 0;
const _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4None__ = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4None();
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4Some(param0) {
  this._0 = param0;
}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4Some.prototype.$tag = 1;
function _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE(param0) {
  this.val = param0;
}
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4None() {}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4None.prototype.$tag = 0;
const _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4None__ = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4None();
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4Some(param0) {
  this._0 = param0;
}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4Some.prototype.$tag = 1;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang9splitwise6shared8AppState(param0, param1, param2) {
  this.people = param0;
  this.expenses = param1;
  this.settlements = param2;
}
...
function _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang9splitwise8frontend3app3MsgE(param0, param1) {
  this.id = param0;
  this.inbox = param1;
}
function _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE(param0, param1, param2, param3, param4, param5) {
  this.model = param0;
...
function _M0DTP48bobzhang9splitwise8frontend3app3Msg4Init() {}
_M0DTP48bobzhang9splitwise8frontend3app3Msg4Init.prototype.$tag = 0;
const _M0DTP48bobzhang9splitwise8frontend3app3Msg4Init__ = new _M0DTP48bobzhang9splitwise8frontend3app3Msg4Init();
function _M0DTP48bobzhang9splitwise8frontend3app3Msg8GotState(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg8GotState.prototype.$tag = 1;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg18PersonInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg18PersonInputChanged.prototype.$tag = 2;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg9AddPerson() {}
_M0DTP48bobzhang9splitwise8frontend3app3Msg9AddPerson.prototype.$tag = 3;
const _M0DTP48bobzhang9splitwise8frontend3app3Msg9AddPerson__ = new _M0DTP48bobzhang9splitwise8frontend3app3Msg9AddPerson();
function _M0DTP48bobzhang9splitwise8frontend3app3Msg11PersonAdded(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg11PersonAdded.prototype.$tag = 4;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg16DescInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg16DescInputChanged.prototype.$tag = 5;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg18AmountInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg18AmountInputChanged.prototype.$tag = 6;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg13PaidByChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg13PaidByChanged.prototype.$tag = 7;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg10AddExpense() {}
_M0DTP48bobzhang9splitwise8frontend3app3Msg10AddExpense.prototype.$tag = 8;
const _M0DTP48bobzhang9splitwise8frontend3app3Msg10AddExpense__ = new _M0DTP48bobzhang9splitwise8frontend3app3Msg10AddExpense();
function _M0DTP48bobzhang9splitwise8frontend3app3Msg12ExpenseAdded(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg12ExpenseAdded.prototype.$tag = 9;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg13DeleteExpense(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg13DeleteExpense.prototype.$tag = 10;
function _M0DTP48bobzhang9splitwise8frontend3app3Msg14ExpenseDeleted(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang9splitwise8frontend3app3Msg14ExpenseDeleted.prototype.$tag = 11;
...
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared8AppStateE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared8AppStateE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared8AppStateE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared8AppStateE4Text.prototype.$tag = 1;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStatesE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStatesE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStatesE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStatesE2Ok.prototype.$tag = 1;
...
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared6PersonE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared6PersonE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared6PersonE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared6PersonE4Text.prototype.$tag = 1;
function _M0TP48bobzhang9splitwise8frontend3app5Model(param0, param1, param2, param3, param4, param5, param6) {
  this.people = param0;
  this.expenses = param1;
  this.settlements = param2;
  this.person_input = param3;
  this.desc_input = param4;
  this.amount_input = param5;
  this.paid_by_input = param6;
}
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared7ExpenseE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared7ExpenseE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared7ExpenseE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared7ExpenseE4Text.prototype.$tag = 1;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpensesE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpensesE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpensesE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpensesE2Ok.prototype.$tag = 1;
...
const _M0FP0211moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fsplitwise_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fsplitwise_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell = { method_0: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE, method_1: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE, method_2: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE };
...
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1963 = { _0: 0, _1: "" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1964 = { _0: 1, _1: "5" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1965 = { _0: 1, _1: "25" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1966 = { _0: 1, _1: "125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1967 = { _0: 2, _1: "625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1968 = { _0: 2, _1: "3125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1969 = { _0: 2, _1: "15625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1970 = { _0: 3, _1: "78125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1971 = { _0: 3, _1: "390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1972 = { _0: 3, _1: "1953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1973 = { _0: 4, _1: "9765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1974 = { _0: 4, _1: "48828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1975 = { _0: 4, _1: "244140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1976 = { _0: 4, _1: "1220703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1977 = { _0: 5, _1: "6103515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1978 = { _0: 5, _1: "30517578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1979 = { _0: 5, _1: "152587890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1980 = { _0: 6, _1: "762939453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1981 = { _0: 6, _1: "3814697265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1982 = { _0: 6, _1: "19073486328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1983 = { _0: 7, _1: "95367431640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1984 = { _0: 7, _1: "476837158203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1985 = { _0: 7, _1: "2384185791015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1986 = { _0: 7, _1: "11920928955078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1987 = { _0: 8, _1: "59604644775390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1988 = { _0: 8, _1: "298023223876953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1989 = { _0: 8, _1: "1490116119384765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1990 = { _0: 9, _1: "7450580596923828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1991 = { _0: 9, _1: "37252902984619140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1992 = { _0: 9, _1: "186264514923095703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1993 = { _0: 10, _1: "931322574615478515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1994 = { _0: 10, _1: "4656612873077392578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1995 = { _0: 10, _1: "23283064365386962890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1996 = { _0: 10, _1: "116415321826934814453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1997 = { _0: 11, _1: "582076609134674072265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1998 = { _0: 11, _1: "2910383045673370361328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1999 = { _0: 11, _1: "14551915228366851806640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2000 = { _0: 12, _1: "72759576141834259033203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2001 = { _0: 12, _1: "363797880709171295166015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2002 = { _0: 12, _1: "1818989403545856475830078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2003 = { _0: 13, _1: "9094947017729282379150390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2004 = { _0: 13, _1: "45474735088646411895751953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2005 = { _0: 13, _1: "227373675443232059478759765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2006 = { _0: 13, _1: "1136868377216160297393798828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2007 = { _0: 14, _1: "5684341886080801486968994140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2008 = { _0: 14, _1: "28421709430404007434844970703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2009 = { _0: 14, _1: "142108547152020037174224853515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2010 = { _0: 15, _1: "710542735760100185871124267578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2011 = { _0: 15, _1: "3552713678800500929355621337890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2012 = { _0: 15, _1: "17763568394002504646778106689453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2013 = { _0: 16, _1: "88817841970012523233890533447265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2014 = { _0: 16, _1: "444089209850062616169452667236328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2015 = { _0: 16, _1: "2220446049250313080847263336181640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2016 = { _0: 16, _1: "11102230246251565404236316680908203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2017 = { _0: 17, _1: "55511151231257827021181583404541015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2018 = { _0: 17, _1: "277555756156289135105907917022705078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2019 = { _0: 17, _1: "1387778780781445675529539585113525390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2020 = { _0: 18, _1: "6938893903907228377647697925567626953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2021 = { _0: 18, _1: "34694469519536141888238489627838134765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2022 = { _0: 18, _1: "173472347597680709441192448139190673828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f2023 = { _0: 19, _1: "867361737988403547205962240695953369140625" };
const _M0FPC17strconv19left__shift__cheats = [_M0FPC17strconv34left__shift__cheats_2etuple_2f1963, _M0FPC17strconv34left__shift__cheats_2etuple_2f1964, _M0FPC17strconv34left__shift__cheats_2etuple_2f1965, _M0FPC17strconv34left__shift__cheats_2etuple_2f1966, _M0FPC17strconv34left__shift__cheats_2etuple_2f1967, _M0FPC17strconv34left__shift__cheats_2etuple_2f1968, _M0FPC17strconv34left__shift__cheats_2etuple_2f1969, _M0FPC17strconv34left__shift__cheats_2etuple_2f1970, _M0FPC17strconv34left__shift__cheats_2etuple_2f1971, _M0FPC17strconv34left__shift__cheats_2etuple_2f1972, _M0FPC17strconv34left__shift__cheats_2etuple_2f1973, _M0FPC17strconv34left__shift__cheats_2etuple_2f1974, _M0FPC17strconv34left__shift__cheats_2etuple_2f1975, _M0FPC17strconv34left__shift__cheats_2etuple_2f1976, _M0FPC17strconv34left__shift__cheats_2etuple_2f1977, _M0FPC17strconv34left__shift__cheats_2etuple_2f1978, _M0FPC17strconv34left__shift__cheats_2etuple_2f1979, _M0FPC17strconv34left__shift__cheats_2etuple_2f1980, _M0FPC17strconv34left__shift__cheats_2etuple_2f1981, _M0FPC17strconv34left__shift__cheats_2etuple_2f1982, _M0FPC17strconv34left__shift__cheats_2etuple_2f1983, _M0FPC17strconv34left__shift__cheats_2etuple_2f1984, _M0FPC17strconv34left__shift__cheats_2etuple_2f1985, _M0FPC17strconv34left__shift__cheats_2etuple_2f1986, _M0FPC17strconv34left__shift__cheats_2etuple_2f1987, _M0FPC17strconv34left__shift__cheats_2etuple_2f1988, _M0FPC17strconv34left__shift__cheats_2etuple_2f1989, _M0FPC17strconv34left__shift__cheats_2etuple_2f1990, _M0FPC17strconv34left__shift__cheats_2etuple_2f1991, _M0FPC17strconv34left__shift__cheats_2etuple_2f1992, _M0FPC17strconv34left__shift__cheats_2etuple_2f1993, _M0FPC17strconv34left__shift__cheats_2etuple_2f1994, _M0FPC17strconv34left__shift__cheats_2etuple_2f1995, _M0FPC17strconv34left__shift__cheats_2etuple_2f1996, _M0FPC17strconv34left__shift__cheats_2etuple_2f1997, _M0FPC17strconv34left__shift__cheats_2etuple_2f1998, _M0FPC17strconv34left__shift__cheats_2etuple_2f1999, _M0FPC17strconv34left__shift__cheats_2etuple_2f2000, _M0FPC17strconv34left__shift__cheats_2etuple_2f2001, _M0FPC17strconv34left__shift__cheats_2etuple_2f2002, _M0FPC17strconv34left__shift__cheats_2etuple_2f2003, _M0FPC17strconv34left__shift__cheats_2etuple_2f2004, _M0FPC17strconv34left__shift__cheats_2etuple_2f2005, _M0FPC17strconv34left__shift__cheats_2etuple_2f2006, _M0FPC17strconv34left__shift__cheats_2etuple_2f2007, _M0FPC17strconv34left__shift__cheats_2etuple_2f2008, _M0FPC17strconv34left__shift__cheats_2etuple_2f2009, _M0FPC17strconv34left__shift__cheats_2etuple_2f2010, _M0FPC17strconv34left__shift__cheats_2etuple_2f2011, _M0FPC17strconv34left__shift__cheats_2etuple_2f2012, _M0FPC17strconv34left__shift__cheats_2etuple_2f2013, _M0FPC17strconv34left__shift__cheats_2etuple_2f2014, _M0FPC17strconv34left__shift__cheats_2etuple_2f2015, _M0FPC17strconv34left__shift__cheats_2etuple_2f2016, _M0FPC17strconv34left__shift__cheats_2etuple_2f2017, _M0FPC17strconv34left__shift__cheats_2etuple_2f2018, _M0FPC17strconv34left__shift__cheats_2etuple_2f2019, _M0FPC17strconv34left__shift__cheats_2etuple_2f2020, _M0FPC17strconv34left__shift__cheats_2etuple_2f2021, _M0FPC17strconv34left__shift__cheats_2etuple_2f2022, _M0FPC17strconv34left__shift__cheats_2etuple_2f2023];
...
const _M0FP38bobzhang9splitwise6shared17max__name__length = 50;
const _M0FP38bobzhang9splitwise6shared24max__description__length = 100;
const _M0FP38bobzhang9splitwise6shared10api__state = "/api/state";
const _M0FP38bobzhang9splitwise6shared11api__people = "/api/people";
const _M0FP38bobzhang9splitwise6shared13api__expenses = "/api/expenses";
...
const _M0FPC17strconv28checked__mul_2econstr_2f2443 = $0L;
...
function _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(self, index) {
...
function _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(self, value) {
...
function _M0MPB4Iter9to__arrayGRPC16string10StringViewE(self) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(result, _x);
      continue;
    }
  }
  return result;
...
function _M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang9splitwise6shared6PersonE(self, g) {
  if (self.$tag === 1) {
    const _Ok = self;
    const _value = _Ok._0;
    return g(_value);
    ...
    const _Err = self;
    const _err = _Err._0;
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE3Err(_err);
  }
}
...
function _M0MPC15array5Array3setGUiiEE(self, index, value) {
  const len = self.length;
  if (index >= 0 && index < len) {
    $bound_check(self, index);
    self[index] = value;
...
function _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared6PersonRPB4JsonE(self, f) {
...
function _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared6PersonRP319moonbit_2dcommunity7rabbita4html4HtmlE(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared7ExpenseRP319moonbit_2dcommunity7rabbita4html4HtmlE(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared10SettlementRP319moonbit_2dcommunity7rabbita4html4HtmlE(self, f) {
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
...
function _M0IPC15array5ArrayPB6ToJson8to__jsonGRPB4JsonE(self) {
  return new _M0DTPB4Json5Array(_M0MPC15array5Array3mapGRPB4JsonRPB4JsonE(self, _M0IPC14json4JsonPB6ToJson8to__json));
}
...
function _M0MPC15array5Array4copyGRP38bobzhang9splitwise6shared7ExpenseE(self) {
...
function _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang9splitwise6shared6PersonEHRPC14json15JsonDecodeError(self, f) {
  if (self.length === 0) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonERPC14json15JsonDecodeErrorE2Ok([]);
  }
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonERPC14json15JsonDecodeErrorE2Ok(arr);
}
function _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang9splitwise6shared7ExpenseEHRPC14json15JsonDecodeError(self, f) {
  if (self.length === 0) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseERPC14json15JsonDecodeErrorE2Ok([]);
  }
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseERPC14json15JsonDecodeErrorE2Ok(arr);
}
function _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang9splitwise6shared10SettlementEHRPC14json15JsonDecodeError(self, f) {
  if (self.length === 0) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementERPC14json15JsonDecodeErrorE2Ok([]);
  }
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementERPC14json15JsonDecodeErrorE2Ok(arr);
}
function _M0MPC15array5Array6filterGRP38bobzhang9splitwise6shared7ExpenseE(self, f) {
  const arr = [];
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0MPC15array5Array10push__iterGRP419moonbit_2dcommunity7rabbita8internal7runtime5INodeE(self, iter) {
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(self, _x);
      continue;
    }
  }
}
...
function _M0FPC17strconv12checked__mul(a, b) {
  if (_M0IPC16uint646UInt64PB2Eq5equal(a, $0L) || _M0IPC16uint646UInt64PB2Eq5equal(b, $0L)) {
    return _M0FPC17strconv28checked__mul_2econstr_2f2443;
  }
...
function _M0MPC14json12ParseContext12parse__array(ctx) {
  ...
  _L: while (true) {
    ...
    if (_param.$tag === 8) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(vec, _tmp$4);
    ...
    if (_param === undefined) {
      if (stack.length === 0) {
        ...
        if (_x.$tag === 0) {
          ...
          const _i = _Array._1;
          if (_i < _arr.length) {
            const element = _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(_arr, _i);
            _Array._1 = _i + 1 | 0;
            if (_i > 0) {
      ...
      switch (_value.$tag) {
        case 6: {
          ...
          if (_M0MPB3Map9is__emptyGsRPB4JsonE(_members)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(stack, new _M0DTPC14json10WriteFrame6Object(_M0MPB3Map4iterGsWRP319moonbit_2dcommunity7rabbita3dom5EventRP419moonbit_2dcommunity7rabbita8internal7runtime9SchedulerEuE(_members), true));
          }
          break;
        }
        case 5: {
          ...
          if (_M0MPC15array5Array9is__emptyGRPB4JsonE(_arr)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(stack, new _M0DTPC14json10WriteFrame5Array(_arr, 0));
          }
          break;
        }
        case 4: {
...
function _M0FPC14json18from__json_2einnerGRP38bobzhang9splitwise6shared6PersonE(json, path) {
  return _M0IP38bobzhang9splitwise6shared6PersonPC14json8FromJson10from__json(json, path);
}
function _M0FPC14json18from__json_2einnerGRP38bobzhang9splitwise6shared7ExpenseE(json, path) {
  return _M0IP38bobzhang9splitwise6shared7ExpensePC14json8FromJson10from__json(json, path);
}
function _M0FPC14json18from__json_2einnerGRP38bobzhang9splitwise6shared8AppStateE(json, path) {
  return _M0IP38bobzhang9splitwise6shared8AppStatePC14json8FromJson10from__json(json, path);
}
function _M0FPC14json10from__jsonGRP38bobzhang9splitwise6shared6PersonE(json, path$46$opt) {
  let path;
  ...
  return _M0FPC14json18from__json_2einnerGRP38bobzhang9splitwise6shared6PersonE(json, path);
}
function _M0FPC14json10from__jsonGRP38bobzhang9splitwise6shared7ExpenseE(json, path$46$opt) {
  let path;
  if (path$46$opt === undefined) {
    path = _M0DTPC14json8JsonPath4Root__;
  } else {
  ...
  return _M0FPC14json18from__json_2einnerGRP38bobzhang9splitwise6shared7ExpenseE(json, path);
}
function _M0FPC14json10from__jsonGRP38bobzhang9splitwise6shared8AppStateE(json, path$46$opt) {
  let path;
  if (path$46$opt === undefined) {
    path = _M0DTPC14json8JsonPath4Root__;
  } else {
  ...
  return _M0FPC14json18from__json_2einnerGRP38bobzhang9splitwise6shared8AppStateE(json, path);
}
...
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang9splitwise6shared6PersonE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    const _bind = new _M0DTPC14json8JsonPath5Index(path, 0);
    if (_bind.$tag === 2) {
      const _Index = _bind;
      return _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang9splitwise6shared6PersonEHRPC14json15JsonDecodeError(_a, (i, x) => {
        _Index._1 = i;
        return _M0IP38bobzhang9splitwise6shared6PersonPC14json8FromJson10from__json(x, _Index);
      });
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    return _M0FPC14json13decode__errorGRPB5ArrayGiEE(path, "Array::from_json: expected array");
  }
}
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang9splitwise6shared7ExpenseE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    const _bind = new _M0DTPC14json8JsonPath5Index(path, 0);
    if (_bind.$tag === 2) {
      const _Index = _bind;
      return _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang9splitwise6shared7ExpenseEHRPC14json15JsonDecodeError(_a, (i, x) => {
        _Index._1 = i;
        return _M0IP38bobzhang9splitwise6shared7ExpensePC14json8FromJson10from__json(x, _Index);
      });
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    return _M0FPC14json13decode__errorGRPB5ArrayGiEE(path, "Array::from_json: expected array");
  }
}
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang9splitwise6shared10SettlementE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    const _bind = new _M0DTPC14json8JsonPath5Index(path, 0);
    if (_bind.$tag === 2) {
      const _Index = _bind;
      return _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang9splitwise6shared10SettlementEHRPC14json15JsonDecodeError(_a, (i, x) => {
        _Index._1 = i;
        return _M0IP38bobzhang9splitwise6shared10SettlementPC14json8FromJson10from__json(x, _Index);
      });
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    return _M0FPC14json13decode__errorGRPB5ArrayGiEE(path, "Array::from_json: expected array");
  }
}
function _M0MPC15queue5Queue3newGRP48bobzhang9splitwise8frontend3app3MsgE() {
  return new _M0TPC15queue5QueueGRP48bobzhang9splitwise8frontend3app3MsgE(0, undefined, undefined);
}
...
function _M0FPC13ref3newGRP48bobzhang9splitwise8frontend3app5ModelE(x) {
  return new _M0TPC13ref3RefGRP48bobzhang9splitwise8frontend3app5ModelE(x);
}
...
function _M0IP38bobzhang9splitwise6shared7ExpensePC14json8FromJson10from__json(_x_127, _x_128) {
  const _de_split_among_133 = new _M0TPC13ref3RefGORPB5ArrayGiEE(_M0DTPC16option6OptionGRPB5ArrayGiEE4None__);
  const _de_paid_by_132 = new _M0TPC13ref3RefGOiE(undefined);
  const _de_id_131 = new _M0TPC13ref3RefGOiE(undefined);
  const _de_description_130 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_amount_129 = new _M0TPC13ref3RefGOiE(undefined);
  let _map;
  _L: {
    if (_x_127.$tag === 6) {
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_128, _1: "Expected object to deserialize Expense" }));
    }
  }
  let _v;
  _L$2: {
  ...
  _L$3: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_128, "description"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$4: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_128, "amount"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_amount_129.val = _tmp;
  }
  let _v$4;
  _L$5: {
    _L$6: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "paid_by");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$4, _M0MPC14json8JsonPath8add__key(_x_128, "paid_by"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_paid_by_132.val = _tmp;
  }
  let _v$5;
  _L$6: {
    _L$7: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "split_among");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGiE(_v$5, _M0MPC14json8JsonPath8add__key(_x_128, "split_among"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_split_among_133.val = new _M0DTPC16option6OptionGRPB5ArrayGiEE4Some(_tmp);
  }
  let _de_split_among_133$2;
  const _bind = _de_split_among_133.val;
  if (_bind.$tag === 1) {
    const _Some = _bind;
    const _v$6 = _Some._0;
    _de_split_among_133$2 = _v$6;
  } else {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_128, _1: "Missing field split_among" }));
  }
  let _de_paid_by_132$2;
  const _bind$2 = _de_paid_by_132.val;
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_128, _1: "Missing field paid_by" }));
  } else {
    const _Some = _bind$2;
    const _v$6 = _Some;
    _de_paid_by_132$2 = _v$6;
  }
  let _de_id_131$2;
  const _bind$3 = _de_id_131.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_128, _1: "Missing field id" }));
  } else {
    const _Some = _bind$3;
    const _v$6 = _Some;
    _de_id_131$2 = _v$6;
  }
  let _de_description_130$2;
  const _bind$4 = _de_description_130.val;
  if (_bind$4 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_128, _1: "Missing field description" }));
  } else {
    const _Some = _bind$4;
    const _v$6 = _Some;
    _de_description_130$2 = _v$6;
  }
  let _de_amount_129$2;
  const _bind$5 = _de_amount_129.val;
  if (_bind$5 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_128, _1: "Missing field amount" }));
  } else {
    const _Some = _bind$5;
    const _v$6 = _Some;
    _de_amount_129$2 = _v$6;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpenseRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang9splitwise6shared7Expense(_de_id_131$2, _de_description_130$2, _de_amount_129$2, _de_paid_by_132$2, _de_split_among_133$2));
}
function _M0IP38bobzhang9splitwise6shared6PersonPC14json8FromJson10from__json(_x_107, _x_108) {
  const _de_name_110 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_id_109 = new _M0TPC13ref3RefGOiE(undefined);
  let _map;
  _L: {
    if (_x_107.$tag === 6) {
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_108, _1: "Expected object to deserialize Person" }));
    }
  }
  let _v;
  _L$2: {
  ...
  _L$3: {
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_108, "name"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_name_110.val = _tmp;
  }
  let _de_name_110$2;
  const _bind = _de_name_110.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_108, _1: "Missing field name" }));
  } else {
    const _Some = _bind;
    const _v$3 = _Some;
    _de_name_110$2 = _v$3;
  ...
  let _de_id_109$2;
  const _bind$2 = _de_id_109.val;
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_108, _1: "Missing field id" }));
  } else {
    const _Some = _bind$2;
    const _v$3 = _Some;
    _de_id_109$2 = _v$3;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang9splitwise6shared6Person(_de_id_109$2, _de_name_110$2));
}
function _M0IP38bobzhang9splitwise6shared10SettlementPC14json8FromJson10from__json(_x_72, _x_73) {
  const _de_to_name_78 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_to_id_77 = new _M0TPC13ref3RefGOiE(undefined);
  const _de_from_name_76 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_from_id_75 = new _M0TPC13ref3RefGOiE(undefined);
  const _de_amount_74 = new _M0TPC13ref3RefGOiE(undefined);
  let _map;
  _L: {
    if (_x_72.$tag === 6) {
      const _Object = _x_72;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_73, _1: "Expected object to deserialize Settlement" }));
    }
  }
  let _v;
  _L$2: {
    _L$3: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "from_id");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v, _M0MPC14json8JsonPath8add__key(_x_73, "from_id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_from_id_75.val = _tmp;
  }
  let _v$2;
  _L$3: {
    _L$4: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "from_name");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_73, "from_name"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_from_name_76.val = _tmp;
  }
  let _v$3;
  _L$4: {
    _L$5: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "to_id");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_73, "to_id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_to_id_77.val = _tmp;
  }
  let _v$4;
  _L$5: {
    _L$6: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "to_name");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$4, _M0MPC14json8JsonPath8add__key(_x_73, "to_name"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$6: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$5, _M0MPC14json8JsonPath8add__key(_x_73, "amount"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_amount_74.val = _tmp;
  }
  let _de_to_name_78$2;
  const _bind = _de_to_name_78.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_73, _1: "Missing field to_name" }));
  } else {
    const _Some = _bind;
    const _v$6 = _Some;
    _de_to_name_78$2 = _v$6;
  }
  let _de_to_id_77$2;
  const _bind$2 = _de_to_id_77.val;
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_73, _1: "Missing field to_id" }));
  } else {
    const _Some = _bind$2;
    const _v$6 = _Some;
    _de_to_id_77$2 = _v$6;
  }
  let _de_from_name_76$2;
  const _bind$3 = _de_from_name_76.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_73, _1: "Missing field from_name" }));
  } else {
    const _Some = _bind$3;
    const _v$6 = _Some;
    _de_from_name_76$2 = _v$6;
  }
  let _de_from_id_75$2;
  const _bind$4 = _de_from_id_75.val;
  if (_bind$4 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_73, _1: "Missing field from_id" }));
  } else {
    const _Some = _bind$4;
    const _v$6 = _Some;
    _de_from_id_75$2 = _v$6;
  }
  let _de_amount_74$2;
  const _bind$5 = _de_amount_74.val;
  if (_bind$5 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_73, _1: "Missing field amount" }));
  } else {
    const _Some = _bind$5;
    const _v$6 = _Some;
    _de_amount_74$2 = _v$6;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared10SettlementRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang9splitwise6shared10Settlement(_de_from_id_75$2, _de_from_name_76$2, _de_to_id_77$2, _de_to_name_78$2, _de_amount_74$2));
}
function _M0IP38bobzhang9splitwise6shared8AppStatePC14json8FromJson10from__json(_x_47, _x_48) {
  const _de_settlements_51 = new _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE(_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4None__);
  const _de_people_50 = new _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE(_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4None__);
  const _de_expenses_49 = new _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE(_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4None__);
  let _map;
  _L: {
    if (_x_47.$tag === 6) {
      const _Object = _x_47;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_48, _1: "Expected object to deserialize AppState" }));
    }
  }
  let _v;
  _L$2: {
    _L$3: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "people");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang9splitwise6shared6PersonE(_v, _M0MPC14json8JsonPath8add__key(_x_48, "people"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_people_50.val = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared6PersonEE4Some(_tmp);
  }
  let _v$2;
  _L$3: {
    _L$4: {
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang9splitwise6shared7ExpenseE(_v$2, _M0MPC14json8JsonPath8add__key(_x_48, "expenses"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_expenses_49.val = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared7ExpenseEE4Some(_tmp);
  }
  let _v$3;
  _L$4: {
    _L$5: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "settlements");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang9splitwise6shared10SettlementE(_v$3, _M0MPC14json8JsonPath8add__key(_x_48, "settlements"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_settlements_51.val = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang9splitwise6shared10SettlementEE4Some(_tmp);
  }
  let _de_settlements_51$2;
  const _bind = _de_settlements_51.val;
  if (_bind.$tag === 1) {
    const _Some = _bind;
    const _v$4 = _Some._0;
    _de_settlements_51$2 = _v$4;
  } else {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_48, _1: "Missing field settlements" }));
  }
  let _de_people_50$2;
  const _bind$2 = _de_people_50.val;
  if (_bind$2.$tag === 1) {
    const _Some = _bind$2;
    const _v$4 = _Some._0;
    _de_people_50$2 = _v$4;
  } else {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_48, _1: "Missing field people" }));
  }
  let _de_expenses_49$2;
  const _bind$3 = _de_expenses_49.val;
  if (_bind$3.$tag === 1) {
    const _Some = _bind$3;
    const _v$4 = _Some._0;
    _de_expenses_49$2 = _v$4;
  } else {
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_48, _1: "Missing field expenses" }));
  }
  return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStateRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang9splitwise6shared8AppState(_de_people_50$2, _de_expenses_49$2, _de_settlements_51$2));
}
function _M0FP38bobzhang9splitwise6shared14validate__name(name) {
  return _M0IP016_24default__implPB2Eq10not__equalGsE(name, "") && _M0MPC16string6String20char__length_2einner(name, 0, undefined) <= _M0FP38bobzhang9splitwise6shared17max__name__length;
}
function _M0FP38bobzhang9splitwise6shared21validate__description(desc) {
  return _M0IP016_24default__implPB2Eq10not__equalGsE(desc, "") && _M0MPC16string6String20char__length_2einner(desc, 0, undefined) <= _M0FP38bobzhang9splitwise6shared24max__description__length;
}
function _M0FP38bobzhang9splitwise6shared16validate__amount(amount) {
  return amount > 0;
}
function _M0FP38bobzhang9splitwise6shared12api__expense(id) {
  return `/api/expenses/${_M0IP016_24default__implPB4Show10to__stringGiE(id)}`;
}
function _M0FP38bobzhang9splitwise6shared14format__amount(cents) {
...
function _M0FP38bobzhang9splitwise6shared17compute__balances(people, expenses) {
  const balances = [];
  const _bind = people.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind) {
      const p = people[_];
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(balances, { _0: p.id, _1: 0 });
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _bind$2 = expenses.length;
  let _tmp$2 = 0;
  while (true) {
    const _ = _tmp$2;
    if (_ < _bind$2) {
      const expense = expenses[_];
      if (expense.split_among.length === 0) {
        $panic();
      }
      const share = expense.amount / expense.split_among.length | 0;
      const _bind$3 = 0;
      const _bind$4 = balances.length;
      let _tmp$3 = _bind$3;
      while (true) {
        const i = _tmp$3;
        if (i < _bind$4) {
          ...
          let bal;
          _L: {
            const _bind$5 = _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(balances, i);
            const _pid = _bind$5._0;
            const _bal = _bind$5._1;
            pid = _pid;
            bal = _bal;
            break _L;
          }
          if (pid === expense.paid_by) {
            _M0MPC15array5Array3setGUiiEE(balances, i, { _0: pid, _1: bal + expense.amount | 0 });
          }
          _tmp$3 = i + 1 | 0;
          continue;
        } else {
      ...
      const _bind$5 = expense.split_among;
      const _bind$6 = _bind$5.length;
      let _tmp$4 = 0;
      while (true) {
        const _$2 = _tmp$4;
        if (_$2 < _bind$6) {
          const participant_id = _bind$5[_$2];
          const _bind$7 = 0;
          const _bind$8 = balances.length;
          let _tmp$5 = _bind$7;
          while (true) {
            const i = _tmp$5;
            if (i < _bind$8) {
              ...
              let bal;
              _L: {
                const _bind$9 = _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(balances, i);
                const _pid = _bind$9._0;
                const _bal = _bind$9._1;
                pid = _pid;
                bal = _bal;
                break _L;
              }
              if (pid === participant_id) {
                _M0MPC15array5Array3setGUiiEE(balances, i, { _0: pid, _1: bal - share | 0 });
              }
              _tmp$5 = i + 1 | 0;
              continue;
            } else {
...
function _M0FP38bobzhang9splitwise6shared10find__name(people, id) {
  const _bind = people.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
...
function _M0FP38bobzhang9splitwise6shared20compute__settlements(people, expenses) {
  const balances = _M0FP38bobzhang9splitwise6shared17compute__balances(people, expenses);
  const debtors = [];
  const creditors = [];
  const _bind = balances.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind) {
      ...
      if (bal < 0) {
        _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(debtors, { _0: id, _1: -bal | 0 });
      } else {
        if (bal > 0) {
          _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(creditors, { _0: id, _1: bal });
        }
      }
      _tmp = _ + 1 | 0;
      continue;
  ...
  const settlements = [];
  const di = new _M0TPC13ref3RefGiE(0);
  const ci = new _M0TPC13ref3RefGiE(0);
  while (true) {
    if (di.val < debtors.length && ci.val < creditors.length) {
      let from_id;
      let debt;
      _L: {
        const _bind$2 = _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(debtors, di.val);
        const _from_id = _bind$2._0;
        const _debt = _bind$2._1;
        from_id = _from_id;
        debt = _debt;
        break _L;
      }
      ...
      let credit;
      _L$2: {
        const _bind$2 = _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(creditors, ci.val);
        const _to_id = _bind$2._0;
        const _credit = _bind$2._1;
        to_id = _to_id;
        credit = _credit;
        break _L$2;
      }
      ...
      if (amount > 0) {
        const from_name = _M0FP38bobzhang9splitwise6shared10find__name(people, from_id);
        const to_name = _M0FP38bobzhang9splitwise6shared10find__name(people, to_id);
        _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(settlements, new _M0TP38bobzhang9splitwise6shared10Settlement(from_id, from_name, to_id, to_name, amount));
      }
      if (debt < credit) {
        _M0MPC15array5Array3setGUiiEE(creditors, ci.val, { _0: to_id, _1: credit - debt | 0 });
        di.val = di.val + 1 | 0;
      } else {
        if (debt > credit) {
          _M0MPC15array5Array3setGUiiEE(debtors, di.val, { _0: from_id, _1: debt - credit | 0 });
          ci.val = ci.val + 1 | 0;
        } else {
          di.val = di.val + 1 | 0;
          ci.val = ci.val + 1 | 0;
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode20scan__direct__childs(s) {
  ...
  while (true) {
    ...
    _L$2: {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(result, inst.link);
    }
    continue;
  }
  return result;
  ...
  while (true) {
    ...
    while (true) {
      ...
      _L$4: {
        ...
        _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(stack, c);
      }
      continue;
    }
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5VNode6insert(self, sandbox, parent_inst, parent, before) {
  ...
  while (true) {
    ...
    const slot = _M0FPC13ref3newGRP48bobzhang9splitwise8frontend3app5ModelE(h);
  ...
  while (true) {
    ...
    _L$2: {
      _L$3: {
        ...
        if (_bind === undefined) {
          const slot$2 = _M0FPC13ref3newGRP48bobzhang9splitwise8frontend3app5ModelE(handler);
  ...
  _L: {
    ...
    _L$2: {
      ...
      if (len1 > len2) {
        ...
        while (true) {
          const i = _tmp;
          if (i >= len2) {
            _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode6remove(_M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(old$3, i), sandbox, parent);
            _tmp = i - 1 | 0;
            continue;
          } else {
            break;
        ...
        while (true) {
          const i = _tmp;
          if (i >= len1) {
            const inode = _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5VNode6insert(_M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(new$3, i), sandbox, parent_inst, parent, before.val);
            _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(acc, inode);
      ...
      while (true) {
        const i = _tmp;
        if (i >= _bind) {
          const inode = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime10diff__node(_M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(old$3, i), _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(new$3, i), sandbox, parent, before.val, parent_inst);
          _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(acc, inode);
          before.val = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime8nullableGRP319moonbit_2dcommunity7rabbita3dom4NodeE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode5start(inode));
          _tmp = i - 1 | 0;
          continue;
    ...
    while (true) {
      ...
      if (i >= _bind$2) {
        ...
        let v2;
        _L$3: {
          const _bind$3 = _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(order, i);
          const _k = _bind$3._0;
        ...
        _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(reversed, { _0: k, _1: inode });
        before.val = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime8nullableGRP319moonbit_2dcommunity7rabbita3dom4NodeE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode5start(inode));
        _tmp = i - 1 | 0;
        continue;
      } else {
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime7Sandbox3new(root) {
  ...
  const _bind$8 = false;
  const _bind$9 = "";
  const _bind$10 = _M0MPC15queue5Queue3newGRP48bobzhang9splitwise8frontend3app3MsgE();
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE(self, scheduler) {
  let msg;
  _L: {
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE(self) {
  const _func = self.view;
  return _func(self.dispatch, self.model.val);
}
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE(self) {
  return self.flags;
}
function _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang9splitwise8frontend3app3MsgE(self, msg) {
...
function _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE(model, update, view) {
  const flags = _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags3new();
  const dispatcher = new _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang9splitwise8frontend3app3MsgE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags2id(flags), _M0MPC15queue5Queue3newGRP48bobzhang9splitwise8frontend3app3MsgE());
  const dispatch = (m) => _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang9splitwise8frontend3app3MsgE(dispatcher, m);
  const model$2 = _M0FPC13ref3newGRP48bobzhang9splitwise8frontend3app5ModelE(model);
  return { _0: dispatch, _1: { self: new _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE(model$2, dispatcher, dispatch, update, view, flags), method_table: _M0FP0211moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fsplitwise_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fsplitwise_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell } };
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang9splitwise6shared6PersonE(url, http_method, expect, body) {
  const launch = (scheduler) => {
    let has_body;
    if (body.$tag === 2) {
      has_body = false;
    ...
    _L: {
      ...
      _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
        ...
        scheduler.method_table.method_0(scheduler.self, f$2(_M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang9splitwise6shared6PersonE(result, decoder)));
      }, (msg) => {
        scheduler.method_table.method_0(scheduler.self, f$2(new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE3Err(`Http request failed:${_M0IPC16string6StringPB4Show10to__string(msg)}`)));
      });
      return;
    }
    _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
...
function _M0FP319moonbit_2dcommunity7rabbita4http3getGRP38bobzhang9splitwise6shared8AppStateE(url, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang9splitwise6shared6PersonE(url, "GET", expect, _M0DTP319moonbit_2dcommunity7rabbita4http4Body5Empty__);
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang9splitwise6shared6PersonE(url, body, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang9splitwise6shared6PersonE(url, "POST", expect, body);
}
function _M0FP48bobzhang9splitwise8frontend3app14compute__total(expenses) {
  const total = new _M0TPC13ref3RefGiE(0);
  const _bind = expenses.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind) {
      const e = expenses[_];
      total.val = total.val + e.amount | 0;
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP48bobzhang9splitwise8frontend3app10view__card(title, children) {
  const _tmp = ["background: white", "border-radius: 14px", "padding: 18px 20px", "margin-bottom: 14px", "box-shadow: 0 1px 8px rgba(0,0,0,0.06)"];
  const all = [_M0FP319moonbit_2dcommunity7rabbita4html10h2_2einnerGsE(["font-size: 13px", "font-weight: 700", "color: #999", "margin-bottom: 14px", "text-transform: uppercase", "letter-spacing: 0.5px"], undefined, undefined, undefined, -1, undefined, title)];
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(all, child);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  return _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(_tmp, undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, all);
}
function _M0FP48bobzhang9splitwise8frontend3app10parse__int(input) {
  ...
  while (true) {
    ...
    if (ch >= 48 && ch <= 57) {
      result.val = (Math.imul(result.val, 10) | 0) + (ch - 48 | 0) | 0;
    }
    continue;
  }
  return result.val;
}
function _M0MP48bobzhang9splitwise8frontend3app5Model19view__expense__form(self, dispatch) {
  return _M0FP48bobzhang9splitwise8frontend3app10view__card("Add Expense", [_M0FP319moonbit_2dcommunity7rabbita4html12form_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "flex-direction: column", "gap: 10px"], undefined, undefined, undefined, -1, undefined, undefined, dispatch(_M0DTP48bobzhang9splitwise8frontend3app3Msg10AddExpense__), undefined, [_M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.desc_input, -1, -1, -1, undefined, "What was it for?", undefined, ["padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg16DescInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "gap: 10px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.amount_input, -1, -1, -1, undefined, "0.00", undefined, ["flex: 1", "padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg18AmountInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html14select_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["flex: 1", "padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none", "background: white", "color: #333"], undefined, undefined, undefined, -1, -1, undefined, -1, undefined, -1, -1, (v) => dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg13PaidByChanged(_M0FP48bobzhang9splitwise8frontend3app10parse__int(v))), undefined, _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared6PersonRP319moonbit_2dcommunity7rabbita4html4HtmlE(self.people, (p) => _M0FP319moonbit_2dcommunity7rabbita4html6optionGsE(_M0DTPC16option6OptionGRPB5ArrayGsEE4None__, undefined, undefined, undefined, -1, undefined, -1, _M0MPC13int3Int18to__string_2einner(p.id, 10), p.id === self.paid_by_input || self.paid_by_input === 0 && p.id === _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(self.people, 0).id, undefined, `${_M0IPC16string6StringPB4Show10to__string(p.name)} paid`)))]), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 12px", "color: #999", "padding: 0 2px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, `Split equally among all ${_M0IP016_24default__implPB4Show10to__stringGiE(self.people.length)} people`), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["padding: 12px", "background: linear-gradient(135deg, #667eea, #764ba2)", "color: white", "border: none", "border-radius: 10px", "cursor: pointer", "font-size: 15px", "font-weight: 600", "margin-top: 2px"], undefined, undefined, undefined, -1, "submit", -1, undefined, undefined, -1, undefined, undefined, "Add Expense")])]);
}
function _M0FP48bobzhang9splitwise8frontend3app18find__person__name(people, id) {
  const _bind = people.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
...
function _M0FP48bobzhang9splitwise8frontend3app13person__color(id) {
  const colors = ["#667eea", "#e91e63", "#00bcd4", "#ff9800", "#8bc34a", "#9c27b0", "#009688", "#f44336", "#3f51b5", "#795548"];
  if (colors.length === 0) {
    $panic();
  }
  return _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(colors, (id - 1 | 0) % colors.length | 0);
}
function _M0MP48bobzhang9splitwise8frontend3app5Model20view__expenses__list(self, dispatch) {
  return _M0FP48bobzhang9splitwise8frontend3app10view__card("Expenses", _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared7ExpenseRP319moonbit_2dcommunity7rabbita4html4HtmlE(self.expenses, (expense) => {
    const payer_color = _M0FP48bobzhang9splitwise8frontend3app13person__color(expense.paid_by);
    const name = _M0FP48bobzhang9splitwise8frontend3app18find__person__name(self.people, expense.paid_by);
    const payer_initial = _M0MPC16string6String9to__upper(_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(_M0MPB4Iter9to__arrayGcE(_M0MPC16string6String4iter(name)), 0)));
    return _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "align-items: center", "gap: 12px", "padding: 10px 0", "border-bottom: 1px solid #f5f5f5"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["width: 36px", "height: 36px", "border-radius: 50%", "flex-shrink: 0", `background: ${_M0IPC16string6StringPB4Show10to__string(payer_color)}`, "color: white", "font-size: 14px", "font-weight: 700", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, payer_initial), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["flex: 1", "min-width: 0"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-weight: 600", "font-size: 14px", "margin-bottom: 1px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, expense.description), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 12px", "color: #999"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, `${_M0IPC16string6StringPB4Show10to__string(_M0FP48bobzhang9splitwise8frontend3app18find__person__name(self.people, expense.paid_by))} paid · ${_M0IP016_24default__implPB4Show10to__stringGiE(expense.split_among.length)} way split`)]), _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-weight: 700", "font-size: 15px", "color: #333", "white-space: nowrap"], undefined, undefined, undefined, -1, undefined, `$${_M0IPC16string6StringPB4Show10to__string(_M0FP38bobzhang9splitwise6shared14format__amount(expense.amount))}`), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["width: 28px", "height: 28px", "background: #fee", "color: #e53935", "border: none", "border-radius: 8px", "cursor: pointer", "font-size: 13px", "font-weight: 700", "flex-shrink: 0", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg13DeleteExpense(expense.id)), undefined, "X")]);
  }));
}
function _M0MP48bobzhang9splitwise8frontend3app5Model18view__people__card(self, dispatch) {
  return _M0FP48bobzhang9splitwise8frontend3app10view__card("People", [_M0FP319moonbit_2dcommunity7rabbita4html12form_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "gap: 8px", "margin-bottom: 12px"], undefined, undefined, undefined, -1, undefined, undefined, dispatch(_M0DTP48bobzhang9splitwise8frontend3app3Msg9AddPerson__), undefined, [_M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.person_input, -1, -1, -1, undefined, "Enter a name...", undefined, ["flex: 1", "padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg18PersonInputChanged(v)), undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["padding: 10px 20px", "background: #667eea", "color: white", "border: none", "border-radius: 10px", "cursor: pointer", "font-size: 14px", "font-weight: 600"], undefined, undefined, undefined, -1, "submit", -1, undefined, undefined, -1, undefined, undefined, "Add")]), self.people.length > 0 ? _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "flex-wrap: wrap", "gap: 8px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared6PersonRP319moonbit_2dcommunity7rabbita4html4HtmlE(self.people, (p) => {
    const initial = _M0MPC16string6String9to__upper(_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(_M0MPB4Iter9to__arrayGcE(_M0MPC16string6String4iter(p.name)), 0)));
    const color = _M0FP48bobzhang9splitwise8frontend3app13person__color(p.id);
    return _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: inline-flex", "align-items: center", "gap: 8px", "padding: 6px 14px 6px 6px", "background: #f8f8ff", "border-radius: 24px", "font-size: 13px", "color: #333"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["width: 26px", "height: 26px", "border-radius: 50%", `background: ${_M0IPC16string6StringPB4Show10to__string(color)}`, "color: white", "font-size: 12px", "font-weight: 700", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, initial), _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-weight: 500"], undefined, undefined, undefined, -1, undefined, p.name)]);
  })) : _M0FP319moonbit_2dcommunity7rabbita4html9p_2einnerGsE(["color: #aaa", "font-size: 13px", "text-align: center", "padding: 12px 0"], undefined, undefined, undefined, -1, undefined, "Add at least 2 people to get started")]);
}
function _M0MP48bobzhang9splitwise8frontend3app5Model17view__settlements(self) {
  return _M0FP48bobzhang9splitwise8frontend3app10view__card("Who Owes Who", _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared10SettlementRP319moonbit_2dcommunity7rabbita4html4HtmlE(self.settlements, (s) => _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "align-items: center", "gap: 10px", "padding: 12px 0", "border-bottom: 1px solid #f5f5f5"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "align-items: center", "gap: 6px", "flex: 1"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["width: 30px", "height: 30px", "border-radius: 50%", `background: ${_M0IPC16string6StringPB4Show10to__string(_M0FP48bobzhang9splitwise8frontend3app13person__color(s.from_id))}`, "color: white", "font-size: 12px", "font-weight: 700", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, _M0MPC16string6String9to__upper(_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(_M0MPB4Iter9to__arrayGcE(_M0MPC16string6String4iter(s.from_name)), 0)))), _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-weight: 600", "font-size: 14px"], undefined, undefined, undefined, -1, undefined, s.from_name)]), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["color: #ccc", "font-size: 18px", "padding: 0 4px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, "->"), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "align-items: center", "gap: 6px", "flex: 1"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["width: 30px", "height: 30px", "border-radius: 50%", `background: ${_M0IPC16string6StringPB4Show10to__string(_M0FP48bobzhang9splitwise8frontend3app13person__color(s.to_id))}`, "color: white", "font-size: 12px", "font-weight: 700", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, _M0MPC16string6String9to__upper(_M0IPC14char4CharPB4Show10to__string(_M0MPC15array5Array2atGcE(_M0MPB4Iter9to__arrayGcE(_M0MPC16string6String4iter(s.to_name)), 0)))), _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-weight: 600", "font-size: 14px"], undefined, undefined, undefined, -1, undefined, s.to_name)]), _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-weight: 700", "font-size: 15px", "color: #43a047", "background: #e8f5e9", "padding: 4px 10px", "border-radius: 8px"], undefined, undefined, undefined, -1, undefined, `$${_M0IPC16string6StringPB4Show10to__string(_M0FP38bobzhang9splitwise6shared14format__amount(s.amount))}`)])));
}
function _M0MP48bobzhang9splitwise8frontend3app5Model4view(self, dispatch) {
  const _tmp = ["max-width: 520px", "margin: 0 auto", "padding: 24px 16px", "font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"];
  const sections = [];
  _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(sections, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["text-align: center", "margin-bottom: 24px", "padding-top: 12px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html10h1_2einnerGsE(["color: white", "font-size: 26px", "font-weight: 800", "margin-bottom: 4px", "letter-spacing: -0.5px"], undefined, undefined, undefined, -1, undefined, undefined, "Splitwise"), _M0FP319moonbit_2dcommunity7rabbita4html9p_2einnerGsE(["color: rgba(255,255,255,0.75)", "font-size: 13px"], undefined, undefined, undefined, -1, undefined, "Split expenses with friends")]));
  if (self.expenses.length > 0) {
    const total = _M0FP48bobzhang9splitwise8frontend3app14compute__total(self.expenses);
    _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(sections, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["background: rgba(255,255,255,0.15)", "border-radius: 12px", "padding: 16px 20px", "margin-bottom: 16px", "text-align: center", "backdrop-filter: blur(10px)"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["color: rgba(255,255,255,0.7)", "font-size: 12px", "margin-bottom: 4px", "text-transform: uppercase", "letter-spacing: 1px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, "Total Expenses"), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["color: white", "font-size: 32px", "font-weight: 800"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, `$${_M0IPC16string6StringPB4Show10to__string(_M0FP38bobzhang9splitwise6shared14format__amount(total))}`)]));
  }
  _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(sections, _M0MP48bobzhang9splitwise8frontend3app5Model18view__people__card(self, dispatch));
  if (self.people.length >= 2) {
    _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(sections, _M0MP48bobzhang9splitwise8frontend3app5Model19view__expense__form(self, dispatch));
  }
  if (self.expenses.length > 0) {
    _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(sections, _M0MP48bobzhang9splitwise8frontend3app5Model20view__expenses__list(self, dispatch));
  }
  if (self.settlements.length > 0) {
    _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(sections, _M0MP48bobzhang9splitwise8frontend3app5Model17view__settlements(self));
  } else {
    if (self.expenses.length > 0) {
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(sections, _M0FP48bobzhang9splitwise8frontend3app10view__card("Settlements", [_M0FP319moonbit_2dcommunity7rabbita4html9p_2einnerGsE(["text-align: center", "color: #43a047", "padding: 20px 0", "font-weight: 600", "font-size: 15px"], undefined, undefined, undefined, -1, undefined, "All settled up!")]));
    }
  }
  return _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(_tmp, undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, sections);
}
function _M0FP48bobzhang9splitwise8frontend3app12fetch__state(dispatch) {
  return _M0FP319moonbit_2dcommunity7rabbita4http3getGRP38bobzhang9splitwise6shared8AppStateE(_M0FP38bobzhang9splitwise6shared10api__state, new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared8AppStateE4Json((result) => dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg8GotState(result)), (json) => {
    let _try_err;
    _L: {
      const _bind = _M0FPC14json10from__jsonGRP38bobzhang9splitwise6shared8AppStateE(json, undefined);
      let _tmp;
      if (_bind.$tag === 1) {
        const _ok = _bind;
        _tmp = _ok._0;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStatesE2Ok(_tmp);
    }
    return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared8AppStatesE3Err("Failed to decode state");
  }));
}
function _M0FP48bobzhang9splitwise8frontend3app25parse__dollars__to__cents(input) {
  const dollars = new _M0TPC13ref3RefGiE(0);
  const cents = new _M0TPC13ref3RefGiE(0);
  const after_dot = new _M0TPC13ref3RefGbE(false);
  const cent_digits = new _M0TPC13ref3RefGiE(0);
  const _it = _M0MPC16string6String4iter(input);
  while (true) {
    let ch;
    _L: {
    ...
    if (ch === 46) {
      ...
      if (ch >= 48 && ch <= 57) {
        const digit = ch - 48 | 0;
        if (after_dot.val) {
          if (cent_digits.val < 2) {
            cents.val = (Math.imul(cents.val, 10) | 0) + digit | 0;
            cent_digits.val = cent_digits.val + 1 | 0;
          }
        } else {
          dollars.val = (Math.imul(dollars.val, 10) | 0) + digit | 0;
        }
      }
    }
    continue;
  }
  if (cent_digits.val === 1) {
    cents.val = Math.imul(cents.val, 10) | 0;
  }
  return (Math.imul(dollars.val, 100) | 0) + cents.val | 0;
}
function _M0MP48bobzhang9splitwise8frontend3app5Model6update(self, msg, dispatch) {
  let id;
  _L: {
    let id$2;
    _L$2: {
              ...
              _L$7: {
                ...
                _L$8: {
                  ...
                  _L$9: {
                    switch (msg.$tag) {
                      case 0: {
                        return { _0: self, _1: _M0FP48bobzhang9splitwise8frontend3app12fetch__state(dispatch) };
                      }
                      case 1: {
                        const _GotState = msg;
                        const _x = _GotState._0;
                        if (_x.$tag === 1) {
                          const _Ok = _x;
                          const _state = _Ok._0;
                          state = _state;
                      ...
                      case 2: {
                        const _PersonInputChanged = msg;
                        const _v = _PersonInputChanged._0;
                        v$3 = _v;
                        break _L$8;
                      }
                      case 3: {
                        if (!_M0FP38bobzhang9splitwise6shared14validate__name(self.person_input)) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        const name = self.person_input;
                        const _bind = [{ _0: "name", _1: _M0IPC16string6StringPB6ToJson8to__json(name) }];
                        const cmd = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang9splitwise6shared6PersonE(_M0FP38bobzhang9splitwise6shared11api__people, new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(_M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind, 0, 1)))), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared6PersonE4Json((r) => dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg11PersonAdded(r)), (json) => {
                          let _try_err;
                          _L$10: {
                            const _bind$2 = _M0FPC14json10from__jsonGRP38bobzhang9splitwise6shared6PersonE(json, undefined);
                            let _tmp;
                            if (_bind$2.$tag === 1) {
                              const _ok = _bind$2;
                              _tmp = _ok._0;
                            ...
                            return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE2Ok(_tmp);
                          }
                          return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared6PersonsE3Err("Failed to decode person");
                        }));
                        return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, self.expenses, self.settlements, "", self.desc_input, self.amount_input, self.paid_by_input), _1: cmd };
                      }
                      case 4: {
                        const _PersonAdded = msg;
                        const _x$2 = _PersonAdded._0;
                        if (_x$2.$tag === 1) {
                          const _Ok = _x$2;
                      ...
                      case 5: {
                        const _DescInputChanged = msg;
                        const _v$2 = _DescInputChanged._0;
                        v$2 = _v$2;
                        break _L$6;
                      }
                      case 6: {
                        const _AmountInputChanged = msg;
                        const _v$3 = _AmountInputChanged._0;
                        v = _v$3;
                        break _L$5;
                      }
                      case 7: {
                        const _PaidByChanged = msg;
                        const _id = _PaidByChanged._0;
                        id$3 = _id;
                        break _L$4;
                      }
                      case 8: {
                        if (!_M0FP38bobzhang9splitwise6shared21validate__description(self.desc_input)) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        const cents = _M0FP48bobzhang9splitwise8frontend3app25parse__dollars__to__cents(self.amount_input);
                        if (!_M0FP38bobzhang9splitwise6shared16validate__amount(cents)) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        if (self.people.length === 0) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        const paid_by = self.paid_by_input === 0 ? _M0MPC15array5Array2atGRP38bobzhang9splitwise6shared6PersonE(self.people, 0).id : self.paid_by_input;
                        const split_among = _M0MPC15array5Array3mapGRP38bobzhang9splitwise6shared6PersonRPB4JsonE(self.people, (p) => _M0IPC13int3IntPB6ToJson8to__json(p.id));
                        const _bind$2 = [{ _0: "description", _1: _M0IPC16string6StringPB6ToJson8to__json(self.desc_input) }, { _0: "amount", _1: _M0IPC16double6DoublePB6ToJson8to__json(cents + 0) }, { _0: "paid_by", _1: _M0IPC16double6DoublePB6ToJson8to__json(paid_by + 0) }, { _0: "split_among", _1: _M0IPC15array5ArrayPB6ToJson8to__jsonGRPB4JsonE(split_among) }];
                        const body = _M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$2, 0, 4)));
                        const cmd$2 = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang9splitwise6shared6PersonE(_M0FP38bobzhang9splitwise6shared13api__expenses, new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(body), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang9splitwise6shared7ExpenseE4Json((r) => dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg12ExpenseAdded(r)), (json) => {
                          let _try_err;
                          _L$10: {
                            const _bind$3 = _M0FPC14json10from__jsonGRP38bobzhang9splitwise6shared7ExpenseE(json, undefined);
                            let _tmp;
                            if (_bind$3.$tag === 1) {
                              const _ok = _bind$3;
                              _tmp = _ok._0;
                            ...
                            return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpensesE2Ok(_tmp);
                          }
                          return new _M0DTPC16result6ResultGRP38bobzhang9splitwise6shared7ExpensesE3Err("Failed to decode expense");
                        }));
                        return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, self.expenses, self.settlements, self.person_input, "", "", self.paid_by_input), _1: cmd$2 };
                      }
                      case 9: {
                        const _ExpenseAdded = msg;
                        const _x$3 = _ExpenseAdded._0;
                        if (_x$3.$tag === 1) {
                          const _Ok = _x$3;
                          const _expense = _Ok._0;
                          expense = _expense;
                          break _L$3;
                        } else {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                      ...
                      case 10: {
                        const _DeleteExpense = msg;
                        const _id$2 = _DeleteExpense._0;
                        id$2 = _id$2;
                        break _L$2;
                      }
                      default: {
                        const _ExpenseDeleted = msg;
                        const _x$4 = _ExpenseDeleted._0;
                        if (_x$4.$tag === 1) {
                          const _Ok = _x$4;
                          const _id$3 = _Ok._0;
                          id = _id$3;
                  ...
                  const settlements = _M0FP38bobzhang9splitwise6shared20compute__settlements(state.people, state.expenses);
                  return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(state.people, state.expenses, settlements, self.person_input, self.desc_input, self.amount_input, self.paid_by_input), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                }
                return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, self.expenses, self.settlements, v$3, self.desc_input, self.amount_input, self.paid_by_input), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
              }
              const people = _M0MPC15array5Array4copyGRP38bobzhang9splitwise6shared7ExpenseE(self.people);
              _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(people, person);
              return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(people, self.expenses, self.settlements, self.person_input, self.desc_input, self.amount_input, self.paid_by_input), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
            }
            return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, self.expenses, self.settlements, self.person_input, v$2, self.amount_input, self.paid_by_input), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
          }
          return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, self.expenses, self.settlements, self.person_input, self.desc_input, v, self.paid_by_input), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
        }
        return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, self.expenses, self.settlements, self.person_input, self.desc_input, self.amount_input, id$3), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
      }
      const expenses = _M0MPC15array5Array4copyGRP38bobzhang9splitwise6shared7ExpenseE(self.expenses);
      _M0MPC15array5Array4pushGRP38bobzhang9splitwise6shared7ExpenseE(expenses, expense);
      const settlements = _M0FP38bobzhang9splitwise6shared20compute__settlements(self.people, expenses);
      return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, expenses, settlements, self.person_input, self.desc_input, self.amount_input, self.paid_by_input), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
    }
    const cmd = _M0FP319moonbit_2dcommunity7rabbita4http6deleteGuE(_M0FP38bobzhang9splitwise6shared12api__expense(id$2), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmduE4Text((result) => {
      let _tmp;
      let e;
      _L$3: {
        _L$4: {
      ...
      return dispatch(new _M0DTP48bobzhang9splitwise8frontend3app3Msg14ExpenseDeleted(_tmp));
    }));
    return { _0: self, _1: cmd };
  }
  const expenses = _M0MPC15array5Array6filterGRP38bobzhang9splitwise6shared7ExpenseE(self.expenses, (e) => e.id !== id);
  const settlements = _M0FP38bobzhang9splitwise6shared20compute__settlements(self.people, expenses);
  return { _0: new _M0TP48bobzhang9splitwise8frontend3app5Model(self.people, expenses, settlements, self.person_input, self.desc_input, self.amount_input, self.paid_by_input), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
}
(() => {
  ...
  let app_cell;
  _L: {
    const _bind = _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang9splitwise8frontend3app5ModelRP48bobzhang9splitwise8frontend3app3MsgE(new _M0TP48bobzhang9splitwise8frontend3app5Model([], [], [], "", "", "", 0), (dispatch$2, msg, model) => {
      let model$2;
      let cmd;
      _L$2: {
        const _bind$2 = _M0MP48bobzhang9splitwise8frontend3app5Model6update(model, msg, dispatch$2);
    ...
    }, (dispatch$2, model) => _M0MP48bobzhang9splitwise8frontend3app5Model4view(model, dispatch$2));
  ...
  _M0MP219moonbit_2dcommunity7rabbita3App10with__init(app, dispatch(_M0DTP48bobzhang9splitwise8frontend3app3Msg4Init__));
