...
function _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE2Ok.prototype.$tag = 1;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE2Ok.prototype.$tag = 1;
...
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollERPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollERPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollERPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollERPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
...
function _M0TPC15queue5QueueGRP48bobzhang7pollapp8frontend3app3MsgE(param0, param1, param2) {
  this.length = param0;
  this.first = param1;
  this.last = param2;
}
...
function _M0TPC13ref3RefGRP48bobzhang7pollapp8frontend3app5ModelE(param0) {
  this.val = param0;
}
...
function _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang7pollapp6shared10PollOption(param0, param1, param2) {
  this.id = param0;
  this.text = param1;
  this.votes = param2;
}
function _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE(param0) {
  this.val = param0;
}
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4None() {}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4None.prototype.$tag = 0;
const _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4None__ = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4None();
function _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4Some(param0) {
  this._0 = param0;
}
_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4Some.prototype.$tag = 1;
function _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE3Err(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE3Err.prototype.$tag = 0;
function _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE2Ok(param0) {
  this._0 = param0;
}
_M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE2Ok.prototype.$tag = 1;
function _M0TP38bobzhang7pollapp6shared4Poll(param0, param1, param2) {
  this.id = param0;
...
function _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang7pollapp8frontend3app3MsgE(param0, param1) {
  this.id = param0;
  this.inbox = param1;
}
function _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE(param0, param1, param2, param3, param4, param5) {
  this.model = param0;
...
function _M0DTP48bobzhang7pollapp8frontend3app3Msg4Init() {}
_M0DTP48bobzhang7pollapp8frontend3app3Msg4Init.prototype.$tag = 0;
const _M0DTP48bobzhang7pollapp8frontend3app3Msg4Init__ = new _M0DTP48bobzhang7pollapp8frontend3app3Msg4Init();
function _M0DTP48bobzhang7pollapp8frontend3app3Msg8GotPolls(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg8GotPolls.prototype.$tag = 1;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg20QuestionInputChanged(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg20QuestionInputChanged.prototype.$tag = 2;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg18OptionInputChanged(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg18OptionInputChanged.prototype.$tag = 3;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg14AddOptionInput() {}
_M0DTP48bobzhang7pollapp8frontend3app3Msg14AddOptionInput.prototype.$tag = 4;
const _M0DTP48bobzhang7pollapp8frontend3app3Msg14AddOptionInput__ = new _M0DTP48bobzhang7pollapp8frontend3app3Msg14AddOptionInput();
function _M0DTP48bobzhang7pollapp8frontend3app3Msg17RemoveOptionInput(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg17RemoveOptionInput.prototype.$tag = 5;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg10CreatePoll() {}
_M0DTP48bobzhang7pollapp8frontend3app3Msg10CreatePoll.prototype.$tag = 6;
const _M0DTP48bobzhang7pollapp8frontend3app3Msg10CreatePoll__ = new _M0DTP48bobzhang7pollapp8frontend3app3Msg10CreatePoll();
function _M0DTP48bobzhang7pollapp8frontend3app3Msg11PollCreated(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg11PollCreated.prototype.$tag = 7;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg4Vote(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg4Vote.prototype.$tag = 8;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg5Voted(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg5Voted.prototype.$tag = 9;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg10DeletePoll(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg10DeletePoll.prototype.$tag = 10;
function _M0DTP48bobzhang7pollapp8frontend3app3Msg11PollDeleted(param0) {
  this._0 = param0;
}
_M0DTP48bobzhang7pollapp8frontend3app3Msg11PollDeleted.prototype.$tag = 11;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE4Text.prototype.$tag = 1;
function _M0TP48bobzhang7pollapp8frontend3app5Model(param0, param1, param2, param3) {
  this.polls = param0;
  this.question_input = param1;
  this.option_inputs = param2;
  this.voted = param3;
}
...
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7pollapp6shared4PollE4Json(param0, param1) {
  this._0 = param0;
  this._1 = param1;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7pollapp6shared4PollE4Json.prototype.$tag = 0;
function _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7pollapp6shared4PollE4Text(param0) {
  this._0 = param0;
}
_M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7pollapp6shared4PollE4Text.prototype.$tag = 1;
...
const _M0FP0207moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fpollapp_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fpollapp_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell = { method_0: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE, method_1: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE, method_2: _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE };
...
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1862 = { _0: 0, _1: "" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1863 = { _0: 1, _1: "5" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1864 = { _0: 1, _1: "25" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1865 = { _0: 1, _1: "125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1866 = { _0: 2, _1: "625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1867 = { _0: 2, _1: "3125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1868 = { _0: 2, _1: "15625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1869 = { _0: 3, _1: "78125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1870 = { _0: 3, _1: "390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1871 = { _0: 3, _1: "1953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1872 = { _0: 4, _1: "9765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1873 = { _0: 4, _1: "48828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1874 = { _0: 4, _1: "244140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1875 = { _0: 4, _1: "1220703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1876 = { _0: 5, _1: "6103515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1877 = { _0: 5, _1: "30517578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1878 = { _0: 5, _1: "152587890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1879 = { _0: 6, _1: "762939453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1880 = { _0: 6, _1: "3814697265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1881 = { _0: 6, _1: "19073486328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1882 = { _0: 7, _1: "95367431640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1883 = { _0: 7, _1: "476837158203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1884 = { _0: 7, _1: "2384185791015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1885 = { _0: 7, _1: "11920928955078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1886 = { _0: 8, _1: "59604644775390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1887 = { _0: 8, _1: "298023223876953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1888 = { _0: 8, _1: "1490116119384765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1889 = { _0: 9, _1: "7450580596923828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1890 = { _0: 9, _1: "37252902984619140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1891 = { _0: 9, _1: "186264514923095703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1892 = { _0: 10, _1: "931322574615478515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1893 = { _0: 10, _1: "4656612873077392578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1894 = { _0: 10, _1: "23283064365386962890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1895 = { _0: 10, _1: "116415321826934814453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1896 = { _0: 11, _1: "582076609134674072265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1897 = { _0: 11, _1: "2910383045673370361328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1898 = { _0: 11, _1: "14551915228366851806640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1899 = { _0: 12, _1: "72759576141834259033203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1900 = { _0: 12, _1: "363797880709171295166015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1901 = { _0: 12, _1: "1818989403545856475830078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1902 = { _0: 13, _1: "9094947017729282379150390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1903 = { _0: 13, _1: "45474735088646411895751953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1904 = { _0: 13, _1: "227373675443232059478759765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1905 = { _0: 13, _1: "1136868377216160297393798828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1906 = { _0: 14, _1: "5684341886080801486968994140625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1907 = { _0: 14, _1: "28421709430404007434844970703125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1908 = { _0: 14, _1: "142108547152020037174224853515625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1909 = { _0: 15, _1: "710542735760100185871124267578125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1910 = { _0: 15, _1: "3552713678800500929355621337890625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1911 = { _0: 15, _1: "17763568394002504646778106689453125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1912 = { _0: 16, _1: "88817841970012523233890533447265625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1913 = { _0: 16, _1: "444089209850062616169452667236328125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1914 = { _0: 16, _1: "2220446049250313080847263336181640625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1915 = { _0: 16, _1: "11102230246251565404236316680908203125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1916 = { _0: 17, _1: "55511151231257827021181583404541015625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1917 = { _0: 17, _1: "277555756156289135105907917022705078125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1918 = { _0: 17, _1: "1387778780781445675529539585113525390625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1919 = { _0: 18, _1: "6938893903907228377647697925567626953125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1920 = { _0: 18, _1: "34694469519536141888238489627838134765625" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1921 = { _0: 18, _1: "173472347597680709441192448139190673828125" };
const _M0FPC17strconv34left__shift__cheats_2etuple_2f1922 = { _0: 19, _1: "867361737988403547205962240695953369140625" };
const _M0FPC17strconv19left__shift__cheats = [_M0FPC17strconv34left__shift__cheats_2etuple_2f1862, _M0FPC17strconv34left__shift__cheats_2etuple_2f1863, _M0FPC17strconv34left__shift__cheats_2etuple_2f1864, _M0FPC17strconv34left__shift__cheats_2etuple_2f1865, _M0FPC17strconv34left__shift__cheats_2etuple_2f1866, _M0FPC17strconv34left__shift__cheats_2etuple_2f1867, _M0FPC17strconv34left__shift__cheats_2etuple_2f1868, _M0FPC17strconv34left__shift__cheats_2etuple_2f1869, _M0FPC17strconv34left__shift__cheats_2etuple_2f1870, _M0FPC17strconv34left__shift__cheats_2etuple_2f1871, _M0FPC17strconv34left__shift__cheats_2etuple_2f1872, _M0FPC17strconv34left__shift__cheats_2etuple_2f1873, _M0FPC17strconv34left__shift__cheats_2etuple_2f1874, _M0FPC17strconv34left__shift__cheats_2etuple_2f1875, _M0FPC17strconv34left__shift__cheats_2etuple_2f1876, _M0FPC17strconv34left__shift__cheats_2etuple_2f1877, _M0FPC17strconv34left__shift__cheats_2etuple_2f1878, _M0FPC17strconv34left__shift__cheats_2etuple_2f1879, _M0FPC17strconv34left__shift__cheats_2etuple_2f1880, _M0FPC17strconv34left__shift__cheats_2etuple_2f1881, _M0FPC17strconv34left__shift__cheats_2etuple_2f1882, _M0FPC17strconv34left__shift__cheats_2etuple_2f1883, _M0FPC17strconv34left__shift__cheats_2etuple_2f1884, _M0FPC17strconv34left__shift__cheats_2etuple_2f1885, _M0FPC17strconv34left__shift__cheats_2etuple_2f1886, _M0FPC17strconv34left__shift__cheats_2etuple_2f1887, _M0FPC17strconv34left__shift__cheats_2etuple_2f1888, _M0FPC17strconv34left__shift__cheats_2etuple_2f1889, _M0FPC17strconv34left__shift__cheats_2etuple_2f1890, _M0FPC17strconv34left__shift__cheats_2etuple_2f1891, _M0FPC17strconv34left__shift__cheats_2etuple_2f1892, _M0FPC17strconv34left__shift__cheats_2etuple_2f1893, _M0FPC17strconv34left__shift__cheats_2etuple_2f1894, _M0FPC17strconv34left__shift__cheats_2etuple_2f1895, _M0FPC17strconv34left__shift__cheats_2etuple_2f1896, _M0FPC17strconv34left__shift__cheats_2etuple_2f1897, _M0FPC17strconv34left__shift__cheats_2etuple_2f1898, _M0FPC17strconv34left__shift__cheats_2etuple_2f1899, _M0FPC17strconv34left__shift__cheats_2etuple_2f1900, _M0FPC17strconv34left__shift__cheats_2etuple_2f1901, _M0FPC17strconv34left__shift__cheats_2etuple_2f1902, _M0FPC17strconv34left__shift__cheats_2etuple_2f1903, _M0FPC17strconv34left__shift__cheats_2etuple_2f1904, _M0FPC17strconv34left__shift__cheats_2etuple_2f1905, _M0FPC17strconv34left__shift__cheats_2etuple_2f1906, _M0FPC17strconv34left__shift__cheats_2etuple_2f1907, _M0FPC17strconv34left__shift__cheats_2etuple_2f1908, _M0FPC17strconv34left__shift__cheats_2etuple_2f1909, _M0FPC17strconv34left__shift__cheats_2etuple_2f1910, _M0FPC17strconv34left__shift__cheats_2etuple_2f1911, _M0FPC17strconv34left__shift__cheats_2etuple_2f1912, _M0FPC17strconv34left__shift__cheats_2etuple_2f1913, _M0FPC17strconv34left__shift__cheats_2etuple_2f1914, _M0FPC17strconv34left__shift__cheats_2etuple_2f1915, _M0FPC17strconv34left__shift__cheats_2etuple_2f1916, _M0FPC17strconv34left__shift__cheats_2etuple_2f1917, _M0FPC17strconv34left__shift__cheats_2etuple_2f1918, _M0FPC17strconv34left__shift__cheats_2etuple_2f1919, _M0FPC17strconv34left__shift__cheats_2etuple_2f1920, _M0FPC17strconv34left__shift__cheats_2etuple_2f1921, _M0FPC17strconv34left__shift__cheats_2etuple_2f1922];
...
const _M0FP38bobzhang7pollapp6shared21max__question__length = 200;
const _M0FP38bobzhang7pollapp6shared19max__option__length = 100;
const _M0FP38bobzhang7pollapp6shared12min__options = 2;
const _M0FP38bobzhang7pollapp6shared12max__options = 6;
const _M0FP38bobzhang7pollapp6shared10api__polls = "/api/polls";
...
const _M0FPB33brute__force__find_2econstr_2f407 = 0;
const _M0FPB43boyer__moore__horspool__find_2econstr_2f393 = 0;
...
const _M0FPC17strconv28checked__mul_2econstr_2f2342 = $0L;
...
function _M0FPB28boyer__moore__horspool__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB43boyer__moore__horspool__find_2econstr_2f393;
  }
}
function _M0FPB18brute__force__find(haystack, needle) {
  ...
  if (needle_len > 0) {
    ...
    return _M0FPB33brute__force__find_2econstr_2f407;
  }
}
...
function _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(self, value) {
  _M0MPB7JSArray4push(self, value);
}
...
function _M0MPB4Iter9to__arrayGRPC16string10StringViewE(self) {
  ...
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(result, _x);
      continue;
    }
  }
  return result;
...
function _M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang7pollapp6shared4PollE(self, g) {
  if (self.$tag === 1) {
    const _Ok = self;
    const _value = _Ok._0;
    return g(_value);
    ...
    const _Err = self;
    const _err = _Err._0;
    return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE3Err(_err);
  }
}
function _M0MPC16result6Result4bindGRPB4JsonsRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(self, g) {
  if (self.$tag === 1) {
    const _Ok = self;
    const _value = _Ok._0;
    return g(_value);
    ...
    const _Err = self;
    const _err = _Err._0;
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE3Err(_err);
  }
}
...
function _M0MPC15array5Array3mapGRP38bobzhang7pollapp6shared4PollRP38bobzhang7pollapp6shared4PollE(self, f) {
...
function _M0MPC15array5Array4copyGRP38bobzhang7pollapp6shared4PollE(self) {
  return _M0MPB7JSArray4copy(self);
}
...
function _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang7pollapp6shared10PollOptionEHRPC14json15JsonDecodeError(self, f) {
  if (self.length === 0) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE2Ok([]);
  }
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE2Ok(arr);
}
function _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang7pollapp6shared4PollEHRPC14json15JsonDecodeError(self, f) {
  if (self.length === 0) {
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollERPC14json15JsonDecodeErrorE2Ok([]);
  }
  const arr = new Array(self.length);
  const _bind = self.length;
  let _tmp = 0;
  ...
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollERPC14json15JsonDecodeErrorE2Ok(arr);
}
function _M0MPC15array5Array6filterGRP38bobzhang7pollapp6shared4PollE(self, f) {
  const arr = [];
  const _bind = self.length;
  let _tmp = 0;
  while (true) {
    ...
    if (_ < _bind) {
      const v = self[_];
      if (f(v)) {
        _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(arr, v);
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
...
function _M0MPC15array5Array10push__iterGRP419moonbit_2dcommunity7rabbita8internal7runtime5INodeE(self, iter) {
  while (true) {
    ...
    if (_bind === undefined) {
      ...
      const _Some = _bind;
      const _x = _Some;
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(self, _x);
      continue;
    }
  }
}
...
function _M0FPC17strconv12checked__mul(a, b) {
  if (_M0IPC16uint646UInt64PB2Eq5equal(a, $0L) || _M0IPC16uint646UInt64PB2Eq5equal(b, $0L)) {
    return _M0FPC17strconv28checked__mul_2econstr_2f2342;
  }
...
function _M0FPC14json13decode__errorGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE(path, msg) {
  return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: path, _1: msg }));
}
...
function _M0MPC14json12ParseContext12parse__array(ctx) {
  ...
  _L: while (true) {
    ...
    if (_param.$tag === 8) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(vec, _tmp$4);
      ...
      switch (_value.$tag) {
        case 6: {
          ...
          if (_M0MPB3Map9is__emptyGsRPB4JsonE(_members)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(stack, new _M0DTPC14json10WriteFrame6Object(_M0MPB3Map4iterGsWRP319moonbit_2dcommunity7rabbita3dom5EventRP419moonbit_2dcommunity7rabbita8internal7runtime9SchedulerEuE(_members), true));
          }
          break;
        }
        case 5: {
          ...
          if (_M0MPC15array5Array9is__emptyGRPB4JsonE(_arr)) {
            ...
            _M0IPB13StringBuilderPB6Logger13write__string(buf, _M0FPC14json11indent__str(depth, indent));
            _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(stack, new _M0DTPC14json10WriteFrame5Array(_arr, 0));
          }
          break;
        }
        case 4: {
...
function _M0FPC14json18from__json_2einnerGRP38bobzhang7pollapp6shared4PollE(json, path) {
  return _M0IP38bobzhang7pollapp6shared4PollPC14json8FromJson10from__json(json, path);
}
function _M0FPC14json18from__json_2einnerGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(json, path) {
  return _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang7pollapp6shared4PollE(json, path);
}
function _M0FPC14json10from__jsonGRP38bobzhang7pollapp6shared4PollE(json, path$46$opt) {
  let path;
  ...
  return _M0FPC14json18from__json_2einnerGRP38bobzhang7pollapp6shared4PollE(json, path);
}
function _M0FPC14json10from__jsonGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(json, path$46$opt) {
  let path;
  if (path$46$opt === undefined) {
    path = _M0DTPC14json8JsonPath4Root__;
  } else {
  ...
  return _M0FPC14json18from__json_2einnerGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(json, path);
}
...
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang7pollapp6shared10PollOptionE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    ...
    if (_bind.$tag === 2) {
      const _Index = _bind;
      return _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang7pollapp6shared10PollOptionEHRPC14json15JsonDecodeError(_a, (i, x) => {
        _Index._1 = i;
        return _M0IP38bobzhang7pollapp6shared10PollOptionPC14json8FromJson10from__json(x, _Index);
      });
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    return _M0FPC14json13decode__errorGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE(path, "Array::from_json: expected array");
  }
}
function _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang7pollapp6shared4PollE(json, path) {
  if (json.$tag === 5) {
    const _Array = json;
    const _a = _Array._0;
    const _bind = new _M0DTPC14json8JsonPath5Index(path, 0);
    if (_bind.$tag === 2) {
      const _Index = _bind;
      return _M0MPC15array5Array4mapiGRPB4JsonRP38bobzhang7pollapp6shared4PollEHRPC14json15JsonDecodeError(_a, (i, x) => {
        _Index._1 = i;
        return _M0IP38bobzhang7pollapp6shared4PollPC14json8FromJson10from__json(x, _Index);
      });
    } else {
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollERPC14json15JsonDecodeErrorE2Ok($panic());
    }
  } else {
    return _M0FPC14json13decode__errorGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE(path, "Array::from_json: expected array");
  }
}
function _M0MPC15queue5Queue3newGRP48bobzhang7pollapp8frontend3app3MsgE() {
  return new _M0TPC15queue5QueueGRP48bobzhang7pollapp8frontend3app3MsgE(0, undefined, undefined);
}
...
function _M0FPC13ref3newGRP48bobzhang7pollapp8frontend3app5ModelE(x) {
  return new _M0TPC13ref3RefGRP48bobzhang7pollapp8frontend3app5ModelE(x);
}
...
function _M0IP38bobzhang7pollapp6shared10PollOptionPC14json8FromJson10from__json(_x_37, _x_38) {
  const _de_votes_41 = new _M0TPC13ref3RefGOiE(undefined);
  const _de_text_40 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_id_39 = new _M0TPC13ref3RefGOiE(undefined);
  let _map;
  _L: {
    if (_x_37.$tag === 6) {
      const _Object = _x_37;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_38, _1: "Expected object to deserialize PollOption" }));
    }
  }
  let _v;
  _L$2: {
  ...
  _L$3: {
    ...
    _de_text_40.val = _tmp;
  }
  let _v$3;
  _L$4: {
    _L$5: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "votes");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v$3, _M0MPC14json8JsonPath8add__key(_x_38, "votes"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_votes_41.val = _tmp;
  }
  let _de_votes_41$2;
  const _bind = _de_votes_41.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_38, _1: "Missing field votes" }));
  } else {
    const _Some = _bind;
    const _v$4 = _Some;
    _de_votes_41$2 = _v$4;
  ...
  let _de_text_40$2;
  const _bind$2 = _de_text_40.val;
  if (_bind$2 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_38, _1: "Missing field text" }));
  } else {
    const _Some = _bind$2;
    const _v$4 = _Some;
    _de_text_40$2 = _v$4;
  ...
  let _de_id_39$2;
  const _bind$3 = _de_id_39.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_38, _1: "Missing field id" }));
  } else {
    const _Some = _bind$3;
    const _v$4 = _Some;
    _de_id_39$2 = _v$4;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared10PollOptionRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang7pollapp6shared10PollOption(_de_id_39$2, _de_text_40$2, _de_votes_41$2));
}
function _M0IP38bobzhang7pollapp6shared4PollPC14json8FromJson10from__json(_x_12, _x_13) {
  const _de_question_16 = new _M0TPC13ref3RefGOsE(undefined);
  const _de_options_15 = new _M0TPC13ref3RefGORPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE(_M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4None__);
  const _de_id_14 = new _M0TPC13ref3RefGOiE(undefined);
  let _map;
  _L: {
    if (_x_12.$tag === 6) {
      const _Object = _x_12;
      ...
      return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_13, _1: "Expected object to deserialize Poll" }));
    }
  }
  let _v;
  _L$2: {
    ...
    const _bind = _M0IPC13int3IntPC14json8FromJson10from__json(_v, _M0MPC14json8JsonPath8add__key(_x_13, "id"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
  ...
  _L$3: {
    _L$4: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "question");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC16string6StringPC14json8FromJson10from__json(_v$2, _M0MPC14json8JsonPath8add__key(_x_13, "question"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_question_16.val = _tmp;
  }
  let _v$3;
  _L$4: {
    _L$5: {
      const _bind = _M0MPB3Map3getGsRPB4JsonE(_map, "options");
      if (_bind === undefined) {
      } else {
        const _Some = _bind;
        const __v = _Some;
    ...
    const _bind = _M0IPC15array5ArrayPC14json8FromJson10from__jsonGRP38bobzhang7pollapp6shared10PollOptionE(_v$3, _M0MPC14json8JsonPath8add__key(_x_13, "options"));
    let _tmp;
    if (_bind.$tag === 1) {
      const _ok = _bind;
      _tmp = _ok._0;
    ...
    _de_options_15.val = new _M0DTPC16option6OptionGRPB5ArrayGRP38bobzhang7pollapp6shared10PollOptionEE4Some(_tmp);
  }
  let _de_question_16$2;
  const _bind = _de_question_16.val;
  if (_bind === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_13, _1: "Missing field question" }));
  } else {
    const _Some = _bind;
    const _v$4 = _Some;
    _de_question_16$2 = _v$4;
  }
  let _de_options_15$2;
  const _bind$2 = _de_options_15.val;
  if (_bind$2.$tag === 1) {
    const _Some = _bind$2;
    const _v$4 = _Some._0;
    _de_options_15$2 = _v$4;
  } else {
    return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_13, _1: "Missing field options" }));
  }
  let _de_id_14$2;
  const _bind$3 = _de_id_14.val;
  if (_bind$3 === undefined) {
    return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE3Err(new _M0DTPC15error5Error61moonbitlang_2fcore_2fjson_2eJsonDecodeError_2eJsonDecodeError({ _0: _x_13, _1: "Missing field id" }));
  } else {
    const _Some = _bind$3;
    const _v$4 = _Some;
    _de_id_14$2 = _v$4;
  }
  return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollRPC14json15JsonDecodeErrorE2Ok(new _M0TP38bobzhang7pollapp6shared4Poll(_de_id_14$2, _de_question_16$2, _de_options_15$2));
}
function _M0FP38bobzhang7pollapp6shared18validate__question(q) {
  return _M0IP016_24default__implPB2Eq10not__equalGsE(q, "") && _M0MPC16string6String20char__length_2einner(q, 0, undefined) <= _M0FP38bobzhang7pollapp6shared21max__question__length;
}
function _M0FP38bobzhang7pollapp6shared16validate__option(text) {
  return _M0IP016_24default__implPB2Eq10not__equalGsE(text, "") && _M0MPC16string6String20char__length_2einner(text, 0, undefined) <= _M0FP38bobzhang7pollapp6shared19max__option__length;
}
function _M0FP38bobzhang7pollapp6shared9api__poll(id) {
  return `/api/polls/${_M0IP016_24default__implPB4Show10to__stringGiE(id)}`;
}
function _M0FP38bobzhang7pollapp6shared15api__poll__vote(id) {
  return `/api/polls/${_M0IP016_24default__implPB4Show10to__stringGiE(id)}/vote`;
}
function _M0FP38bobzhang7pollapp6shared21compute__total__votes(options) {
  ...
  while (true) {
    ...
    if (_ < _bind) {
      const opt = options[_];
      total.val = total.val + opt.votes | 0;
      _tmp = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0FP38bobzhang7pollapp6shared19compute__percentage(votes, total) {
  if (total === 0) {
    return 0;
  } else {
    if (total === 0) {
    ...
    return (Math.imul(votes, 100) | 0) / total | 0;
  }
}
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode20scan__direct__childs(s) {
  ...
  while (true) {
    ...
    _L$2: {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(result, inst.link);
    }
    continue;
  }
  return result;
  ...
  while (true) {
    ...
    while (true) {
      ...
      _L$4: {
        ...
        _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(stack, c);
      }
      continue;
    }
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5VNode6insert(self, sandbox, parent_inst, parent, before) {
  ...
  while (true) {
    ...
    const slot = _M0FPC13ref3newGRP48bobzhang7pollapp8frontend3app5ModelE(h);
  ...
  while (true) {
    ...
    _L$2: {
      _L$3: {
        ...
        if (_bind === undefined) {
          const slot$2 = _M0FPC13ref3newGRP48bobzhang7pollapp8frontend3app5ModelE(handler);
  ...
  _L: {
      ...
      if (len1 > len2) {
        ...
        while (true) {
          ...
          if (i >= len1) {
            ...
            _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(acc, inode);
    ...
    while (true) {
      ...
      if (i >= _bind$2) {
        ...
        _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(reversed, { _0: k, _1: inode });
        before.val = _M0FP419moonbit_2dcommunity7rabbita8internal7runtime8nullableGRP319moonbit_2dcommunity7rabbita3dom4NodeE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5INode5start(inode));
        _tmp = i - 1 | 0;
        continue;
      } else {
...
function _M0MP419moonbit_2dcommunity7rabbita8internal7runtime7Sandbox3new(root) {
  ...
  const _bind$8 = false;
  const _bind$9 = "";
  const _bind$10 = _M0MPC15queue5Queue3newGRP48bobzhang7pollapp8frontend3app3MsgE();
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4stepGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE(self, scheduler) {
  let msg;
  _L: {
...
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell4viewGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE(self) {
  const _func = self.view;
  return _func(self.dispatch, self.model.val);
}
function _M0IP219moonbit_2dcommunity7rabbita9TypedCellP419moonbit_2dcommunity7rabbita8internal7runtime6IsCell5flagsGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE(self) {
  return self.flags;
}
function _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang7pollapp8frontend3app3MsgE(self, msg) {
...
function _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE(model, update, view) {
  const flags = _M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags3new();
  const dispatcher = new _M0TP219moonbit_2dcommunity7rabbita10DispatcherGRP48bobzhang7pollapp8frontend3app3MsgE(_M0MP419moonbit_2dcommunity7rabbita8internal7runtime5Flags2id(flags), _M0MPC15queue5Queue3newGRP48bobzhang7pollapp8frontend3app3MsgE());
  const dispatch = (m) => _M0MP219moonbit_2dcommunity7rabbita10Dispatcher7messageGRP48bobzhang7pollapp8frontend3app3MsgE(dispatcher, m);
  const model$2 = _M0FPC13ref3newGRP48bobzhang7pollapp8frontend3app5ModelE(model);
  return { _0: dispatch, _1: { self: new _M0TP219moonbit_2dcommunity7rabbita9TypedCellGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE(model$2, dispatcher, dispatch, update, view, flags), method_table: _M0FP0207moonbit_2dcommunity_2frabbita_2fTypedCell_5bbobzhang_2fpollapp_2ffrontend_2fapp_2fModel_2c_20bobzhang_2fpollapp_2ffrontend_2fapp_2fMsg_5d_24as_24_40moonbit_2dcommunity_2frabbita_2finternal_2fruntime_2eIsCell } };
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang7pollapp6shared4PollE(url, http_method, expect, body) {
  const launch = (scheduler) => {
    let has_body;
    if (body.$tag === 2) {
      has_body = false;
    ...
    _L: {
      ...
      _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
        ...
        scheduler.method_table.method_0(scheduler.self, f$2(_M0MPC16result6Result4bindGRPB4JsonsRP38bobzhang7pollapp6shared4PollE(result, decoder)));
      }, (msg) => {
        scheduler.method_table.method_0(scheduler.self, f$2(new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE3Err(`Http request failed:${_M0IPC16string6StringPB4Show10to__string(msg)}`)));
      });
      return;
    }
    _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
...
function _M0FP319moonbit_2dcommunity7rabbita4http7requestGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(url, http_method, expect, body) {
  const launch = (scheduler) => {
    let has_body;
    if (body.$tag === 2) {
      has_body = false;
    ...
    _L: {
      ...
      _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
        ...
        scheduler.method_table.method_0(scheduler.self, f$2(_M0MPC16result6Result4bindGRPB4JsonsRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(result, decoder)));
      }, (msg) => {
        scheduler.method_table.method_0(scheduler.self, f$2(new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE3Err(`Http request failed:${_M0IPC16string6StringPB4Show10to__string(msg)}`)));
      });
      return;
    }
    _M0FP319moonbit_2dcommunity7rabbita4http11js__request(url, http_method, content_type, body$2, has_body, (str) => {
...
function _M0FP319moonbit_2dcommunity7rabbita4http3getGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(url, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(url, "GET", expect, _M0DTP319moonbit_2dcommunity7rabbita4http4Body5Empty__);
}
...
function _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang7pollapp6shared4PollE(url, body, expect) {
  return _M0FP319moonbit_2dcommunity7rabbita4http7requestGRP38bobzhang7pollapp6shared4PollE(url, "POST", expect, body);
}
function _M0MP48bobzhang7pollapp8frontend3app5Model10has__voted(self, poll_id) {
  const _bind = self.voted;
  const _bind$2 = _bind.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
...
function _M0FP48bobzhang7pollapp8frontend3app10view__card(title, children) {
  ...
  if (_M0IP016_24default__implPB2Eq10not__equalGsE(title, "")) {
    _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(all, _M0FP319moonbit_2dcommunity7rabbita4html10h2_2einnerGsE(["font-size: 13px", "font-weight: 700", "color: #999", "margin-bottom: 14px", "text-transform: uppercase", "letter-spacing: 0.5px"], undefined, undefined, undefined, -1, undefined, title));
  }
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(all, child);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
...
function _M0MP48bobzhang7pollapp8frontend3app5Model18view__create__poll(self, dispatch) {
  const option_fields = [];
  const _bind = 0;
  const _bind$2 = self.option_inputs.length;
  let _tmp = _bind;
  while (true) {
    const i = _tmp;
    if (i < _bind$2) {
      const idx = i;
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(option_fields, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "gap: 8px", "align-items: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, _M0MPC15array5Array2atGsE(self.option_inputs, idx), -1, -1, -1, undefined, `Option ${_M0IP016_24default__implPB4Show10to__stringGiE(idx + 1 | 0)}`, undefined, ["flex: 1", "padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg18OptionInputChanged(idx, v)), undefined, ""), self.option_inputs.length > _M0FP38bobzhang7pollapp6shared12min__options ? _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["width: 32px", "height: 32px", "background: #fee", "color: #e53935", "border: none", "border-radius: 8px", "cursor: pointer", "font-size: 16px", "font-weight: 700", "flex-shrink: 0", "display: flex", "align-items: center", "justify-content: center"], undefined, undefined, undefined, -1, "button", -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg17RemoveOptionInput(idx)), undefined, "-") : _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE([], undefined, undefined, undefined, -1, undefined, "")]));
      _tmp = i + 1 | 0;
      continue;
    } else {
      break;
  ...
  const _tmp$2 = ["display: flex", "flex-direction: column", "gap: 10px"];
  const _tmp$3 = dispatch(_M0DTP48bobzhang7pollapp8frontend3app3Msg10CreatePoll__);
  const children = [];
  _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, _M0FP319moonbit_2dcommunity7rabbita4html13input_2einnerGsE(18, undefined, self.question_input, -1, -1, -1, undefined, "What's your question?", undefined, ["padding: 10px 14px", "border: 2px solid #eee", "border-radius: 10px", "font-size: 14px", "outline: none"], undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, -1, -1, -1, undefined, undefined, undefined, (v) => dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg20QuestionInputChanged(v)), undefined, ""));
  _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 12px", "font-weight: 700", "color: #999", "text-transform: uppercase", "letter-spacing: 0.5px", "margin-top: 4px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, "Options"));
  const _bind$3 = option_fields.length;
  let _tmp$4 = 0;
  while (true) {
    const _ = _tmp$4;
    if (_ < _bind$3) {
      const field = option_fields[_];
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, field);
      _tmp$4 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (self.option_inputs.length < _M0FP38bobzhang7pollapp6shared12max__options) {
    _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["padding: 8px", "background: #f0f0ff", "color: #667eea", "border: 2px dashed #ccc", "border-radius: 10px", "cursor: pointer", "font-size: 13px", "font-weight: 600"], undefined, undefined, undefined, -1, "button", -1, undefined, undefined, -1, dispatch(_M0DTP48bobzhang7pollapp8frontend3app3Msg14AddOptionInput__), undefined, "+ Add Option"));
  }
  ...
  return _M0FP48bobzhang7pollapp8frontend3app10view__card("Create Poll", [_M0FP319moonbit_2dcommunity7rabbita4html12form_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(_tmp$2, undefined, undefined, undefined, -1, undefined, undefined, _tmp$3, undefined, children)]);
}
function _M0MP48bobzhang7pollapp8frontend3app5Model16view__poll__card(self, dispatch, poll) {
  const total = _M0FP38bobzhang7pollapp6shared21compute__total__votes(poll.options);
  const voted = _M0MP48bobzhang7pollapp8frontend3app5Model10has__voted(self, poll.id);
  const option_bars = [];
  const _bind = poll.options;
  const _bind$2 = _bind.length;
  let _tmp = 0;
  while (true) {
    const _ = _tmp;
    if (_ < _bind$2) {
      const opt = _bind[_];
      const pct = _M0FP38bobzhang7pollapp6shared19compute__percentage(opt.votes, total);
      const poll_id = poll.id;
      const option_id = opt.id;
      if (voted) {
        _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(option_bars, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["position: relative", "padding: 12px 14px", "border-radius: 10px", "background: #f5f5f8", "overflow: hidden", "margin-bottom: 6px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["position: absolute", "top: 0", "left: 0", "bottom: 0", `width: ${_M0IP016_24default__implPB4Show10to__stringGiE(pct)}%`, "background: linear-gradient(135deg, rgba(102,126,234,0.2), rgba(118,75,162,0.2))", "border-radius: 10px", "transition: width 0.3s ease"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, ""), _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["position: relative", "display: flex", "justify-content: space-between", "align-items: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-size: 14px", "font-weight: 500", "color: #333"], undefined, undefined, undefined, -1, undefined, opt.text), _M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-size: 13px", "font-weight: 600", "color: #667eea"], undefined, undefined, undefined, -1, undefined, `${_M0IP016_24default__implPB4Show10to__stringGiE(opt.votes)} votes (${_M0IP016_24default__implPB4Show10to__stringGiE(pct)}%)`)])]));
      } else {
        _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(option_bars, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["position: relative", "padding: 12px 14px", "border-radius: 10px", "background: #f5f5f8", "overflow: hidden", "margin-bottom: 6px", "cursor: pointer", "transition: background 0.2s ease"], undefined, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg4Vote(poll_id, option_id)), undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html12span_2einnerGsE(["font-size: 14px", "font-weight: 500", "color: #333"], undefined, undefined, undefined, -1, undefined, opt.text)]));
      }
      _tmp = _ + 1 | 0;
      continue;
    } else {
  ...
  const children = [];
  _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGRPB5ArrayGRP319moonbit_2dcommunity7rabbita4html4HtmlEE(["display: flex", "justify-content: space-between", "align-items: flex-start", "margin-bottom: 14px"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, [_M0FP319moonbit_2dcommunity7rabbita4html10h3_2einnerGsE(["font-size: 16px", "font-weight: 700", "color: #333", "flex: 1"], undefined, undefined, undefined, -1, undefined, poll.question), _M0FP319moonbit_2dcommunity7rabbita4html14button_2einnerGsE(["width: 28px", "height: 28px", "background: #fee", "color: #e53935", "border: none", "border-radius: 8px", "cursor: pointer", "font-size: 13px", "font-weight: 700", "flex-shrink: 0", "display: flex", "align-items: center", "justify-content: center", "margin-left: 12px"], undefined, undefined, undefined, -1, undefined, -1, undefined, undefined, -1, dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg10DeletePoll(poll.id)), undefined, "X")]));
  const _bind$3 = option_bars.length;
  let _tmp$2 = 0;
  while (true) {
    const _ = _tmp$2;
    if (_ < _bind$3) {
      const bar = option_bars[_];
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, bar);
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (total > 0) {
    _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 12px", "color: #999", "margin-top: 8px", "text-align: right"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, `${_M0IP016_24default__implPB4Show10to__stringGiE(total)} total votes`));
  }
  if (!voted && total === 0) {
    _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(children, _M0FP319moonbit_2dcommunity7rabbita4html11div_2einnerGsE(["font-size: 12px", "color: #999", "margin-top: 8px", "text-align: center"], undefined, undefined, undefined, -1, undefined, undefined, undefined, undefined, undefined, undefined, undefined, "Click an option to vote"));
  }
  return _M0FP48bobzhang7pollapp8frontend3app10view__card("", children);
}
function _M0MP48bobzhang7pollapp8frontend3app5Model4view(self, dispatch) {
  ...
  while (true) {
    ...
    if (_ < _bind$2) {
      const poll = _bind[_];
      _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(sections, _M0MP48bobzhang7pollapp8frontend3app5Model16view__poll__card(self, dispatch, poll));
      _tmp$2 = _ + 1 | 0;
      continue;
    } else {
      break;
  ...
  if (self.polls.length === 0) {
    _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(sections, _M0FP48bobzhang7pollapp8frontend3app10view__card("Polls", [_M0FP319moonbit_2dcommunity7rabbita4html9p_2einnerGsE(["color: #aaa", "font-size: 13px", "text-align: center", "padding: 12px 0"], undefined, undefined, undefined, -1, undefined, "No polls yet. Create one above!")]));
  }
...
function _M0FP48bobzhang7pollapp8frontend3app12fetch__polls(dispatch) {
  return _M0FP319moonbit_2dcommunity7rabbita4http3getGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(_M0FP38bobzhang7pollapp6shared10api__polls, new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE4Json((result) => dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg8GotPolls(result)), (json) => {
    let _try_err;
    _L: {
      const _bind = _M0FPC14json10from__jsonGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEE(json, undefined);
      let _tmp;
      if (_bind.$tag === 1) {
        const _ok = _bind;
        _tmp = _ok._0;
      ...
      return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE2Ok(_tmp);
    }
    return new _M0DTPC16result6ResultGRPB5ArrayGRP38bobzhang7pollapp6shared4PollEsE3Err("Failed to decode polls");
  }));
}
function _M0MP48bobzhang7pollapp8frontend3app5Model6update(self, msg, dispatch) {
  let id;
  _L: {
    let id$2;
    _L$2: {
      ...
      _L$3: {
        ...
        _L$4: {
          ...
          _L$5: {
              ...
              _L$7: {
                ...
                _L$8: {
                  ...
                  _L$9: {
                    switch (msg.$tag) {
                      case 0: {
                        return { _0: self, _1: _M0FP48bobzhang7pollapp8frontend3app12fetch__polls(dispatch) };
                      }
                      case 1: {
                        const _GotPolls = msg;
                        const _x = _GotPolls._0;
                        if (_x.$tag === 1) {
                          const _Ok = _x;
                          const _polls = _Ok._0;
                          polls = _polls;
                      ...
                      case 2: {
                        const _QuestionInputChanged = msg;
                        const _v = _QuestionInputChanged._0;
                        v$2 = _v;
                        break _L$8;
                      }
                      case 3: {
                        const _OptionInputChanged = msg;
                        const _idx = _OptionInputChanged._0;
                        const _v$2 = _OptionInputChanged._1;
                        idx$2 = _idx;
                        v = _v$2;
                        break _L$7;
                      }
                      case 4: {
                        ...
                        const new_opts = _M0MPC15array5Array4copyGRP38bobzhang7pollapp6shared4PollE(self.option_inputs);
                        _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(new_opts, "");
                        return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(self.polls, self.question_input, new_opts, self.voted), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                      }
                      case 5: {
                        const _RemoveOptionInput = msg;
                        const _idx$2 = _RemoveOptionInput._0;
                        idx = _idx$2;
                        break _L$6;
                      }
                      case 6: {
                        if (!_M0FP38bobzhang7pollapp6shared18validate__question(self.question_input)) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        const valid_options = [];
                        const _bind = self.option_inputs;
                        const _bind$2 = _bind.length;
                        let _tmp = 0;
                        while (true) {
                          const _ = _tmp;
                          if (_ < _bind$2) {
                            ...
                            if (_M0IP016_24default__implPB2Eq10not__equalGsE(trimmed, "")) {
                              _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(valid_options, trimmed);
                            }
                            _tmp = _ + 1 | 0;
                            continue;
                          } else {
                        ...
                        if (valid_options.length < _M0FP38bobzhang7pollapp6shared12min__options) {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                        const _bind$3 = valid_options.length;
                        let _tmp$2 = 0;
                        while (true) {
                          const _ = _tmp$2;
                          if (_ < _bind$3) {
                            const text = valid_options[_];
                            if (!_M0FP38bobzhang7pollapp6shared16validate__option(text)) {
                              return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                            }
                            _tmp$2 = _ + 1 | 0;
                            continue;
                        ...
                        const options_json = _M0MPC15array5Array3mapGsRPB4JsonE(valid_options, (t) => _M0IPC16string6StringPB6ToJson8to__json(t));
                        const _bind$4 = [{ _0: "question", _1: _M0IPC16string6StringPB6ToJson8to__json(self.question_input) }, { _0: "options", _1: _M0IPC15array5ArrayPB6ToJson8to__jsonGRPB4JsonE(options_json) }];
                        const body = _M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$4, 0, 2)));
                        const cmd = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang7pollapp6shared4PollE(_M0FP38bobzhang7pollapp6shared10api__polls, new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(body), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7pollapp6shared4PollE4Json((r) => dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg11PollCreated(r)), (json) => {
                          let _try_err;
                          _L$10: {
                            const _bind$5 = _M0FPC14json10from__jsonGRP38bobzhang7pollapp6shared4PollE(json, undefined);
                            let _tmp$3;
                            if (_bind$5.$tag === 1) {
                              const _ok = _bind$5;
                              _tmp$3 = _ok._0;
                            ...
                            return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE2Ok(_tmp$3);
                          }
                          return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE3Err("Failed to decode poll");
                        }));
                        return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(self.polls, "", ["", ""], self.voted), _1: cmd };
                      }
                      case 7: {
                        const _PollCreated = msg;
                        const _x$2 = _PollCreated._0;
                        if (_x$2.$tag === 1) {
                          const _Ok = _x$2;
                          const _poll = _Ok._0;
                          poll = _poll;
                      ...
                      case 8: {
                        const _Vote = msg;
                        const _poll_id = _Vote._0;
                        const _option_id = _Vote._1;
                        poll_id = _poll_id;
                      ...
                      case 9: {
                        const _Voted = msg;
                        const _x$3 = _Voted._0;
                        if (_x$3.$tag === 1) {
                          const _Ok = _x$3;
                          const _updated_poll = _Ok._0;
                          updated_poll = _updated_poll;
                          break _L$3;
                        } else {
                          return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                        }
                      ...
                      case 10: {
                        const _DeletePoll = msg;
                        const _id = _DeletePoll._0;
                        id$2 = _id;
                        break _L$2;
                      }
                      default: {
                        const _PollDeleted = msg;
                        const _x$4 = _PollDeleted._0;
                        if (_x$4.$tag === 1) {
                          const _Ok = _x$4;
                          const _id$2 = _Ok._0;
                          id = _id$2;
                  ...
                  return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(polls, self.question_input, self.option_inputs, self.voted), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
                }
                return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(self.polls, v$2, self.option_inputs, self.voted), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
              }
              const new_opts = _M0MPC15array5Array4copyGRP38bobzhang7pollapp6shared4PollE(self.option_inputs);
              _M0MPC15array5Array3setGsE(new_opts, idx$2, v);
              return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(self.polls, self.question_input, new_opts, self.voted), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
            }
            if (self.option_inputs.length <= _M0FP38bobzhang7pollapp6shared12min__options) {
              return { _0: self, _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
            }
            const new_opts = [];
            const _bind = 0;
            ...
            while (true) {
              ...
              if (i < _bind$2) {
                if (i !== idx) {
                  _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(new_opts, _M0MPC15array5Array2atGsE(self.option_inputs, i));
                }
                _tmp = i + 1 | 0;
                continue;
              } else {
          ...
          const polls = _M0MPC15array5Array4copyGRP38bobzhang7pollapp6shared4PollE(self.polls);
          const new_polls = [poll];
          const _bind = polls.length;
          let _tmp = 0;
          while (true) {
            const _ = _tmp;
            if (_ < _bind) {
              const p = polls[_];
              _M0MPC15array5Array4pushGRP38bobzhang7pollapp6shared4PollE(new_polls, p);
              _tmp = _ + 1 | 0;
              continue;
            } else {
              break;
          ...
          return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(new_polls, self.question_input, self.option_inputs, self.voted), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
        }
        const _bind = self.voted;
        const _bind$2 = _bind.length;
        let _tmp = 0;
        ...
        const _bind$3 = [{ _0: "option_id", _1: _M0IPC16double6DoublePB6ToJson8to__json(option_id + 0) }];
        const body = _M0MPC14json4Json6object(_M0MPB3Map11from__arrayGsRPB4JsonE(new _M0TPB9ArrayViewGUsRPB4JsonEE(_bind$3, 0, 1)));
        const cmd = _M0FP319moonbit_2dcommunity7rabbita4http4postGRP38bobzhang7pollapp6shared4PollE(_M0FP38bobzhang7pollapp6shared15api__poll__vote(poll_id), new _M0DTP319moonbit_2dcommunity7rabbita4http4Body4Json(body), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmdRP38bobzhang7pollapp6shared4PollE4Json((r) => dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg5Voted(r)), (json) => {
          let _try_err;
          _L$5: {
            const _bind$4 = _M0FPC14json10from__jsonGRP38bobzhang7pollapp6shared4PollE(json, undefined);
            let _tmp$2;
            if (_bind$4.$tag === 1) {
              const _ok = _bind$4;
              _tmp$2 = _ok._0;
            ...
            return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE2Ok(_tmp$2);
          }
          return new _M0DTPC16result6ResultGRP38bobzhang7pollapp6shared4PollsE3Err("Failed to decode poll");
        }));
        const new_voted = _M0MPC15array5Array4copyGiE(self.voted);
        _M0MPC15array5Array4pushGiE(new_voted, poll_id);
        return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(self.polls, self.question_input, self.option_inputs, new_voted), _1: cmd };
      }
      const polls = _M0MPC15array5Array3mapGRP38bobzhang7pollapp6shared4PollRP38bobzhang7pollapp6shared4PollE(self.polls, (p) => p.id === updated_poll.id ? updated_poll : p);
      return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(polls, self.question_input, self.option_inputs, self.voted), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
    }
    const cmd = _M0FP319moonbit_2dcommunity7rabbita4http6deleteGuE(_M0FP38bobzhang7pollapp6shared9api__poll(id$2), new _M0DTP319moonbit_2dcommunity7rabbita4http9ExpectingGRP419moonbit_2dcommunity7rabbita8internal7runtime3CmduE4Text((result) => {
      let _tmp;
      let e;
      _L$3: {
        _L$4: {
      ...
      return dispatch(new _M0DTP48bobzhang7pollapp8frontend3app3Msg11PollDeleted(_tmp));
    }));
    return { _0: self, _1: cmd };
  }
  const polls = _M0MPC15array5Array6filterGRP38bobzhang7pollapp6shared4PollE(self.polls, (p) => p.id !== id);
  return { _0: new _M0TP48bobzhang7pollapp8frontend3app5Model(polls, self.question_input, self.option_inputs, self.voted), _1: _M0FP319moonbit_2dcommunity7rabbita3cmd4none };
}
(() => {
  let dispatch;
  let app_cell;
  _L: {
    const _bind = _M0FP219moonbit_2dcommunity7rabbita20cell__with__dispatchGRP48bobzhang7pollapp8frontend3app5ModelRP48bobzhang7pollapp8frontend3app3MsgE(new _M0TP48bobzhang7pollapp8frontend3app5Model([], "", ["", ""], []), (dispatch$2, msg, model) => {
      let model$2;
      let cmd;
      _L$2: {
        const _bind$2 = _M0MP48bobzhang7pollapp8frontend3app5Model6update(model, msg, dispatch$2);
    ...
    }, (dispatch$2, model) => _M0MP48bobzhang7pollapp8frontend3app5Model4view(model, dispatch$2));
  ...
  _M0MP219moonbit_2dcommunity7rabbita3App10with__init(app, dispatch(_M0DTP48bobzhang7pollapp8frontend3app3Msg4Init__));
